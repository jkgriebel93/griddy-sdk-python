...
from griddy_nfl.models.entities.play_detail import PlayDetail, PlayDetailTypedDict
from griddy_nfl.models.entities.play_player import PlayPlayer, PlayPlayerTypedDict
