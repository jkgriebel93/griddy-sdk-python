...
from griddy_nfl.models.enums.passing_stats_category_enum import PassingStatsCategoryEnum
...
class GetPlayerPassingStatsBySeasonRequest(BaseModel):
    season: Annotated[
    ...
    qualified_passer: Annotated[
        Optional[bool],
        pydantic.Field(alias="qualifiedPasser"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = True
    r"""Filter to only qualified passers (minimum attempts threshold)"""
