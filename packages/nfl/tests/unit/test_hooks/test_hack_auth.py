...
from griddy_nfl._hooks.hack_auth import HackAuthHook
from griddy_nfl._hooks.types import BeforeRequestContext, HookContext
...
class TestHackAuthHook:
    @patch("griddy_nfl._hooks.hack_auth.requests.post")
    ...
    @patch("griddy_nfl._hooks.hack_auth.HackAuthHook.before_request")
