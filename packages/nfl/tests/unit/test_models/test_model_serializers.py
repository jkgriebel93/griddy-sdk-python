...
_OPTIONAL_MODELS = [
    ("griddy_nfl.models.entities.boxscore_site", "BoxscoreSite"),
    ("griddy_nfl.models.entities.current_game", "CurrentGame"),
    ("griddy_nfl.models.entities.futures_market", "FuturesMarket"),
    ("griddy_nfl.models.entities.game", "Game"),
    ("griddy_nfl.models.entities.game_site", "GameSite"),
    (
        "griddy_nfl.models.entities.multiple_rankings_category",
        "MultipleRankingsCategoryPagination",
    ),
    ("griddy_nfl.models.entities.pagination", "Pagination"),
    ("griddy_nfl.models.entities.player", "Player"),
    ("griddy_nfl.models.entities.player_detail", "PlayerDetail"),
    ("griddy_nfl.models.entities.player_search_result", "PlayerSearchResult"),
    ("griddy_nfl.models.entities.pro_game", "ProGame"),
    ("griddy_nfl.models.entities.pro_team", "ProTeam"),
    ("griddy_nfl.models.entities.scheduled_game", "ScheduledGame"),
    ("griddy_nfl.models.entities.site", "Site"),
    ("griddy_nfl.models.entities.team", "Team"),
    ("griddy_nfl.models.entities.team_info", "TeamInfo"),
    ("griddy_nfl.models.entities.team_matchup_rankings", "TeamMatchupRankings"),
    ("griddy_nfl.models.entities.venue", "Venue"),
    ("griddy_nfl.models.entities.weekly_game_detail", "WeeklyGameDetail"),
    ("griddy_nfl.models.entities.weekly_player", "WeeklyPlayer"),
    (
        "griddy_nfl.models.responses.game_preview_response",
        "GamePreviewResponse",
    ),
]
...
class TestModelsWithRequiredFields:
    ...
    def test_coaches_film_video(self):
        from griddy_nfl.models.entities.coaches_film_video import CoachesFilmVideo
        from griddy_nfl.models.entities.video_game_play_ids import VideoGamePlayIds
    ...
    def test_insight(self):
        from griddy_nfl.models.entities.insight import Insight
    ...
    def test_play_win_probability(self):
        from griddy_nfl.models.entities.play_win_probability import PlayWinProbability
    ...
    def test_player_week_projected_points(self):
        from griddy_nfl.models.entities.player_week_projected_points import (
    ...
    def test_player_week_projected_stats(self):
        from griddy_nfl.models.entities.player_week_projected_stats import (
...
class TestSerializerBranchCoverage:
    ...
    def test_player_with_set_nullable_field(self):
        ...
        from griddy_nfl.models.entities.player import Player
    ...
    def test_game_preview_response_with_null_preview(self):
        ...
        from griddy_nfl.models.responses.game_preview_response import (
            GamePreviewResponse,
        )
