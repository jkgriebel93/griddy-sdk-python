...
from griddy_nfl.utils.retries import (
    BackoffStrategy,
    PermanentError,
    Retries,
    RetryConfig,
...
@pytest.mark.unit
class TestRetry:
    @patch("griddy_nfl.utils.retries.retry_with_backoff")
    ...
    def test_connect_error_with_retry_enabled(self):
        ...
        with patch(
            "griddy_nfl.utils.retries.retry_with_backoff",
    ...
    def test_connect_error_without_retry(self):
        ...
        with patch("griddy_nfl.utils.retries.retry_with_backoff") as mock_backoff:
...
class TestRetryWithBackoff:
    @patch("griddy_nfl.utils.retries.time")
