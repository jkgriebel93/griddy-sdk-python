...
PlayerDetailNgsPosition = Literal[
    "C",
    "CB",
    "DB",
    "DE",
...
PlayerDetailNgsPositionGroup = Literal[
    "DB",
    "DL",
    "K",
    "LB",
...
class PlayerDetailTypedDict(TypedDict):
    ...
    ngs_position: NotRequired[Nullable[PlayerDetailNgsPosition]]
    ngs_position_group: NotRequired[Nullable[PlayerDetailNgsPositionGroup]]
...
class PlayerDetail(BaseModel):
    ...
    ngs_position: Annotated[
        OptionalNullable[PlayerDetailNgsPosition], pydantic.Field(alias="ngsPosition")
    ] = UNSET

    ngs_position_group: Annotated[
        OptionalNullable[PlayerDetailNgsPositionGroup],
