...
class ReplayCtaTypedDict(TypedDict):
    pass


class ReplayCta(BaseModel):
    pass
...
class ReplayImageTypedDict(TypedDict):
    pass


class ReplayImage(BaseModel):
    pass


class ReplayPromoAssetTypedDict(TypedDict):
    pass


class ReplayPromoAsset(BaseModel):
    pass
...
class ReplayVideoTypedDict(TypedDict):
    pass


class ReplayVideo(BaseModel):
    pass
...
class ReplayTypedDict(TypedDict):
    ...
    ctas: NotRequired[List[ReplayCtaTypedDict]]
    ...
    r"""Related entity identifiers"""
    images: NotRequired[List[ReplayImageTypedDict]]
    r"""Associated images"""
    ...
    promo_assets: NotRequired[List[ReplayPromoAssetTypedDict]]
    ...
    r"""Content type"""
    videos: NotRequired[List[ReplayVideoTypedDict]]
...
class Replay(BaseModel):
    ...
    ctas: Optional[List[ReplayCta]] = None
    r"""Call-to-action buttons"""
    ...
    images: Optional[List[ReplayImage]] = None
    r"""Associated images"""
    ...
    promo_assets: Annotated[
        Optional[List[ReplayPromoAsset]], pydantic.Field(alias="promoAssets")
    ] = None
    r"""Promotional assets"""
    ...
    videos: Optional[List[ReplayVideo]] = None
    r"""Associated video content"""
