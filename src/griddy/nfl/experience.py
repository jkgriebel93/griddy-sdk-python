...
class Experience(BaseSDK):
    ...
    def get_experience_games(
        ...
        *,
    ...
    ) -> Optional[models.ExperienceGamesResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_EXPERIENCE_GAMES_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.ExperienceGamesResponse], http_res
            )
    ...
    def get_experience_teams(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.ExperienceTeamsResponse]:
        r"""Get All Teams
        ...
        if server_url is not None:
            ...
            base_url = models.GET_EXPERIENCE_TEAMS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.ExperienceTeamsResponse], http_res
            )
        if utils.match_response(http_res, ["400", "401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
