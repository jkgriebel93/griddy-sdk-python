...
class Teams(BaseSDK):
    ...
    def get_all_teams(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_ALL_TEAMS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(Optional[List[models.ProTeam]], http_res)
    ...
    def get_team_roster(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.TeamRosterResponse]:
        r"""Get Team Roster
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEAM_ROSTER_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.TeamRosterResponse], http_res
            )
    ...
    def get_weekly_team_roster(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.WeeklyRosterResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_WEEKLY_TEAM_ROSTER_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.WeeklyRosterResponse], http_res
            )
        if utils.match_response(http_res, ["400", "401", "404", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
    ...
    def get_team_schedule(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[List[models.ScheduledGame]]:
        r"""Get Team Schedule
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEAM_SCHEDULE_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[List[models.ScheduledGame]], http_res
            )
        if utils.match_response(http_res, ["400", "401", "404", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
