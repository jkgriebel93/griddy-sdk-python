    ...
    def get_fantasy_stats_by_season(
        ...
        *,
        request: Union[
            ...
            models.GetFantasyStatsBySeasonRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.FantasyStatsResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_FANTASY_STATS_BY_SEASON_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetFantasyStatsBySeasonRequest)
        request = cast(models.GetFantasyStatsBySeasonRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.FantasyStatsResponse], http_res
            )
