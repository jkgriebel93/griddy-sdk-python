...
class FantasyStatistics(BaseSDK):
    ...
    def get_fantasy_stats_by_season(
        ...
        *,
        ...
        page: Optional[int] = 1,
        sort_key: Optional[
            models.GetFantasyStatsBySeasonQueryParamSortKey
        ] = models.GetFantasyStatsBySeasonQueryParamSortKey.FP_STD,
        sort_value: Optional[models.SortOrderEnum] = None,
        position_group: Optional[List[models.PositionGroup]] = None,
