...
class Football(BaseSDK):
    ...
    def get_weekly_game_details(
        ...
        *,
        request: Union[
            models.GetWeeklyGameDetailsRequest,
            models.GetWeeklyGameDetailsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetWeeklyGameDetailsRequest)
        request = cast(models.GetWeeklyGameDetailsRequest, request)
    ...
    def get_season_player_stats(
        ...
        *,
        request: Union[
            models.GetSeasonPlayerStatsRequest,
            models.GetSeasonPlayerStatsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetSeasonPlayerStatsRequest)
        request = cast(models.GetSeasonPlayerStatsRequest, request)
    ...
    def get_transactions(
        ...
        *,
        request: Union[
            models.GetTransactionsRequest, models.GetTransactionsRequestTypedDict
        ] = models.GetTransactionsRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetTransactionsRequest)
        request = cast(models.GetTransactionsRequest, request)
