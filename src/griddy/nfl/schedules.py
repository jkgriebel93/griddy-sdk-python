...
class Schedules(BaseSDK):
    ...
    def get_scheduled_game(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_SCHEDULED_GAME_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(Optional[models.GameDetail], http_res)
    ...
    def get_game_matchup_rankings(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.MatchupRankingsResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_GAME_MATCHUP_RANKINGS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.MatchupRankingsResponse], http_res
            )
        if utils.match_response(http_res, ["400", "401", "404", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
    ...
    def get_team_injuries(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEAM_INJURIES_OP_SERVERS[0]
    ...
    def get_scheduled_games(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_SCHEDULED_GAMES_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(Optional[models.GamesResponse], http_res)
