...
class StandingsRecordAllOfPoints(BaseModel):
    """
    StandingsRecordAllOfPoints
    """  # noqa: E501

    against: Optional[StrictInt] = Field(default=None, description="Points allowed")
    var_for: Optional[StrictInt] = Field(
        default=None, description="Points scored", alias="for"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"against": obj.get("against"), "for": obj.get("for")}
        )
        return _obj
