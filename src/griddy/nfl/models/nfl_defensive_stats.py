...
class NFLDefensiveStats(BaseModel):
    """
    NFLDefensiveStats
    """ # noqa: E501
    ...
    fumble_recoveries: Optional[StrictInt] = Field(default=None, alias="fumbleRecoveries")
    ...
    __properties: ClassVar[List[str]] = ["assistedTackles", "forcedFumbles", "fumbleRecoveries", "interceptions", "passesDefended", "qbHits", "sacks", "safeties", "soloTackles", "tackles", "tacklesForLoss"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fumbleRecoveries": obj.get("fumbleRecoveries"),
