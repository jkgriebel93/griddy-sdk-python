...
class NFLHomeFilmCardsResponse(BaseModel):
    """
    NFLHomeFilmCardsResponse
    """ # noqa: E501
    cards: Optional[List[NFLNFLFilmCard]] = None
    title: Optional[StrictStr] = Field(default=None, description="Title of the film card collection")
    __properties: ClassVar[List[str]] = ["cards", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cards": [NFLNFLFilmCard.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None,
            "title": obj.get("title")
        })
        return _obj
