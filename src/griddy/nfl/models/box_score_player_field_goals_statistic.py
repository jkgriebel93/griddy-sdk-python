...
class BoxScorePlayerFieldGoalsStatistic(BaseModel):
    ...
    avg_yard: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="avgYard"
    )
    longest_made_field_goal: Optional[StrictInt] = Field(
        default=None, alias="longestMadeFieldGoal"
    )
