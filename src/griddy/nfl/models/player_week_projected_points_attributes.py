...
class PlayerWeekProjectedPointsAttributes(BaseModel):
    ...
    player_id: Optional[StrictStr] = Field(
        default=None, description="Player SMART ID", alias="playerId"
    )
    points: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Projected fantasy points"
    )
    season: Optional[StrictInt] = Field(default=None, description="Season year")
    settings_code: Optional[StrictStr] = Field(
        default=None, description="Fantasy settings code", alias="settingsCode"
    )
