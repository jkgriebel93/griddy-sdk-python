...
class VideoAuthorizationsNflPlusPlusInner(BaseModel):
    """
    VideoAuthorizationsNflPlusPlusInner
    """  # noqa: E501

    nfl_plus___coaches_film: Optional[
        VideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM
    ] = Field(default=None, alias="NFL PLUS - COACHES FILM")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VideoAuthorizationsNflPlusPlusInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VideoAuthorizationsNflPlusPlusInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "NFL PLUS - COACHES FILM": (
                    VideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM.from_dict(
                        obj["NFL PLUS - COACHES FILM"]
                    )
                    if obj.get("NFL PLUS - COACHES FILM") is not None
                    else None
                )
            }
        )
