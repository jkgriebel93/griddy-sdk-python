...
class NFLPlayerProjection(BaseModel):
    ...
    NFLPlayerProjection
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Player SMART ID")
    relationships: Optional[NFLNFLPlayerProjectionRelationships] = None
    type: Optional[StrictStr] = Field(default=None, description="Resource type")
    __properties: ClassVar[List[str]] = ["id", "relationships", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['player']):
            raise ValueError("must be one of enum values ('player')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "relationships": NFLNFLPlayerProjectionRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
