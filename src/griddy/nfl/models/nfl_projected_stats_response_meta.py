...
class NFLProjectedStatsResponseMeta(BaseModel):
    """
    NFLProjectedStatsResponseMeta
    """ # noqa: E501
    page: Optional[NFLNFLProjectedStatsResponseMetaPage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": NFLNFLProjectedStatsResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
