...
class NFLSite(BaseModel):
    """
    Stadium or venue information for a game
    """ # noqa: E501
    postal_code: Optional[StrictStr] = Field(default=None, alias="postalCode")
    roof_type: Optional[NFLNFLRoofTypeEnum] = Field(default=None, alias="roofType")
    site_city: Optional[StrictStr] = Field(default=None, alias="siteCity")
    site_full_name: Optional[StrictStr] = Field(default=None, description="Stadium name", alias="siteFullName")
    ...
    __properties: ClassVar[List[str]] = ["postalCode", "roofType", "siteCity", "siteFullName", "siteId", "siteState", "smartId"]
