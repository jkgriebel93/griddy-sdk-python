...
class NFLPlayerWeekProjectedPointsAttributes(BaseModel):
    """
    NFLPlayerWeekProjectedPointsAttributes
    """ # noqa: E501
    player_id: Optional[StrictStr] = Field(default=None, description="Player SMART ID", alias="playerId")
    points: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Projected fantasy points")
    season: Optional[StrictInt] = Field(default=None, description="Season year")
    settings_code: Optional[StrictStr] = Field(default=None, description="Fantasy settings code", alias="settingsCode")
    week: Optional[StrictInt] = Field(default=None, description="Week number")
    __properties: ClassVar[List[str]] = ["playerId", "points", "season", "settingsCode", "week"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settingsCode": obj.get("settingsCode"),
            "week": obj.get("week")
        })
        return _obj
