...
class NFLMultipleRankingsCategory(BaseModel):
    """
    NFLMultipleRankingsCategory
    """ # noqa: E501
    pagination: Optional[NFLNFLMultipleRankingsCategoryPagination] = None
    stat_category: Optional[StrictStr] = Field(default=None, description="Category of statistic", alias="statCategory")
    stat_name: Optional[StrictStr] = Field(default=None, description="Name of specific statistic", alias="statName")
    teams: Optional[List[NFLNFLTeamRankingEntry]] = None
    __properties: ClassVar[List[str]] = ["pagination", "statCategory", "statName", "teams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": NFLNFLMultipleRankingsCategoryPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "statCategory": obj.get("statCategory"),
            "statName": obj.get("statName"),
            "teams": [NFLNFLTeamRankingEntry.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
