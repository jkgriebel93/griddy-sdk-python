...
class NFLInjuryEntryPracticeStatus(BaseModel):
    """
    NFLInjuryEntryPracticeStatus
    """ # noqa: E501
    friday: Optional[NFLNFLPracticeStatusEnum] = None
    thursday: Optional[NFLNFLPracticeStatusEnum] = None
    wednesday: Optional[NFLNFLPracticeStatusEnum] = None
    __properties: ClassVar[List[str]] = ["friday", "thursday", "wednesday"]
