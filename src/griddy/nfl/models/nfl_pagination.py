...
class NFLPagination(BaseModel):
    """
    NFLPagination
    """ # noqa: E501
    limit: Optional[StrictInt] = Field(default=None, description="Maximum items per page")
    token: Optional[StrictStr] = Field(default=None, description="Token for next page of results")
