...
class InjuryEntry(BaseModel):
    ...
    game_status: Optional[InjuredPlayerGameStatusEnum] = Field(
        default=None, alias="gameStatus"
    )
    injury: Optional[StrictStr] = Field(default=None, description="Injury description")
    player: Optional[Player] = None
    practice_status: Optional[InjuryEntryPracticeStatus] = Field(
        default=None, alias="practiceStatus"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "practiceStatus": (
                    InjuryEntryPracticeStatus.from_dict(obj["practiceStatus"])
                    if obj.get("practiceStatus") is not None
                    else None
                ),
            }
        )
