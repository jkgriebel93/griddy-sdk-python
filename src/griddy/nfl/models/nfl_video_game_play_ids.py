...
class NFLVideoGamePlayIds(BaseModel):
    """
    NFLVideoGamePlayIds
    """ # noqa: E501
    away_team_id: Optional[StrictStr] = Field(default=None, description="Away team UUID", alias="awayTeamId")
    game_id: Optional[StrictStr] = Field(default=None, description="Game UUID", alias="gameId")
    home_team_id: Optional[StrictStr] = Field(default=None, description="Home team UUID", alias="homeTeamId")
    play_id: Optional[StrictStr] = Field(default=None, description="Play identifier", alias="playId")
    __properties: ClassVar[List[str]] = ["awayTeamId", "gameId", "homeTeamId", "playId"]
