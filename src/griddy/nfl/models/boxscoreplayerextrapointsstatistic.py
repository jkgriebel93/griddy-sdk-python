...
class BoxScorePlayerExtraPointsStatisticTypedDict(TypedDict):
...
class BoxScorePlayerExtraPointsStatistic(BaseModel):
    ...
    attempt_cnt: Annotated[Optional[int], pydantic.Field(alias="attemptCnt")] = None
