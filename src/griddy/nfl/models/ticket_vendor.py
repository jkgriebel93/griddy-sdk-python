...
class TicketVendor(BaseModel):
    ...
    ticket_url: Optional[StrictStr] = Field(
        default=None, description="Vendor-specific ticket URL", alias="ticketUrl"
    )
    vendor_name: Optional[StrictStr] = Field(
        default=None, description="Vendor identifier", alias="vendorName"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"ticketUrl": obj.get("ticketUrl"), "vendorName": obj.get("vendorName")}
        )
        return _obj
