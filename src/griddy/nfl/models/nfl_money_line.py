...
class NFLMoneyLine(BaseModel):
    """
    Money line betting odds
    """ # noqa: E501
    away_price: Optional[StrictStr] = Field(default=None, description="Away team money line odds (American format)", alias="awayPrice")
    home_price: Optional[StrictStr] = Field(default=None, description="Home team money line odds (American format)", alias="homePrice")
    __properties: ClassVar[List[str]] = ["awayPrice", "homePrice"]
