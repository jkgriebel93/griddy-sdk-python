...
class RefreshTokenRequest(BaseModel):
    ...
    client_key: Optional[StrictStr] = Field(
        default=None, description="Client application identifier key", alias="clientKey"
    )
    ...
    device_info: Optional[StrictStr] = Field(
        default=None,
        description='Base64-encoded JSON containing device information such as: {"model":"desktop","version":"Chrome","osName":"Windows","osVersion":"10"} ',
        alias="deviceInfo",
    )
    network_type: Optional[NetworkTypeEnum] = Field(default=None, alias="networkType")
    refresh_token: Optional[StrictStr] = Field(
        default=None,
        description="Valid refresh token from previous authentication",
        alias="refreshToken",
    )
    signature_timestamp: Optional[StrictStr] = Field(
        default=None,
        description="Unix timestamp for signature verification",
        alias="signatureTimestamp",
    )
    uid: Optional[StrictStr] = Field(default=None, description="User identifier hash")
    uid_signature: Optional[StrictStr] = Field(
        default=None,
