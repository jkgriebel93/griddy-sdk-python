...
class PointSpread(BaseModel):
    ...
    away_handicap: Optional[StrictStr] = Field(
        default=None, description="Away team point spread", alias="awayHandicap"
    )
    away_price: Optional[StrictStr] = Field(
        default=None,
        description="Away team spread odds (American format)",
        alias="awayPrice",
    )
    home_handicap: Optional[StrictStr] = Field(
        default=None, description="Home team point spread", alias="homeHandicap"
    )
    home_price: Optional[StrictStr] = Field(
        default=None,
        description="Home team spread odds (American format)",
        alias="homePrice",
    )
