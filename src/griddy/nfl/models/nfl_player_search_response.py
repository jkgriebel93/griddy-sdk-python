...
class NFLPlayerSearchResponse(BaseModel):
    """
    NFLPlayerSearchResponse
    """ # noqa: E501
    players: Optional[List[NFLNFLPlayerSearchResult]] = Field(default=None, description="Array of players matching search criteria")
    term: Optional[StrictStr] = Field(default=None, description="Search term used")
    __properties: ClassVar[List[str]] = ["players", "term"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "players": [NFLNFLPlayerSearchResult.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
            "term": obj.get("term")
        })
        return _obj
