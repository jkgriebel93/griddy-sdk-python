...
class NFLGamecenterResponsePassers(BaseModel):
    """
    NFLGamecenterResponsePassers
    """ # noqa: E501
    home: Optional[NFLNFLPasserStats] = None
    visitor: Optional[NFLNFLPasserStats] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of visitor
        if self.visitor:
            _dict['visitor'] = self.visitor.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "home": NFLNFLPasserStats.from_dict(obj["home"]) if obj.get("home") is not None else None,
            "visitor": NFLNFLPasserStats.from_dict(obj["visitor"]) if obj.get("visitor") is not None else None
        })
        return _obj
