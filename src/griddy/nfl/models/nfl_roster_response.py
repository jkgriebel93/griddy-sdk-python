...
class NFLRosterResponse(BaseModel):
    """
    NFLRosterResponse
    """ # noqa: E501
    roster: Optional[NFLNFLRosterResponseRoster] = None
    season: Optional[StrictInt] = None
    team: Optional[NFLNFLTeam] = None
    __properties: ClassVar[List[str]] = ["roster", "season", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roster": NFLNFLRosterResponseRoster.from_dict(obj["roster"]) if obj.get("roster") is not None else None,
