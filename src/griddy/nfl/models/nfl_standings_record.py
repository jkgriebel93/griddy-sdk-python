...
from nfl.models.nflnfl_standings_record_all_of_points import NFLNFLStandingsRecordAllOfPoints
from typing import Optional, Set
from typing_extensions import Self

class NFLStandingsRecord(BaseModel):
    """
    NFLStandingsRecord
    """ # noqa: E501
    ...
    points: Optional[NFLNFLStandingsRecordAllOfPoints] = None
    rank: Optional[StrictInt] = Field(default=None, description="Ranking within group")
    win_pct: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Win percentage", alias="winPct")
    __properties: ClassVar[List[str]] = ["losses", "ties", "wins", "points", "rank", "winPct"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ties": obj.get("ties"),
            "wins": obj.get("wins"),
            "points": NFLNFLStandingsRecordAllOfPoints.from_dict(obj["points"]) if obj.get("points") is not None else None,
            "rank": obj.get("rank"),
