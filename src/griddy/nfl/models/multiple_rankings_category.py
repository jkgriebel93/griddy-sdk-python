...
class MultipleRankingsCategory(BaseModel):
    ...
    stat_category: Optional[StrictStr] = Field(
        default=None, description="Category of statistic", alias="statCategory"
    )
    stat_name: Optional[StrictStr] = Field(
        default=None, description="Name of specific statistic", alias="statName"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "pagination": (
                    MultipleRankingsCategoryPagination.from_dict(obj["pagination"])
                ...
                "teams": (
                    [TeamRankingEntry.from_dict(_item) for _item in obj["teams"]]
