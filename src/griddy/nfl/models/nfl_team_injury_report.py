...
class NFLTeamInjuryReport(BaseModel):
    """
    NFLTeamInjuryReport
    """ # noqa: E501
    injuries: Optional[List[NFLNFLInjuryEntry]] = None
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    team: Optional[NFLNFLTeam] = None
    __properties: ClassVar[List[str]] = ["injuries", "lastUpdated", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "injuries": [NFLNFLInjuryEntry.from_dict(_item) for _item in obj["injuries"]] if obj.get("injuries") is not None else None,
