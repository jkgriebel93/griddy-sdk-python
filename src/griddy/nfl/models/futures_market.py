...
class FuturesMarket(BaseModel):
    ...
    fixture: Optional[Dict[str, Any]] = Field(
        default=None, description="Associated fixture information"
    )
    fixture_id: Optional[StrictStr] = Field(
        default=None,
        description="Associated fixture ID if applicable",
        alias="fixtureId",
    )
    hierarchy: Optional[StrictStr] = Field(
        default=None, description="Full betting hierarchy path"
    )
    is_available: Optional[StrictBool] = Field(
        default=None,
        description="Whether market is currently available",
        alias="isAvailable",
    )
    is_suspended: Optional[StrictBool] = Field(
        default=None,
        description="Whether market is currently suspended",
        alias="isSuspended",
    )
    name: Optional[StrictStr] = Field(
        default=None, description='Market name (e.g., "Winner", "Division Winner")'
    )
    selections: Optional[List[OddsSelection]] = None
    source_id: Optional[StrictStr] = Field(
        default=None, description="Source identifier for the market", alias="sourceId"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "selections": (
                    [OddsSelection.from_dict(_item) for _item in obj["selections"]]
