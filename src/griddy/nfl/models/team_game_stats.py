...
class TeamGameStats(BaseModel):
    ...
    fourth_down_conversions: Optional[StrictStr] = Field(
        default=None, alias="fourthDownConversions"
    )
    ...
    third_down_conversions: Optional[StrictStr] = Field(
        default=None, alias="thirdDownConversions"
    )
    time_of_possession: Optional[StrictStr] = Field(
        default=None, alias="timeOfPossession"
    )
