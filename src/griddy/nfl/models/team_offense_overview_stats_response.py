...
class TeamOffenseOverviewStatsResponse(BaseModel):
    ...
    split: Optional[List[StrictStr]] = Field(
        default=None, description="Applied offensive situation splits"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "offense": (
                    [
                        TeamOffenseOverviewStats.from_dict(_item)
                        for _item in obj["offense"]
                    ]
