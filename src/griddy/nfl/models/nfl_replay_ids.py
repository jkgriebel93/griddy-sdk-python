...
class NFLReplayIds(BaseModel):
    """
    Related entity identifiers
    """ # noqa: E501
    away_team_id: Optional[StrictStr] = Field(default=None, alias="awayTeamId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if play_id (nullable) is None
        # and model_fields_set contains the field
        if self.play_id is None and "play_id" in self.model_fields_set:
            _dict['playId'] = None
