...
class NFLSpeedLeaderEntry(BaseModel):
    """
    NFLSpeedLeaderEntry
    """ # noqa: E501
    max_speed: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxSpeed")
    ...
    __properties: ClassVar[List[str]] = ["gsisPlayId", "esbId", "jerseyNumber", "playerName", "position", "shortName", "teamId", "headshot"]
