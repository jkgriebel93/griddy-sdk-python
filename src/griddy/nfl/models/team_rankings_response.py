...
class TeamRankingsResponse(BaseModel):
    ...
    away_rankings: Optional[TeamRankings] = Field(default=None, alias="awayRankings")
    home_rankings: Optional[TeamRankings] = Field(default=None, alias="homeRankings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "awayRankings": (
                    TeamRankings.from_dict(obj["awayRankings"])
                    if obj.get("awayRankings") is not None
                    else None
                ),
                "homeRankings": (
                    TeamRankings.from_dict(obj["homeRankings"])
                    if obj.get("homeRankings") is not None
                    else None
                ),
            }
        )
