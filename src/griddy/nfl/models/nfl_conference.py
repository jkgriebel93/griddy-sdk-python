...
class NFLConference(BaseModel):
    """
    NFLConference
    """ # noqa: E501
    abbr: Optional[NFLNFLConferenceEnum] = None
    full_name: Optional[StrictStr] = Field(default=None, description="Full conference name", alias="fullName")
    id: Optional[StrictStr] = Field(default=None, description="Conference identifier")
