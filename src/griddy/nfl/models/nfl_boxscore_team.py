...
class NFLBoxscoreTeam(BaseModel):
    """
    NFLBoxscoreTeam
    """ # noqa: E501
    ...
    division_abbr: Optional[StrictStr] = Field(default=None, alias="divisionAbbr")
    ...
    __properties: ClassVar[List[str]] = ["abbr", "cityState", "conferenceAbbr", "divisionAbbr", "fullName", "logo", "nick", "smartId", "teamId", "teamType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "divisionAbbr": obj.get("divisionAbbr"),
