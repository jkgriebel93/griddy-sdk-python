...
class TackleInfoTypedDict(TypedDict):
    time_to_tackle: NotRequired[float]


class TackleInfo(BaseModel):
    time_to_tackle: Annotated[Optional[float], pydantic.Field(alias="timeToTackle")] = (
        None
    )


class TimeToSackLeaderEntryTypedDict(TypedDict):
    ...
    tackle_info: NotRequired[TackleInfoTypedDict]
...
class TimeToSackLeaderEntry(BaseModel):
    ...
    tackle_info: Annotated[Optional[TackleInfo], pydantic.Field(alias="tackleInfo")] = (
        None
    )
