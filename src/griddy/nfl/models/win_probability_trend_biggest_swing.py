...
class WinProbabilityTrendBiggestSwing(BaseModel):
    """
    WinProbabilityTrendBiggestSwing
    """  # noqa: E501

    play: Optional[PlayWinProbability] = None
    probability_change: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Absolute change in win probability",
        alias="probabilityChange",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "play": (
                    PlayWinProbability.from_dict(obj["play"])
