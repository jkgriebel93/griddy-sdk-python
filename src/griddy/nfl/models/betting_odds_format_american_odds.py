...
class BettingOddsFormatAmericanOdds(BaseModel):
    """
    BettingOddsFormatAmericanOdds
    """  # noqa: E501

    description: Optional[StrictStr] = None
    examples: Optional[List[BettingOddsFormatAmericanOddsExamplesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "examples": (
                    [
                        BettingOddsFormatAmericanOddsExamplesInner.from_dict(_item)
                        for _item in obj["examples"]
                    ]
