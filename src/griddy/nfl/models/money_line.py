...
class MoneyLine(BaseModel):
    ...
    away_price: Optional[StrictStr] = Field(
        default=None,
        description="Away team money line odds (American format)",
        alias="awayPrice",
    )
    home_price: Optional[StrictStr] = Field(
        default=None,
        description="Home team money line odds (American format)",
        alias="homePrice",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"awayPrice": obj.get("awayPrice"), "homePrice": obj.get("homePrice")}
        )
        return _obj
