...
class ReplayThumbnail(BaseModel):
    """
    Video thumbnail information
    """  # noqa: E501

    thumbnail_url: Optional[StrictStr] = Field(
        default=None, description="URL to video thumbnail image", alias="thumbnailUrl"
    )
    __properties: ClassVar[List[str]] = ["thumbnailUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"thumbnailUrl": obj.get("thumbnailUrl")})
        return _obj
