...
class NFLPassingStats(BaseModel):
    """
    NFLPassingStats
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["attempts", "completionPct", "completions", "interceptions", "rating", "sackYards", "sacks", "touchdowns", "yards"]
