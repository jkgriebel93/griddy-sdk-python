...
class NFLStandingsResponseWeeksInner(BaseModel):
    """
    NFLStandingsResponseWeeksInner
    """ # noqa: E501
    standings: Optional[List[NFLNFLStandings]] = None
    week: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["standings", "week"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "standings": [NFLNFLStandings.from_dict(_item) for _item in obj["standings"]] if obj.get("standings") is not None else None,
            "week": obj.get("week")
        })
        return _obj
