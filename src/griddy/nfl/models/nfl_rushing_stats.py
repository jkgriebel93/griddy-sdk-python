...
class NFLRushingStats(BaseModel):
    """
    NFLRushingStats
    """ # noqa: E501
    carries: Optional[StrictInt] = None
    fumbles: Optional[StrictInt] = None
    long_rush: Optional[StrictInt] = Field(default=None, alias="longRush")
    touchdowns: Optional[StrictInt] = None
    yards: Optional[StrictInt] = None
    yards_per_carry: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="yardsPerCarry")
    __properties: ClassVar[List[str]] = ["carries", "fumbles", "longRush", "touchdowns", "yards", "yardsPerCarry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "longRush": obj.get("longRush"),
            "touchdowns": obj.get("touchdowns"),
            "yards": obj.get("yards"),
            "yardsPerCarry": obj.get("yardsPerCarry")
        })
        return _obj
