...
class NFLDefensiveMetricsExplanation(BaseModel):
    """
    Explanation of defensive metrics and calculations
    """ # noqa: E501
    epa: Optional[NFLNFLDefensiveMetricsExplanationEpa] = None
    qbp_pct: Optional[NFLNFLDefensiveMetricsExplanationQbpPct] = Field(default=None, alias="qbpPct")
    ryoe: Optional[NFLNFLDefensiveMetricsExplanationRyoe] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "epa": NFLNFLDefensiveMetricsExplanationEpa.from_dict(obj["epa"]) if obj.get("epa") is not None else None,
            "qbpPct": NFLNFLDefensiveMetricsExplanationQbpPct.from_dict(obj["qbpPct"]) if obj.get("qbpPct") is not None else None,
            "ryoe": NFLNFLDefensiveMetricsExplanationRyoe.from_dict(obj["ryoe"]) if obj.get("ryoe") is not None else None
        })
        return _obj
