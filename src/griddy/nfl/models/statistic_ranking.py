...
class StatisticRanking(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(
        default=None, description="Team's rank in this category (1-32)"
    )
    statistic: Optional[StatisticRankingStatistic] = None
        ...
        _obj = cls.model_validate(
            {
                "rank": obj.get("rank"),
                "statistic": (
                    StatisticRankingStatistic.from_dict(obj["statistic"])
