...
class NFLPlayerProjectionRelationshipsWeekStatsInner(BaseModel):
    """
    NFLPlayerProjectionRelationshipsWeekStatsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Reference to projected stats")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['player-week-projected-stats']):
            raise ValueError("must be one of enum values ('player-week-projected-stats')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFLPlayerProjectionRelationshipsWeekStatsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFLPlayerProjectionRelationshipsWeekStatsInner from a dict"""
        if obj is None:
            return None
