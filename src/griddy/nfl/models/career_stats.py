...
class CareerStats(BaseModel):
    ...
    season_stats: Optional[List[SeasonStats]] = Field(default=None, alias="seasonStats")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "seasonStats": (
                    [SeasonStats.from_dict(_item) for _item in obj["seasonStats"]]
                    if obj.get("seasonStats") is not None
                    else None
                ),
