...
class NFLCoachesFilmResponse(BaseModel):
    """
    NFLCoachesFilmResponse
    """ # noqa: E501
    items: Optional[List[NFLNFLCoachesFilmVideo]] = None
    metadata: Optional[NFLNFLResponseMetadata] = None
    pagination: Optional[NFLNFLPagination] = None
    __properties: ClassVar[List[str]] = ["items", "metadata", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NFLNFLCoachesFilmVideo.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "metadata": NFLNFLResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
