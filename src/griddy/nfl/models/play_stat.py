...
class PlayStat(BaseModel):
    ...
    club_code: Optional[StrictStr] = Field(
        default=None, description="Team abbreviation", alias="clubCode"
    )
    gsis_id: Optional[StrictStr] = Field(
        default=None, description="Player GSIS ID", alias="gsisId"
    )
    play_id: Optional[StrictInt] = Field(default=None, alias="playId")
    player_name: Optional[StrictStr] = Field(
        default=None, description="Player name", alias="playerName"
    )
    stat_id: Optional[StrictInt] = Field(
        default=None, description="Type of statistic", alias="statId"
    )
