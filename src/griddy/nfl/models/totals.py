...
class Totals(BaseModel):
    ...
    over_handicap: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Total points line for over", alias="overHandicap"
    )
    over_price: Optional[StrictInt] = Field(
        default=None, description="Over odds (American format)", alias="overPrice"
    )
    under_handicap: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Total points line for under", alias="underHandicap"
    )
    under_price: Optional[StrictInt] = Field(
        default=None, description="Under odds (American format)", alias="underPrice"
    )
