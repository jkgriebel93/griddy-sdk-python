...
class QualifiedPasserCriteria(BaseModel):
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="Explanation of qualification criteria"
    )
    minimum_attempts: Optional[StrictInt] = Field(
        default=None,
        description="Minimum passing attempts required",
        alias="minimumAttempts",
    )
    minimum_attempts_per_game: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Minimum attempts per team game",
        alias="minimumAttemptsPerGame",
    )
    season_type: Optional[SeasonTypeEnum] = Field(default=None, alias="seasonType")
    __properties: ClassVar[List[str]] = [
        "description",
        "minimumAttempts",
        "minimumAttemptsPerGame",
        "seasonType",
    ]
