...
class FilmCard(BaseModel):
    ...
    link_params: Optional[FilmCardLinkParams] = Field(default=None, alias="linkParams")
    team_id: Optional[StrictStr] = Field(
        default=None, description="Team identifier", alias="teamId"
    )
    title: Optional[StrictStr] = Field(
        default=None, description="Title of the film content"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "linkParams": (
                    FilmCardLinkParams.from_dict(obj["linkParams"])
                    if obj.get("linkParams") is not None
                    else None
                ),
