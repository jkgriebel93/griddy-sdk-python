...
class NFLWeeklyGameDetailSummaryTeam(BaseModel):
    """
    Team game state in summary
    """ # noqa: E501
    has_possession: Optional[StrictBool] = Field(default=None, description="Whether the team currently has possession", alias="hasPossession")
    score: Optional[NFLNFLWeeklyGameDetailSummaryScore] = None
    team_id: Optional[StrictStr] = Field(default=None, description="Team identifier (UUID format)", alias="teamId")
    timeouts: Optional[NFLNFLWeeklyGameDetailSummaryTimeouts] = None
    __properties: ClassVar[List[str]] = ["hasPossession", "score", "teamId", "timeouts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hasPossession": obj.get("hasPossession"),
            "score": NFLNFLWeeklyGameDetailSummaryScore.from_dict(obj["score"]) if obj.get("score") is not None else None,
            "teamId": obj.get("teamId"),
            "timeouts": NFLNFLWeeklyGameDetailSummaryTimeouts.from_dict(obj["timeouts"]) if obj.get("timeouts") is not None else None
        })
        return _obj
