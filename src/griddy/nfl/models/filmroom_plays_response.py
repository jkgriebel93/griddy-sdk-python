...
class FilmroomPlaysResponse(BaseModel):
    ...
    count: Optional[StrictInt] = Field(
        default=None, description="Total number of plays matching the filter criteria"
    )
    plays: Optional[List[FilmroomPlay]] = Field(
        default=None, description="Array of play data matching the filter criteria"
    )
        ...
        _obj = cls.model_validate(
            {
                "count": obj.get("count"),
                "plays": (
                    [FilmroomPlay.from_dict(_item) for _item in obj["plays"]]
