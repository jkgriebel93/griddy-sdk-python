...
class DefensiveSplitCategory(BaseModel):
    """
    Definition of defensive situation categories
    """  # noqa: E501

    category: Optional[StrictStr] = Field(
        default=None, description="Split category name"
    )
    description: Optional[StrictStr] = Field(
        default=None, description="Category description"
    )
    situation_type: Optional[DefensiveSituationTypeEnum] = Field(
        default=None, alias="situationType"
    )
