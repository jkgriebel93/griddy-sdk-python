...
class BroadcastInfoStreamingNetworksInner(BaseModel):
    """
    BroadcastInfoStreamingNetworksInner
    """  # noqa: E501

    host_network: Optional[StrictStr] = Field(
        default=None, description="Primary streaming network", alias="hostNetwork"
    )
    networks: Optional[List[StrictStr]] = Field(
        default=None, description="Available streaming networks"
    )
    __properties: ClassVar[List[str]] = ["hostNetwork", "networks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"hostNetwork": obj.get("hostNetwork"), "networks": obj.get("networks")}
        )
        return _obj
