...
class NFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM(BaseModel):
    """
    NFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM
    """ # noqa: E501
    requirements: Optional[NFLNFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILMRequirements] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "requirements": NFLNFLVideoAuthorizationsNflPlusPlusInnerNFLPLUSCOACHESFILMRequirements.from_dict(obj["requirements"]) if obj.get("requirements") is not None else None
        })
        return _obj
