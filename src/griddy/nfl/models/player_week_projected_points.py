...
class PlayerWeekProjectedPoints(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="Unique identifier for this projection"
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["player-week-projected-points"]):
            raise ValueError(
                "must be one of enum values ('player-week-projected-points')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    PlayerWeekProjectedPointsAttributes.from_dict(obj["attributes"])
