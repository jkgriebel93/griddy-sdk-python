...
class NFLBoxScoreResponsePlayerStats(BaseModel):
    """
    NFLBoxScoreResponsePlayerStats
    """ # noqa: E501
    away: Optional[NFLNFLBoxScoreResponsePlayerStatsAway] = None
    home: Optional[NFLNFLBoxScoreResponsePlayerStatsAway] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "away": NFLNFLBoxScoreResponsePlayerStatsAway.from_dict(obj["away"]) if obj.get("away") is not None else None,
            "home": NFLNFLBoxScoreResponsePlayerStatsAway.from_dict(obj["home"]) if obj.get("home") is not None else None
        })
        return _obj
