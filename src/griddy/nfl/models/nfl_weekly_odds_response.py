...
class NFLWeeklyOddsResponse(BaseModel):
    """
    NFLWeeklyOddsResponse
    """ # noqa: E501
    games: Optional[List[NFLNFLGameOdds]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "games": [NFLNFLGameOdds.from_dict(_item) for _item in obj["games"]] if obj.get("games") is not None else None,
