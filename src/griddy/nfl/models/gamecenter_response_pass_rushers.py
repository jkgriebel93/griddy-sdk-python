...
class GamecenterResponsePassRushers(BaseModel):
    ...
    league_average_separation_to_qb: Optional[
        GamecenterResponsePassRushersLeagueAverageSeparationToQb
    ] = Field(default=None, alias="leagueAverageSeparationToQb")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.league_average_separation_to_qb:
            _dict["leagueAverageSeparationToQb"] = (
                self.league_average_separation_to_qb.to_dict()
            )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "home": (
                    [PassRusherStats.from_dict(_item) for _item in obj["home"]]
                    if obj.get("home") is not None
                    else None
                ),
                "leagueAverageSeparationToQb": (
                    GamecenterResponsePassRushersLeagueAverageSeparationToQb.from_dict(
                        obj["leagueAverageSeparationToQb"]
                    )
                    if obj.get("leagueAverageSeparationToQb") is not None
                    else None
                ),
                "visitor": (
                    [PassRusherStats.from_dict(_item) for _item in obj["visitor"]]
