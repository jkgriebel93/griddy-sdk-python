...
class NFLInjuryReportResponse(BaseModel):
    """
    NFLInjuryReportResponse
    """ # noqa: E501
    reports: Optional[List[NFLNFLTeamInjuryReport]] = None
    season: Optional[StrictInt] = None
    week: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["reports", "season", "week"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [NFLNFLTeamInjuryReport.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
