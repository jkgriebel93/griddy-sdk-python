...
class WeeklyGameDetailSummaryTeam(BaseModel):
    ...
    has_possession: Optional[StrictBool] = Field(
        default=None,
        description="Whether the team currently has possession",
        alias="hasPossession",
    )
    score: Optional[WeeklyGameDetailSummaryScore] = None
    team_id: Optional[StrictStr] = Field(
        default=None, description="Team identifier (UUID format)", alias="teamId"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "score": (
                    WeeklyGameDetailSummaryScore.from_dict(obj["score"])
                    if obj.get("score") is not None
                    else None
                ),
                "teamId": obj.get("teamId"),
                "timeouts": (
                    WeeklyGameDetailSummaryTimeouts.from_dict(obj["timeouts"])
