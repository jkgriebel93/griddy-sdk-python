...
class PlayerWeekProjectedStatsType(str, Enum):
    PLAYER_WEEK_PROJECTED_STATS = "player-week-projected-stats"


class PlayerWeekProjectedStatsTypedDict(TypedDict):
    attributes: NotRequired[PlayerWeekProjectedStatsAttributesTypedDict]
    id: NotRequired[str]
    r"""Unique identifier for these stats"""
    type: NotRequired[PlayerWeekProjectedStatsType]
...
class PlayerWeekProjectedStats(BaseModel):
    ...
    type: Optional[PlayerWeekProjectedStatsType] = None
