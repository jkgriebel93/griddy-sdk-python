...
class WinProbabilityTrendFinalProbability(BaseModel):
    """
    ...
    ] = Field(default=None, alias="awayTeam")
    home_team: Optional[
        Union[
            Annotated[float, Field(le=1, strict=True, ge=0)],
            Annotated[int, Field(le=1, strict=True, ge=0)],
        ]
    ] = Field(default=None, alias="homeTeam")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WinProbabilityTrendFinalProbability from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WinProbabilityTrendFinalProbability from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"awayTeam": obj.get("awayTeam"), "homeTeam": obj.get("homeTeam")}
        )
        return _obj
