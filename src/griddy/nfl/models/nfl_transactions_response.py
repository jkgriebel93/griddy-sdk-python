...
class NFLTransactionsResponse(BaseModel):
    """
    NFLTransactionsResponse
    """ # noqa: E501
    pagination: Optional[NFLNFLPagination] = None
    transactions: Optional[List[NFLNFLTransaction]] = None
    __properties: ClassVar[List[str]] = ["pagination", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [NFLNFLTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
