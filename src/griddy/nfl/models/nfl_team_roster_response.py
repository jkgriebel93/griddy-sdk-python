...
class NFLTeamRosterResponse(BaseModel):
    """
    ...
    team_players: Optional[List[NFLNFLPlayer]] = Field(default=None, alias="teamPlayers")
    __properties: ClassVar[List[str]] = ["season", "team", "teamPlayers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teamPlayers": [NFLNFLPlayer.from_dict(_item) for _item in obj["teamPlayers"]] if obj.get("teamPlayers") is not None else None
        })
        return _obj
