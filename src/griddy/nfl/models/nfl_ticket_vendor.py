...
class NFLTicketVendor(BaseModel):
    """
    NFLTicketVendor
    """ # noqa: E501
    ticket_url: Optional[StrictStr] = Field(default=None, description="Vendor-specific ticket URL", alias="ticketUrl")
    vendor_name: Optional[StrictStr] = Field(default=None, description="Vendor identifier", alias="vendorName")
    __properties: ClassVar[List[str]] = ["ticketUrl", "vendorName"]
