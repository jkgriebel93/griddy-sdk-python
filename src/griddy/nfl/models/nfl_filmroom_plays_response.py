...
class NFLFilmroomPlaysResponse(BaseModel):
    """
    NFLFilmroomPlaysResponse
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total number of plays matching the filter criteria")
    plays: Optional[List[NFLNFLFilmroomPlay]] = Field(default=None, description="Array of play data matching the filter criteria")
    __properties: ClassVar[List[str]] = ["count", "plays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "plays": [NFLNFLFilmroomPlay.from_dict(_item) for _item in obj["plays"]] if obj.get("plays") is not None else None
        })
        return _obj
