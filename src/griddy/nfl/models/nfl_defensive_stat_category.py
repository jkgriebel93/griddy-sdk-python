...
class NFLDefensiveStatCategory(BaseModel):
    """
    Definition of defensive statistical categories
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Category name")
    data_type: Optional[NFLNFLDataTypeEnum] = Field(default=None, alias="dataType")
    description: Optional[StrictStr] = Field(default=None, description="Category description")
    unit: Optional[StrictStr] = Field(default=None, description="Unit of measurement (if applicable)")
    __properties: ClassVar[List[str]] = ["category", "dataType", "description", "unit"]
