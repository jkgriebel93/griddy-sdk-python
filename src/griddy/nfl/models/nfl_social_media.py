...
class NFLSocialMedia(BaseModel):
    """
    NFLSocialMedia
    """ # noqa: E501
    link: Optional[StrictStr] = Field(default=None, description="URL to social media profile")
    platform: Optional[StrictStr] = Field(default=None, description="Social media platform name")
    __properties: ClassVar[List[str]] = ["link", "platform"]
