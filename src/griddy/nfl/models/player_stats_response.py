...
class PlayerStatsResponse(BaseModel):
    ...
    players: Optional[List[PlayerStatsResponsePlayersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "pagination": (
                    PlayerStatsResponsePagination.from_dict(obj["pagination"])
                    if obj.get("pagination") is not None
                    else None
                ),
                "players": (
                    [
                        PlayerStatsResponsePlayersInner.from_dict(_item)
                        for _item in obj["players"]
                    ]
