...
class GamecenterResponseReceivers(BaseModel):
    ...
    league_average_receiver_separation: Optional[
        GamecenterResponseReceiversLeagueAverageReceiverSeparation
    ] = Field(default=None, alias="leagueAverageReceiverSeparation")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.league_average_receiver_separation:
            _dict["leagueAverageReceiverSeparation"] = (
                self.league_average_receiver_separation.to_dict()
            )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "home": (
                    [ReceiverStats.from_dict(_item) for _item in obj["home"]]
                    if obj.get("home") is not None
                    else None
                ),
                "leagueAverageReceiverSeparation": (
                    GamecenterResponseReceiversLeagueAverageReceiverSeparation.from_dict(
                        obj["leagueAverageReceiverSeparation"]
                    )
                    if obj.get("leagueAverageReceiverSeparation") is not None
                    else None
                ),
                "visitor": (
                    [ReceiverStats.from_dict(_item) for _item in obj["visitor"]]
                    if obj.get("visitor") is not None
                    else None
                ),
            }
        )
