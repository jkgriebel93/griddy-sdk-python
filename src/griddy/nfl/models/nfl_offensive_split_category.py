...
class NFLOffensiveSplitCategory(BaseModel):
    """
    Definition of offensive situation categories
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="Split category name")
    description: Optional[StrictStr] = Field(default=None, description="Category description")
    situation_type: Optional[NFLNFLOffensiveSituationTypeEnum] = Field(default=None, alias="situationType")
    __properties: ClassVar[List[str]] = ["category", "description", "situationType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "situationType": obj.get("situationType")
        })
        return _obj
