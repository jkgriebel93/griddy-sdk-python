...
class ProInjuryReportResponse(BaseModel):
    """
    ProInjuryReportResponse
    """  # noqa: E501

    injuries: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="Array of injured players (empty if no injuries)"
    )
    pagination: Optional[ProInjuryReportResponsePagination] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pagination": (
                    ProInjuryReportResponsePagination.from_dict(obj["pagination"])
