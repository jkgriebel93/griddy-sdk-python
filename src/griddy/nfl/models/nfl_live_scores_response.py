...
class NFLLiveScoresResponse(BaseModel):
    """
    NFLLiveScoresResponse
    """ # noqa: E501
    games: Optional[List[NFLNFLLiveGame]] = Field(default=None, description="Array of live game data (empty when no games are active)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "games": [NFLNFLLiveGame.from_dict(_item) for _item in obj["games"]] if obj.get("games") is not None else None,
