...
class NFLTeamBoxScore(BaseModel):
    ...
    NFLTeamBoxScore
    """ # noqa: E501
    away: Optional[NFLNFLTeamBoxscore] = None
    game_id: Optional[StrictStr] = Field(default=None, description="Game identifier", alias="gameId")
    home: Optional[NFLNFLTeamBoxscore] = None
    schedule: Optional[NFLNFLBoxscoreSchedule] = None
    __properties: ClassVar[List[str]] = ["away", "gameId", "home", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "away": NFLNFLTeamBoxscore.from_dict(obj["away"]) if obj.get("away") is not None else None,
            "gameId": obj.get("gameId"),
            "home": NFLNFLTeamBoxscore.from_dict(obj["home"]) if obj.get("home") is not None else None,
            "schedule": NFLNFLBoxscoreSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
