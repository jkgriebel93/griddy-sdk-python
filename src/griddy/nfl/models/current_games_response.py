...
class CurrentGamesResponse(BaseModel):
    ...
    games_played_smart_ids: Optional[List[StrictStr]] = Field(
        default=None,
        description="Smart IDs of games already played",
        alias="gamesPlayedSmartIds",
    )
    number_of_games: Optional[StrictInt] = Field(
        default=None,
        description="Total number of games in the week",
        alias="numberOfGames",
    )
    number_of_games_played: Optional[StrictInt] = Field(
        default=None,
        description="Number of games already played",
        alias="numberOfGamesPlayed",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "games": (
                    [CurrentGame.from_dict(_item) for _item in obj["games"]]
