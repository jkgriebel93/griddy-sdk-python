...
class NFLGameStatsResponse(BaseModel):
    """
    NFLGameStatsResponse
    """ # noqa: E501
    data: Optional[List[NFLNFLSummary]] = Field(default=None, description="Array of live game state summaries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [NFLNFLSummary.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
