...
class NFLExternalId(BaseModel):
    """
    NFLExternalId
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID in external system")
    source: Optional[StrictStr] = Field(default=None, description="External system name")
