...
class NFLPlayParticipant(BaseModel):
    """
    NFLPlayParticipant
    """ # noqa: E501
    player: Optional[NFLNFLPlayer] = None
    role: Optional[NFLNFLPlayParticipantRoleEnum] = None
    stats: Optional[Dict[str, Any]] = Field(default=None, description="Play-specific statistics")
    __properties: ClassVar[List[str]] = ["player", "role", "stats"]
