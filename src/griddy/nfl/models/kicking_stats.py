...
class KickingStats(BaseModel):
    ...
    extra_points_attempted: Optional[StrictInt] = Field(
        default=None, alias="extraPointsAttempted"
    )
    extra_points_made: Optional[StrictInt] = Field(
        default=None, alias="extraPointsMade"
    )
    field_goal_pct: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="fieldGoalPct"
    )
    field_goals_attempted: Optional[StrictInt] = Field(
        default=None, alias="fieldGoalsAttempted"
    )
