...
class OddsSelection(BaseModel):
    ...
    decimal: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Decimal odds for this selection"
    )
    is_available: Optional[StrictBool] = Field(
        default=None,
        description="Whether this selection is currently available for betting",
        alias="isAvailable",
    )
    name: Optional[StrictStr] = Field(
        default=None, description='Team name (e.g., "KC Chiefs", "BUF Bills")'
    )
