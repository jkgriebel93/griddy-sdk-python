...
class GamecenterResponseLeadersTimeToSackLeaders(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "home": (
                    [TimeToSackLeaderEntry.from_dict(_item) for _item in obj["home"]]
                    if obj.get("home") is not None
                    else None
                ),
                "visitor": (
                    [TimeToSackLeaderEntry.from_dict(_item) for _item in obj["visitor"]]
