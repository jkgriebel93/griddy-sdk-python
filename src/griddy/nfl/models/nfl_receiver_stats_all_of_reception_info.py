...
class NFLReceiverStatsAllOfReceptionInfo(BaseModel):
    """
    NFLReceiverStatsAllOfReceptionInfo
    """ # noqa: E501
    avg_air_yards: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgAirYards")
    avg_cushion: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgCushion")
    avg_separation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgSeparation")
    __properties: ClassVar[List[str]] = ["avgAirYards", "avgCushion", "avgSeparation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "avgAirYards": obj.get("avgAirYards"),
            "avgCushion": obj.get("avgCushion"),
            "avgSeparation": obj.get("avgSeparation")
        })
        return _obj
