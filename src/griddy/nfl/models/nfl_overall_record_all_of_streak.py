...
class NFLOverallRecordAllOfStreak(BaseModel):
    """
    NFLOverallRecordAllOfStreak
    """ # noqa: E501
    length: Optional[StrictInt] = Field(default=None, description="Length of current streak")
    type: Optional[NFLNFLGameResultEnum] = None
