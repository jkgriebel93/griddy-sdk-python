...
class VideoGamePlayIds(BaseModel):
    ...
    away_team_id: Optional[StrictStr] = Field(
        default=None, description="Away team UUID", alias="awayTeamId"
    )
    game_id: Optional[StrictStr] = Field(
        default=None, description="Game UUID", alias="gameId"
    )
    home_team_id: Optional[StrictStr] = Field(
        default=None, description="Home team UUID", alias="homeTeamId"
    )
