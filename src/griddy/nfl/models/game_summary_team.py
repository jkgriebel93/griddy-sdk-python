...
class GameSummaryTeam(BaseModel):
    ...
    score: Optional[GameSummaryTeamScore] = None
    timeouts: Optional[GameSummaryTeamTimeouts] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "score": (
                    GameSummaryTeamScore.from_dict(obj["score"])
                    if obj.get("score") is not None
                    else None
                ),
                "timeouts": (
                    GameSummaryTeamTimeouts.from_dict(obj["timeouts"])
