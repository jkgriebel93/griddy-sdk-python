...
class NFLBettingOddsFormatAmericanOdds(BaseModel):
    """
    NFLBettingOddsFormatAmericanOdds
    """ # noqa: E501
    description: Optional[StrictStr] = None
    examples: Optional[List[NFLNFLBettingOddsFormatAmericanOddsExamplesInner]] = None
    __properties: ClassVar[List[str]] = ["description", "examples"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFLBettingOddsFormatAmericanOdds from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFLBettingOddsFormatAmericanOdds from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "examples": [NFLNFLBettingOddsFormatAmericanOddsExamplesInner.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None
        })
        return _obj
