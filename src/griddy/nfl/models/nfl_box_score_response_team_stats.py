...
class NFLBoxScoreResponseTeamStats(BaseModel):
    """
    NFLBoxScoreResponseTeamStats
    """ # noqa: E501
    away: Optional[NFLNFLTeamGameStats] = None
    home: Optional[NFLNFLTeamGameStats] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "away": NFLNFLTeamGameStats.from_dict(obj["away"]) if obj.get("away") is not None else None,
            "home": NFLNFLTeamGameStats.from_dict(obj["home"]) if obj.get("home") is not None else None
        })
        return _obj
