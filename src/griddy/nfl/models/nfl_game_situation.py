...
class NFLGameSituation(BaseModel):
    """
    Game situation context for win probability calculations
    """ # noqa: E501
    down: Optional[Annotated[int, Field(le=4, strict=True, ge=1)]] = Field(default=None, description="Current down")
    score: Optional[NFLNFLGameScore] = None
    time_remaining: Optional[StrictStr] = Field(default=None, description="Time remaining in the current quarter", alias="timeRemaining")
    yard_line: Optional[StrictStr] = Field(default=None, description="Field position where play occurred", alias="yardLine")
    yards_to_go: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Yards needed for first down", alias="yardsToGo")
    __properties: ClassVar[List[str]] = ["down", "score", "timeRemaining", "yardLine", "yardsToGo"]
