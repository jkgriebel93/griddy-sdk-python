...
class NFLPlayerStatsResponse(BaseModel):
    ...
    """ # noqa: E501
    pagination: Optional[NFLNFLPlayerStatsResponsePagination] = None
    players: Optional[List[NFLNFLPlayerStatsResponsePlayersInner]] = None
    season: Optional[StrictInt] = None
    season_type: Optional[NFLNFLSeasonTypeEnum] = Field(default=None, alias="seasonType")
    stat_category: Optional[StrictStr] = Field(default=None, alias="statCategory")
    __properties: ClassVar[List[str]] = ["pagination", "players", "season", "seasonType", "statCategory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": NFLNFLPlayerStatsResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "players": [NFLNFLPlayerStatsResponsePlayersInner.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
