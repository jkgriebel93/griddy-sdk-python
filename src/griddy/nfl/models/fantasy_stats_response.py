...
class FantasyStatsResponse(BaseModel):
    ...
    last_n_weeks: Optional[StrictInt] = Field(
        default=None,
        description="Number of recent weeks analyzed (if applied)",
        alias="lastNWeeks",
    )
    min_offensive_snaps: Optional[StrictInt] = Field(
        default=None,
        description="Minimum offensive snaps filter applied",
        alias="minOffensiveSnaps",
    )
    position_group: Optional[List[FantasyPositionGroupEnum]] = Field(
        default=None, alias="positionGroup"
    )
    team_offense: Optional[StrictStr] = Field(
        default=None,
        description="Offensive team filter applied (if any)",
        alias="teamOffense",
    )
    week: Optional[List[WeekSlugEnum]] = Field(
        default=None, description="Specific weeks included in analysis"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "total": obj.get("total"),
                "players": (
                    [FantasyPlayerStats.from_dict(_item) for _item in obj["players"]]
