...
class NFLGameSummaryTeam(BaseModel):
    """
    NFLGameSummaryTeam
    """ # noqa: E501
    team_id: Optional[StrictStr] = Field(default=None, alias="teamId")
    has_possession: Optional[StrictBool] = Field(default=None, alias="hasPossession")
    score: Optional[NFLNFLGameSummaryTeamScore] = None
    timeouts: Optional[NFLNFLGameSummaryTeamTimeouts] = None
    __properties: ClassVar[List[str]] = ["teamId", "hasPossession", "score", "timeouts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "score": NFLNFLGameSummaryTeamScore.from_dict(obj["score"]) if obj.get("score") is not None else None,
            "timeouts": NFLNFLGameSummaryTeamTimeouts.from_dict(obj["timeouts"]) if obj.get("timeouts") is not None else None
        })
        return _obj
