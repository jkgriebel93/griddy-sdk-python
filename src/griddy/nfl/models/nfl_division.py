...
class NFLDivision(BaseModel):
    """
    NFLDivision
    """ # noqa: E501
    abbr: Optional[StrictStr] = Field(default=None, description="Division abbreviation")
    full_name: Optional[StrictStr] = Field(default=None, description="Full division name", alias="fullName")
    id: Optional[StrictStr] = Field(default=None, description="Division identifier")
    __properties: ClassVar[List[str]] = ["abbr", "fullName", "id"]
