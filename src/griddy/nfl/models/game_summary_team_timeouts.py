...
class GameSummaryTeamTimeouts(BaseModel):
    """
    GameSummaryTeamTimeouts
    """  # noqa: E501

    remaining: Optional[Annotated[int, Field(le=3, strict=True, ge=0)]] = None
    used: Optional[Annotated[int, Field(le=3, strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["remaining", "used"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"remaining": obj.get("remaining"), "used": obj.get("used")}
        )
        return _obj
