...
class NFLResponseMetadata(BaseModel):
    """
    NFLResponseMetadata
    """ # noqa: E501
    generated_at: Optional[datetime] = Field(default=None, description="Response generation timestamp", alias="generatedAt")
    __properties: ClassVar[List[str]] = ["generatedAt"]
