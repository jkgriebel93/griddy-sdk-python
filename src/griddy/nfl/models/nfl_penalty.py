...
class NFLPenalty(BaseModel):
    """
    NFLPenalty
    """ # noqa: E501
    accepted: Optional[StrictBool] = None
    no_play: Optional[StrictBool] = Field(default=None, alias="noPlay")
    player: Optional[NFLNFLPlayer] = None
    team: Optional[NFLNFLTeam] = None
    type: Optional[StrictStr] = None
    yards: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["accepted", "noPlay", "player", "team", "type", "yards"]
