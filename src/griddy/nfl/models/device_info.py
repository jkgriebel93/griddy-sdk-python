...
class DeviceInfo(BaseModel):
    ...
    model: Optional[StrictStr] = Field(
        default=None, description="Device model or form factor"
    )
    os_name: Optional[StrictStr] = Field(
        default=None, description="Operating system name", alias="osName"
    )
    os_version: Optional[StrictStr] = Field(
        default=None, description="Operating system version", alias="osVersion"
    )
    version: Optional[StrictStr] = Field(
        default=None, description="Browser or application version"
    )
