...
class TokenResponse(BaseModel):
    ...
    access_token: Optional[StrictStr] = Field(
        default=None,
        description='JWT access token containing user permissions, subscription plans, location data, and roles. Include this token in the Authorization header as "Bearer {accessToken}" for authenticated requests.',
        alias="accessToken",
    )
