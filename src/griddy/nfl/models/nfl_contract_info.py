...
class NFLContractInfo(BaseModel):
    """
    NFLContractInfo
    """ # noqa: E501
    expiration_year: Optional[StrictInt] = Field(default=None, description="Contract expiration year", alias="expirationYear")
    guaranteed: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Guaranteed money")
    signing_bonus: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Signing bonus", alias="signingBonus")
    total_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total contract value", alias="totalValue")
    years: Optional[StrictInt] = Field(default=None, description="Contract length in years")
    __properties: ClassVar[List[str]] = ["expirationYear", "guaranteed", "signingBonus", "totalValue", "years"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signingBonus": obj.get("signingBonus"),
