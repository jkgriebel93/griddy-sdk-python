...
class OverallRecord(BaseModel):
    ...
    points: Optional[PointsRecordAllOfPoints] = None
    win_pct: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="winPct"
    )
    games: Optional[StrictInt] = Field(default=None, description="Total games played")
    streak: Optional[OverallRecordAllOfStreak] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "wins": obj.get("wins"),
                "points": (
                    PointsRecordAllOfPoints.from_dict(obj["points"])
                ...
                "games": obj.get("games"),
                "streak": (
                    OverallRecordAllOfStreak.from_dict(obj["streak"])
                    if obj.get("streak") is not None
                    else None
                ),
            }
        )
