...
class NFLDeviceInfo(BaseModel):
    """
    Device information object (normally base64 encoded in requests)
    """ # noqa: E501
    model: Optional[StrictStr] = Field(default=None, description="Device model or form factor")
    os_name: Optional[StrictStr] = Field(default=None, description="Operating system name", alias="osName")
    os_version: Optional[StrictStr] = Field(default=None, description="Operating system version", alias="osVersion")
    version: Optional[StrictStr] = Field(default=None, description="Browser or application version")
    __properties: ClassVar[List[str]] = ["model", "osName", "osVersion", "version"]
