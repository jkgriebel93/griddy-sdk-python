...
class NFLScoringPlay(BaseModel):
    """
    NFLScoringPlay
    """ # noqa: E501
    ...
    score_type: Optional[NFLNFLScoreTypeEnum] = Field(default=None, alias="scoreType")
    team: Optional[NFLNFLTeam] = None
    __properties: ClassVar[List[str]] = ["awayScore", "description", "gameClock", "homeScore", "quarter", "scoreType", "team"]
