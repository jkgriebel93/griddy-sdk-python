...
class NFLFilmCard(BaseModel):
    """
    NFLFilmCard
    """ # noqa: E501
    link_params: Optional[NFLNFLFilmCardLinkParams] = Field(default=None, alias="linkParams")
    team_id: Optional[StrictStr] = Field(default=None, description="Team identifier", alias="teamId")
    title: Optional[StrictStr] = Field(default=None, description="Title of the film content")
    __properties: ClassVar[List[str]] = ["linkParams", "teamId", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "linkParams": NFLNFLFilmCardLinkParams.from_dict(obj["linkParams"]) if obj.get("linkParams") is not None else None,
