...
class BoxScoreResponsePlayerStats(BaseModel):
    """
    BoxScoreResponsePlayerStats
    """  # noqa: E501

    away: Optional[BoxScoreResponsePlayerStatsAway] = None
    home: Optional[BoxScoreResponsePlayerStatsAway] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "away": (
                    BoxScoreResponsePlayerStatsAway.from_dict(obj["away"])
                    if obj.get("away") is not None
                    else None
                ),
                "home": (
                    BoxScoreResponsePlayerStatsAway.from_dict(obj["home"])
