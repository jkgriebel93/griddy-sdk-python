...
from nfl.models.nflnfl_overall_record_all_of_streak import NFLNFLOverallRecordAllOfStreak
from nfl.models.nflnfl_points_record_all_of_points import NFLNFLPointsRecordAllOfPoints
from typing import Optional, Set
from typing_extensions import Self

class NFLOverallRecord(BaseModel):
    """
    NFLOverallRecord
    """ # noqa: E501
    ...
    points: Optional[NFLNFLPointsRecordAllOfPoints] = None
    win_pct: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="winPct")
    games: Optional[StrictInt] = Field(default=None, description="Total games played")
    streak: Optional[NFLNFLOverallRecordAllOfStreak] = None
    __properties: ClassVar[List[str]] = ["losses", "ties", "wins", "points", "winPct", "games", "streak"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ties": obj.get("ties"),
            "wins": obj.get("wins"),
            "points": NFLNFLPointsRecordAllOfPoints.from_dict(obj["points"]) if obj.get("points") is not None else None,
            "winPct": obj.get("winPct"),
            "games": obj.get("games"),
            "streak": NFLNFLOverallRecordAllOfStreak.from_dict(obj["streak"]) if obj.get("streak") is not None else None
        })
        return _obj
