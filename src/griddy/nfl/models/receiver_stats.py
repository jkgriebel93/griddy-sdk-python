...
class ReceiverStats(BaseModel):
    ...
    reception_info: Optional[ReceiverStatsAllOfReceptionInfo] = Field(
        default=None, alias="receptionInfo"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "receptionInfo": (
                    ReceiverStatsAllOfReceptionInfo.from_dict(obj["receptionInfo"])
                    if obj.get("receptionInfo") is not None
                    else None
                ),
            }
        )
