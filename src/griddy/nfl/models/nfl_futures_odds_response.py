...
class NFLFuturesOddsResponse(BaseModel):
    """
    NFLFuturesOddsResponse
    """ # noqa: E501
    data: Optional[NFLNFLFuturesOddsResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": NFLNFLFuturesOddsResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
