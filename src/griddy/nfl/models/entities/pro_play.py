...
class UnofficialPlay(BaseModel):
    date_time_stamp_utc: Annotated[
        str,
        pydantic.Field(alias="dateTimeStampUTC")
    ]
...
class OffenseInfo(BaseModel):
    offense_formation: Annotated[
        str,
        pydantic.Field(alias="offenseFormation")
    ]
    personnel: str
...
class DefenseInfo(BaseModel):
    defenders_in_the_box: Annotated[
        int,
        pydantic.Field(alias="defendersInTheBox")
    ]
    personnel: str
    number_of_pass_rushers: Annotated[
        Optional[int],
        pydantic.Field(alias="numberOfPassRushers")
    ] = None
    man_zone_type: Annotated[
        Optional[str],
        pydantic.Field(alias="manZoneType")
    ] = None
    coverage_type: Annotated[
        Optional[str],
        pydantic.Field(alias="coverageType")
    ] = None
...
class PassInfo(BaseModel):
    air_yards: Annotated[
        Optional[float],
        pydantic.Field(alias="airYards")
    ] = None
    time_to_throw: Annotated[
        Optional[float],
        pydantic.Field(alias="timeToThrow")
    ] = None
    was_pressure: Annotated[
        Optional[bool],
        pydantic.Field(alias="wasPressure")
    ] = None
...
class ProPlay(BaseModel):
    ...
    home_score: Annotated[
        int,
        pydantic.Field(alias="homeScore")
    ]
    is_big_play: Annotated[
        bool,
        pydantic.Field(alias="isBigPlay")
    ]
    is_stp_play: Annotated[
        bool,
        pydantic.Field(alias="isSTPlay")
    ]
    is_scoring: Annotated[
        bool,
        pydantic.Field(alias="isScoring")
    ]
    play_description: Annotated[
        str,
        pydantic.Field(alias="playDescription")
    ]
    # TODO: This should probably be an enum
    play_state: Annotated[
        str,
        pydantic.Field(alias="playState")
    ]
    play_stats: Annotated[
        List[PlayStat],
        pydantic.Field(alias="playStats")
    ]
    play_type: Annotated[
        str,
    ...
    possession_team: Annotated[
        str,
        pydantic.Field(alias="possessionTeam")
    ]
    possession_team_id: Annotated[
        str,
        pydantic.Field(alias="possessionTeamId")
    ]
    quarter: int
    season: int
    ...
    sequence: float
    visitor_score: Annotated[
        int,
        pydantic.Field(alias="visitorScore")
    ]
    week: int
    ...
    nfl_ids: Annotated[
        List[int],
        pydantic.Field(alias="nflIds")
    ]
    is_marker_play: Annotated[
        bool,
        pydantic.Field(alias="isMarkerPlay")
    ]

    # Required but nullable (always present, value may be null)
    unofficial_play: Annotated[
        Optional[UnofficialPlay],
        pydantic.Field(alias="unofficialPlay")
    ]
    yard_line_number: Annotated[
        Optional[int],
        pydantic.Field(alias="yardlineNumber")
    ]
    yard_line_side: Annotated[
        Optional[str],
        pydantic.Field(alias="yardlineSide")
    ]

    # Conditional fields (may be absent from API response)
    end_game_clock: Annotated[
        Optional[str],
        pydantic.Field(alias="endGameClock")
    ] = None
    start_game_clock: Annotated[
        Optional[str],
        pydantic.Field(alias="startGameClock")
    ] = None
    is_red_zone_play: Annotated[
        Optional[bool],
        pydantic.Field(alias="isRedzonePlay")
    ] = None
    offense: Optional[OffenseInfo] = None
    defense: Optional[DefenseInfo] = None
    pass_info: Annotated[
        Optional[PassInfo],
        pydantic.Field(alias="passInfo")
    ] = None
    rec_info: Annotated[
        Optional[RecInfo],
        pydantic.Field(alias="recInfo")
    ] = None
