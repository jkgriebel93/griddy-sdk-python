...
class PlayerSearchResponse(BaseModel):
    ...
    players: Optional[List[PlayerSearchResult]] = Field(
        default=None, description="Array of players matching search criteria"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "players": (
                    [PlayerSearchResult.from_dict(_item) for _item in obj["players"]]
