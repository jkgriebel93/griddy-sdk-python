...
class NFLGameTeam(BaseModel):
    ...
    score: Optional[NFLNFLGameTeamScore] = None
    team_id: Optional[StrictStr] = Field(default=None, alias="teamId")
    __properties: ClassVar[List[str]] = ["currentLogo", "fullName", "id", "score", "teamId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "score": NFLNFLGameTeamScore.from_dict(obj["score"]) if obj.get("score") is not None else None,
