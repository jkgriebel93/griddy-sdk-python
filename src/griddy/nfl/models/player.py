...
class PlayerNgsPosition(str, Enum):
...
class PlayerNgsPositionGroup(str, Enum):
...
class PlayerTypedDict(TypedDict):
    ...
    ngs_position: NotRequired[Nullable[PlayerNgsPosition]]
    ngs_position_group: NotRequired[Nullable[PlayerNgsPositionGroup]]
...
class Player(BaseModel):
    ...
    ngs_position: Annotated[
        OptionalNullable[PlayerNgsPosition], pydantic.Field(alias="ngsPosition")
    ] = UNSET

    ngs_position_group: Annotated[
        OptionalNullable[PlayerNgsPositionGroup],
