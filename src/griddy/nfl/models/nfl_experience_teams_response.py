...
class NFLExperienceTeamsResponse(BaseModel):
    """
    NFLExperienceTeamsResponse
    """ # noqa: E501
    teams: Optional[List[NFLNFLTeam]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [NFLNFLTeam.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
