...
class ReceiverStatsAllOfReceptionInfo(BaseModel):
    """
    ReceiverStatsAllOfReceptionInfo
    """  # noqa: E501

    avg_air_yards: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="avgAirYards"
    )
    avg_cushion: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="avgCushion"
    )
    avg_separation: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="avgSeparation"
    )
