...
class NFLStatisticRankingStatistic(BaseModel):
    """
    NFLStatisticRankingStatistic
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Statistical category name")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Statistical value")
