...
class NFLBroadcastInfoInternationalWatchOptionsInner(BaseModel):
    """
    NFLBroadcastInfoInternationalWatchOptionsInner
    """ # noqa: E501
    broadcasters: Optional[List[StrictStr]] = None
    country_code: Optional[StrictStr] = Field(default=None, alias="countryCode")
    __properties: ClassVar[List[str]] = ["broadcasters", "countryCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFLBroadcastInfoInternationalWatchOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFLBroadcastInfoInternationalWatchOptionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "broadcasters": obj.get("broadcasters"),
