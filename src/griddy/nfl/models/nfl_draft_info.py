...
class NFLDraftInfo(BaseModel):
    """
    NFLDraftInfo
    """ # noqa: E501
    pick: Optional[StrictInt] = Field(default=None, description="Overall pick number")
    round: Optional[StrictInt] = Field(default=None, description="Draft round")
    team: Optional[StrictStr] = Field(default=None, description="Team that drafted player")
    year: Optional[StrictInt] = Field(default=None, description="Draft year")
    __properties: ClassVar[List[str]] = ["pick", "round", "team", "year"]
