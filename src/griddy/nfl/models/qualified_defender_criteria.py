...
class QualifiedDefenderCriteria(BaseModel):
    """
    ...
    minimum_coverage_snaps: Optional[StrictInt] = Field(
        default=None,
        description="Minimum coverage snaps required",
        alias="minimumCoverageSnaps",
    )
    minimum_snaps: Optional[StrictInt] = Field(
        default=None,
        description="Minimum defensive snaps required",
        alias="minimumSnaps",
    )
    season_type: Optional[SeasonTypeEnum] = Field(default=None, alias="seasonType")
    __properties: ClassVar[List[str]] = [
        "description",
        "minimumCoverageSnaps",
        "minimumSnaps",
        "seasonType",
    ]
