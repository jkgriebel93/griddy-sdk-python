...
class WinProbabilityResponse(BaseModel):
    ...
    plays: Optional[List[PlayWinProbability]] = Field(
        default=None,
        description="Chronological list of all plays with win probability data",
    )
    pregame_away_team_win_probability: Optional[
        Union[
        ...
        default=None,
        description="Away team's win probability before the game started",
        alias="pregameAwayTeamWinProbability",
    )
    pregame_home_team_win_probability: Optional[
        Union[
            Annotated[float, Field(le=1, strict=True, ge=0)],
            Annotated[int, Field(le=1, strict=True, ge=0)],
        ]
        ...
        default=None,
        description="Home team's win probability before the game started",
        alias="pregameHomeTeamWinProbability",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "plays": (
                    [PlayWinProbability.from_dict(_item) for _item in obj["plays"]]
                    if obj.get("plays") is not None
                    else None
                ),
                "pregameAwayTeamWinProbability": obj.get(
                    "pregameAwayTeamWinProbability"
                ),
                "pregameHomeTeamWinProbability": obj.get(
                    "pregameHomeTeamWinProbability"
                ),
            }
        )
