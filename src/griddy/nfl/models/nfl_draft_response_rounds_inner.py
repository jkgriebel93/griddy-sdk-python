...
class NFLDraftResponseRoundsInner(BaseModel):
    """
    NFLDraftResponseRoundsInner
    """ # noqa: E501
    picks: Optional[List[NFLNFLDraftPick]] = None
    round: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["picks", "round"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in picks (list)
        _items = []
        if self.picks:
            for _item_picks in self.picks:
                if _item_picks:
                    _items.append(_item_picks.to_dict())
            _dict['picks'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "picks": [NFLNFLDraftPick.from_dict(_item) for _item in obj["picks"]] if obj.get("picks") is not None else None,
            "round": obj.get("round")
        })
        return _obj
