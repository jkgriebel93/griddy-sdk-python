...
class NFLProInjuryReportResponse(BaseModel):
    """
    NFLProInjuryReportResponse
    """ # noqa: E501
    injuries: Optional[List[Dict[str, Any]]] = Field(default=None, description="Array of injured players (empty if no injuries)")
    pagination: Optional[NFLNFLProInjuryReportResponsePagination] = None
    __properties: ClassVar[List[str]] = ["injuries", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": NFLNFLProInjuryReportResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
