...
class GameInsight(BaseModel):
    ...
    title: Optional[StrictStr] = Field(
        default=None, description="A short-ish description of the insight"
    )
    sub_note1: Optional[StrictStr] = Field(
        default=None,
        description="A longer elaboration of the insight",
        alias="subNote1",
    )
    ...
    created_by: Optional[StrictStr] = Field(
        default=None,
        description="Appears to be the username of the NFL staff that created the insight",
        alias="createdBy",
    )
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="Appears to be a UUID with dashes removed"
    )
