...
class NFLStatisticRanking(BaseModel):
    """
    NFLStatisticRanking
    """ # noqa: E501
    rank: Optional[StrictInt] = Field(default=None, description="Team's rank in this category (1-32)")
    statistic: Optional[NFLNFLStatisticRankingStatistic] = None
    __properties: ClassVar[List[str]] = ["rank", "statistic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rank": obj.get("rank"),
            "statistic": NFLNFLStatisticRankingStatistic.from_dict(obj["statistic"]) if obj.get("statistic") is not None else None
        })
        return _obj
