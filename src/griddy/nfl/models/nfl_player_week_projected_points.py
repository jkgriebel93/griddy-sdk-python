...
class NFLPlayerWeekProjectedPoints(BaseModel):
    """
    NFLPlayerWeekProjectedPoints
    """ # noqa: E501
    attributes: Optional[NFLNFLPlayerWeekProjectedPointsAttributes] = None
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this projection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": NFLNFLPlayerWeekProjectedPointsAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
