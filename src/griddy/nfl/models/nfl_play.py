...
class NFLPlay(BaseModel):
    ...
    penalties: Optional[List[NFLNFLPenalty]] = None
    ...
    players: Optional[List[NFLNFLPlayParticipant]] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "distance", "down", "gameClock", "penalties", "playId", "playNumber", "playType", "players", "quarter", "result", "yardLine", "yardsGained"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "penalties": [NFLNFLPenalty.from_dict(_item) for _item in obj["penalties"]] if obj.get("penalties") is not None else None,
            "playId": obj.get("playId"),
            "playNumber": obj.get("playNumber"),
            "playType": obj.get("playType"),
            "players": [NFLNFLPlayParticipant.from_dict(_item) for _item in obj["players"]] if obj.get("players") is not None else None,
