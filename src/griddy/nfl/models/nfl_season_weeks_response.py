...
class NFLSeasonWeeksResponse(BaseModel):
    """
    ...
    weeks: Optional[List[NFLNFLWeek]] = None
    __properties: ClassVar[List[str]] = ["pagination", "season", "weeks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weeks": [NFLNFLWeek.from_dict(_item) for _item in obj["weeks"]] if obj.get("weeks") is not None else None
        })
        return _obj
