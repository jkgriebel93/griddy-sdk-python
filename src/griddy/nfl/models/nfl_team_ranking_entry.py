...
class NFLTeamRankingEntry(BaseModel):
    """
    NFLTeamRankingEntry
    """ # noqa: E501
    rank: Optional[StrictInt] = Field(default=None, description="Team's rank (1-32)")
    stats: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Statistical value")
    team_id: Optional[StrictStr] = Field(default=None, alias="teamId")
    __properties: ClassVar[List[str]] = ["rank", "stats", "teamId"]
