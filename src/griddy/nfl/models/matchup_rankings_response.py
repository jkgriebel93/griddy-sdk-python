...
class MatchupRankingsResponse(BaseModel):
    ...
    home_team_matchup_rankings: Optional[TeamMatchupRankings] = Field(
        default=None, alias="homeTeamMatchupRankings"
    )
    season: Optional[StrictInt] = None
    season_type: Optional[SeasonTypeEnum] = Field(default=None, alias="seasonType")
    visitor_team_matchup_rankings: Optional[TeamMatchupRankings] = Field(
        default=None, alias="visitorTeamMatchupRankings"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.visitor_team_matchup_rankings:
            _dict["visitorTeamMatchupRankings"] = (
                self.visitor_team_matchup_rankings.to_dict()
            )
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "homeTeamMatchupRankings": (
                    TeamMatchupRankings.from_dict(obj["homeTeamMatchupRankings"])
                    if obj.get("homeTeamMatchupRankings") is not None
                    else None
                ),
                "season": obj.get("season"),
                "seasonType": obj.get("seasonType"),
                "visitorTeamMatchupRankings": (
                    TeamMatchupRankings.from_dict(obj["visitorTeamMatchupRankings"])
                    if obj.get("visitorTeamMatchupRankings") is not None
                    else None
                ),
                "week": obj.get("week"),
            }
