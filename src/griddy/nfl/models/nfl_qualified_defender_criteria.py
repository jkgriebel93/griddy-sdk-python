...
class NFLQualifiedDefenderCriteria(BaseModel):
    """
    ...
    minimum_coverage_snaps: Optional[StrictInt] = Field(default=None, description="Minimum coverage snaps required", alias="minimumCoverageSnaps")
    minimum_snaps: Optional[StrictInt] = Field(default=None, description="Minimum defensive snaps required", alias="minimumSnaps")
    season_type: Optional[NFLNFLSeasonTypeEnum] = Field(default=None, alias="seasonType")
    __properties: ClassVar[List[str]] = ["description", "minimumCoverageSnaps", "minimumSnaps", "seasonType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minimumCoverageSnaps": obj.get("minimumCoverageSnaps"),
            "minimumSnaps": obj.get("minimumSnaps"),
