...
class NFLQualifiedPasserCriteria(BaseModel):
    """
    Criteria for qualified passer designation
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Explanation of qualification criteria")
    minimum_attempts: Optional[StrictInt] = Field(default=None, description="Minimum passing attempts required", alias="minimumAttempts")
    minimum_attempts_per_game: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum attempts per team game", alias="minimumAttemptsPerGame")
    season_type: Optional[NFLNFLSeasonTypeEnum] = Field(default=None, alias="seasonType")
    __properties: ClassVar[List[str]] = ["description", "minimumAttempts", "minimumAttemptsPerGame", "seasonType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minimumAttempts": obj.get("minimumAttempts"),
            "minimumAttemptsPerGame": obj.get("minimumAttemptsPerGame"),
