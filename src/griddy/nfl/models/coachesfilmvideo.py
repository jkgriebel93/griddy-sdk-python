...
class PromoAssetsTypedDict(TypedDict):
    pass


class PromoAssets(BaseModel):
    pass


class CoachesFilmVideoType(str, Enum):
    r"""Content type (always \"video\")"""

    VIDEO = "video"


class VideosTypedDict(TypedDict):
    pass
...
class CoachesFilmVideoTypedDict(TypedDict):
    ...
    ctas: NotRequired[List[CtasTypedDict]]
    ...
    promo_assets: NotRequired[List[PromoAssetsTypedDict]]
    ...
    r"""Content type (always \"video\")"""
    videos: NotRequired[List[VideosTypedDict]]
...
class CoachesFilmVideo(BaseModel):
    ...
    promo_assets: Annotated[
        Optional[List[PromoAssets]], pydantic.Field(alias="promoAssets")
    ] = None
    r"""Promotional assets"""
