...
class GamecenterResponseLeadersPassDistanceLeaders(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GamecenterResponseLeadersPassDistanceLeaders from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GamecenterResponseLeadersPassDistanceLeaders from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "home": (
                    [PassDistanceLeaderEntry.from_dict(_item) for _item in obj["home"]]
                    if obj.get("home") is not None
                    else None
                ),
                "visitor": (
                    [
                        PassDistanceLeaderEntry.from_dict(_item)
                        for _item in obj["visitor"]
                    ]
