...
class NFLGamecenterSchedule(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["gameDate", "gameId", "gameKey", "gameTimeEastern", "homeTeamAbbr", "homeTeamId", "season", "seasonType", "visitorTeamAbbr", "visitorTeamId", "week"]
