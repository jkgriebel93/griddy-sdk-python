...
class NFLReceivingStats(BaseModel):
    """
    NFLReceivingStats
    """ # noqa: E501
    drops: Optional[StrictInt] = None
    long_reception: Optional[StrictInt] = Field(default=None, alias="longReception")
    ...
    yards_per_reception: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="yardsPerReception")
    __properties: ClassVar[List[str]] = ["drops", "longReception", "receptions", "targets", "touchdowns", "yards", "yardsPerReception"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "drops": obj.get("drops"),
            "longReception": obj.get("longReception"),
            "receptions": obj.get("receptions"),
            "targets": obj.get("targets"),
            "touchdowns": obj.get("touchdowns"),
            "yards": obj.get("yards"),
            "yardsPerReception": obj.get("yardsPerReception")
        })
        return _obj
