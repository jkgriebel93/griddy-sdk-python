...
class NFLPlayerStatsResponsePlayersInner(BaseModel):
    """
    NFLPlayerStatsResponsePlayersInner
    """ # noqa: E501
    player: Optional[NFLNFLPlayer] = None
    stats: Optional[Dict[str, Any]] = Field(default=None, description="Statistics object varies by category")
    team: Optional[NFLNFLTeam] = None
    __properties: ClassVar[List[str]] = ["player", "stats", "team"]
