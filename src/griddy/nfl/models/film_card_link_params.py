...
class FilmCardLinkParams(BaseModel):
    """
    Parameters for constructing film room link
    """  # noqa: E501

    dropback: Optional[StrictInt] = Field(
        default=None, description="Dropback indicator (1 for yes)"
    )
    nfl_id: Optional[StrictStr] = Field(
        default=None, description="NFL player identifier", alias="nflId"
    )
    passer_id: Optional[StrictStr] = Field(
        default=None, description="Passer ID for QB film", alias="passerId"
    )
    rusher_id: Optional[StrictStr] = Field(
        default=None, description="Rusher ID for RB film", alias="rusherId"
    )
    season: Optional[StrictStr] = Field(default=None, description="Season year")
    target_id: Optional[StrictStr] = Field(
        default=None, description="Target ID for receiver film", alias="targetId"
    )
