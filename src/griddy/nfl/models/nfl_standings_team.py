...
class NFLStandingsTeam(BaseModel):
    """
    NFLStandingsTeam
    """ # noqa: E501
    current_logo: Optional[StrictStr] = Field(default=None, alias="currentLogo")
    full_name: Optional[StrictStr] = Field(default=None, alias="fullName")
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["currentLogo", "fullName", "id"]
