...
class NFLBroadcastInfoStreamingNetworksInner(BaseModel):
    """
    NFLBroadcastInfoStreamingNetworksInner
    """ # noqa: E501
    host_network: Optional[StrictStr] = Field(default=None, description="Primary streaming network", alias="hostNetwork")
    networks: Optional[List[StrictStr]] = Field(default=None, description="Available streaming networks")
