...
class NFLStandingsResponse(BaseModel):
    ...
    """ # noqa: E501
    pagination: Optional[NFLNFLPagination] = None
    season: Optional[StrictInt] = None
    season_type: Optional[NFLNFLSeasonTypeEnum] = Field(default=None, alias="seasonType")
    week: Optional[StrictInt] = Field(default=None, description="Current week for standings")
    weeks: Optional[List[NFLNFLStandingsResponseWeeksInner]] = None
    __properties: ClassVar[List[str]] = ["pagination", "season", "seasonType", "week", "weeks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": NFLNFLPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "season": obj.get("season"),
            "seasonType": obj.get("seasonType"),
            "week": obj.get("week"),
            "weeks": [NFLNFLStandingsResponseWeeksInner.from_dict(_item) for _item in obj["weeks"]] if obj.get("weeks") is not None else None
        })
        return _obj
