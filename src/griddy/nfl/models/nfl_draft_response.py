...
class NFLDraftResponse(BaseModel):
    """
    NFLDraftResponse
    """ # noqa: E501
    rounds: Optional[List[NFLNFLDraftResponseRoundsInner]] = None
    year: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["rounds", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rounds": [NFLNFLDraftResponseRoundsInner.from_dict(_item) for _item in obj["rounds"]] if obj.get("rounds") is not None else None,
            "year": obj.get("year")
        })
        return _obj
