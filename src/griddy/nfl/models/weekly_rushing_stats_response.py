...
class WeeklyRushingStatsResponse(BaseModel):
    ...
    rushers: Optional[List[WeeklyPlayerRushingStats]] = None
    qualified_rusher: Optional[StrictBool] = Field(
        default=None,
        description="Whether results are filtered to qualified rushers only",
        alias="qualifiedRusher",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "rushers": (
                    [
                        WeeklyPlayerRushingStats.from_dict(_item)
                        for _item in obj["rushers"]
                    ]
