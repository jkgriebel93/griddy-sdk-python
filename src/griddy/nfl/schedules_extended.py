...
class SchedulesExtended(BaseSDK):
    ...
    def get_current_week_games(
        ...
        *,
    ...
    ) -> Optional[models.CurrentGamesResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_CURRENT_WEEK_GAMES_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.CurrentGamesResponse], http_res
            )
    ...
    def get_future_betting_odds(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.FuturesOddsResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_FUTURE_BETTING_ODDS_OP_SERVERS[0]
        req = self._build_request(
            method="GET",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.FuturesOddsResponse], http_res
            )
        if utils.match_response(http_res, ["401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
    ...
    def get_team_standings(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEAM_STANDINGS_OP_SERVERS[0]
