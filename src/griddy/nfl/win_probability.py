...
class WinProbability(BaseSDK):
    ...
    def get_plays_win_probability(
        ...
        *,
    ...
    ) -> Optional[models.GetPlaysWinProbabilityResponseBody]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_PLAYS_WIN_PROBABILITY_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.GetPlaysWinProbabilityResponseBody], http_res
            )
    ...
    def get_win_probability_min(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.WinProbabilityResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_WIN_PROBABILITY_MIN_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.WinProbabilityResponse], http_res
            )
        if utils.match_response(http_res, ["400", "401", "403", "404", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
