...
class TeamOffensePassStatistics(BaseSDK):
    ...
    def get_team_offense_pass_stats_by_season(
        ...
        *,
        request: Union[
            models.GetTeamOffensePassStatsBySeasonRequest,
            models.GetTeamOffensePassStatsBySeasonRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.TeamOffensePassStatsResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_TEAM_OFFENSE_PASS_STATS_BY_SEASON_OP_SERVERS[0]

        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.GetTeamOffensePassStatsBySeasonRequest
            )
        request = cast(models.GetTeamOffensePassStatsBySeasonRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.TeamOffensePassStatsResponse], http_res
            )
