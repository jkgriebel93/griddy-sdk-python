...
class BettingController:
    ...
    def get_weekly_betting_odds(
        ...
        _param = self._get_weekly_betting_odds_serialize(
            season=season,
    ...
    @validate_call
    def get_weekly_betting_odds_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[int, Field(le=18, strict=True, ge=1, description="Week number within the season")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLWeeklyOddsResponse]:
        """Get Weekly Betting Odds
    ...
    @validate_call
    def get_weekly_betting_odds_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[int, Field(le=18, strict=True, ge=1, description="Week number within the season")],
    ...
    def _get_weekly_betting_odds_serialize(
        self,
        season,
        season_type,
        week,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/schedules/week/odds',
