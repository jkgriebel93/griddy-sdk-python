...
class AuthenticationController:
    ...
    def generate_token(
        self,
        nfl_token_request: NFLTokenRequest,
        ...
        :param nfl_token_request: (required)
        :type nfl_token_request: NFLTokenRequest
        ...
        _param = self._generate_token_serialize(
            nfl_token_request=nfl_token_request,
    ...
    def generate_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLTokenResponse]:
        """Generate Initial Access Token
    ...
    def _generate_token_serialize(
        ...
        if nfl_token_request is not None:
            _body_params = nfl_token_request
    ...
    def refresh_token(
        self,
        nfl_refresh_token_request: NFLRefreshTokenRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param nfl_refresh_token_request: (required)
        :type nfl_refresh_token_request: NFLRefreshTokenRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._refresh_token_serialize(
            nfl_refresh_token_request=nfl_refresh_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _refresh_token_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if nfl_refresh_token_request is not None:
            _body_params = nfl_refresh_token_request
