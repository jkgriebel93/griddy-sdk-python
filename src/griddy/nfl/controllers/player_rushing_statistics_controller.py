...
class PlayerRushingStatisticsController:
    ...
    def get_player_rushing_stats_by_season(
        ...
        qualified_rusher: Annotated[Optional[StrictBool], Field(description="Filter to only qualified rushers (minimum attempts threshold)")] = None,
        ...
        _param = self._get_player_rushing_stats_by_season_serialize(
            season=season,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLRushingStatsResponse",
            '400': None,
            '401': None,
            '403': None,
            '500': None,
    ...
    @validate_call
    def get_player_rushing_stats_by_season_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of players to return")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLRushingStatsResponse]:
        """Get Player Rushing Statistics by Season
    ...
    @validate_call
    def get_player_rushing_stats_by_season_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of players to return")] = None,
    ...
    def _get_player_rushing_stats_by_season_serialize(
        self,
        season,
        season_type,
        limit,
        ...
        if qualified_rusher is not None:
            
            _query_params.append(('qualifiedRusher', qualified_rusher))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/stats/players-offense/rushing/season',
    ...
    def get_player_rushing_stats_by_week(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> NFLNFLWeeklyRushingStatsResponse:
        ...
        _param = self._get_player_rushing_stats_by_week_serialize(
            season=season,
            season_type=season_type,
            week=week,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLWeeklyRushingStatsResponse",
            '400': None,
            '401': None,
            '403': None,
            '500': None,
    ...
    @validate_call
    def get_player_rushing_stats_by_week_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[NFLWeekSlugEnum, Field(description="Week identifier")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLWeeklyRushingStatsResponse]:
        """Get Player Rushing Statistics by Week
    ...
    @validate_call
    def get_player_rushing_stats_by_week_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[NFLWeekSlugEnum, Field(description="Week identifier")],
    ...
    def _get_player_rushing_stats_by_week_serialize(
        self,
        season,
        season_type,
        week,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/stats/players-offense/rushing/week',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
