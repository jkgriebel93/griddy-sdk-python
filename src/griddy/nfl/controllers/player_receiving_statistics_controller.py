...
class PlayerReceivingStatisticsController:
    ...
    def get_player_receiving_stats_by_season(
        ...
        sort_key: Annotated[
            Optional[ReceivingStatsCategoryEnum], Field(description="Field to sort by")
        ] = None,
        ...
        qualified_receiver: Annotated[
            Optional[StrictBool],
            Field(
                description="Filter to only qualified receivers (minimum target threshold)"
            ),
        ] = None,
        ...
        :type sort_key: ReceivingStatsCategoryEnum
    ...
    def get_player_receiving_stats_by_week(
        ...
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[SeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[WeekSlugEnum, Field(description="Week identifier")],
        limit: Annotated[
            Optional[Annotated[int, Field(le=100, strict=True, ge=1)]],
            Field(description="Maximum number of players to return"),
        ] = None,
