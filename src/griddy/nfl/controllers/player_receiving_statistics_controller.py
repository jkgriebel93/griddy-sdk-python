...
class PlayerReceivingStatisticsController:
    ...
    def get_player_receiving_stats_by_season(
        ...
        sort_key: Annotated[Optional[NFLReceivingStatsCategoryEnum], Field(description="Field to sort by")] = None,
        sort_value: Annotated[Optional[NFLSortOrderEnum], Field(description="Sort direction")] = None,
        qualified_receiver: Annotated[Optional[StrictBool], Field(description="Filter to only qualified receivers (minimum target threshold)")] = None,
        team_offense: Annotated[Optional[List[StrictStr]], Field(description="Filter by specific team IDs (supports multiple teams)")] = None,
        ...
        :type sort_key: NFLReceivingStatsCategoryEnum
        ...
        _param = self._get_player_receiving_stats_by_season_serialize(
            season=season,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLReceivingStatsResponse",
            '400': None,
            '401': None,
            '403': None,
            '500': None,
    ...
    @validate_call
    def get_player_receiving_stats_by_season_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of players to return")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLReceivingStatsResponse]:
        """Get Player Receiving Statistics by Season
    ...
    @validate_call
    def get_player_receiving_stats_by_season_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of players to return")] = None,
    ...
    def _get_player_receiving_stats_by_season_serialize(
        self,
        season,
        season_type,
        limit,
        ...
        if qualified_receiver is not None:
            
            _query_params.append(('qualifiedReceiver', qualified_receiver))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/stats/players-offense/receiving/season',
    ...
    def get_player_receiving_stats_by_week(
        ...
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[NFLWeekSlugEnum, Field(description="Week identifier")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of players to return")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of records to skip for pagination")] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
        sort_key: Annotated[Optional[NFLReceivingStatsCategoryEnum], Field(description="Field to sort by")] = None,
        ...
        :param season_type: Type of season (required)
        :type season_type: NFLSeasonTypeEnum
        :param week: Week identifier (required)
        :type week: NFLWeekSlugEnum
        :param limit: Maximum number of players to return
        :type limit: int
        :param offset: Number of records to skip for pagination
        :type offset: int
        ...
        _param = self._get_player_receiving_stats_by_week_serialize(
            season=season,
            season_type=season_type,
            week=week,
            limit=limit,
    ...
    @validate_call
    def get_player_receiving_stats_by_week_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[NFLWeekSlugEnum, Field(description="Week identifier")],
    ...
    @validate_call
    def get_player_receiving_stats_by_week_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[NFLWeekSlugEnum, Field(description="Week identifier")],
    ...
    def _get_player_receiving_stats_by_week_serialize(
        self,
        season,
        season_type,
        week,
        ...
        if week is not None:
            ...
            _query_params.append(('week', week.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/stats/players-offense/receiving/week',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
