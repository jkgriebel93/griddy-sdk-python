...
class SecuredVideosController:
    ...
    def get_coaches_film_videos(
        self,
        game_id: Annotated[List[StrictStr], Field(min_length=1, max_length=10, description="Game identifiers (UUID format, supports multiple games)")],
        play_id: Annotated[List[StrictStr], Field(min_length=1, max_length=50, description="Play identifiers for specific plays within the games")],
        ...
        :param game_id: Game identifiers (UUID format, supports multiple games) (required)
        :type game_id: List[str]
        :param play_id: Play identifiers for specific plays within the games (required)
        :type play_id: List[str]
        ...
        _param = self._get_coaches_film_videos_serialize(
            game_id=game_id,
            play_id=play_id,
    ...
    @validate_call
    def get_coaches_film_videos_with_http_info(
        self,
        game_id: Annotated[List[StrictStr], Field(min_length=1, max_length=10, description="Game identifiers (UUID format, supports multiple games)")],
        play_id: Annotated[List[StrictStr], Field(min_length=1, max_length=50, description="Play identifiers for specific plays within the games")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLCoachesFilmResponse]:
        """Get Coaches Film Videos
    ...
    @validate_call
    def get_coaches_film_videos_without_preload_content(
        self,
        game_id: Annotated[List[StrictStr], Field(min_length=1, max_length=10, description="Game identifiers (UUID format, supports multiple games)")],
        play_id: Annotated[List[StrictStr], Field(min_length=1, max_length=50, description="Play identifiers for specific plays within the games")],
        _request_timeout: Union[
    ...
    def _get_coaches_film_videos_serialize(
        self,
        game_id,
        play_id,
        _request_auth,
        ...
        if play_id is not None:
            ...
            _query_params.append(('playId', play_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/videos/coaches',
