...
class SeasonScheduleController:
    ...
    def get_schedule_season_weeks(
        ...
        _param = self._get_schedule_season_weeks_serialize(
            season=season,
    ...
    @validate_call
    def get_schedule_season_weeks_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLSeasonWeeksResponse]:
        """Get Season Weeks
    ...
    @validate_call
    def get_schedule_season_weeks_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        _request_timeout: Union[
            None,
    ...
    def _get_schedule_season_weeks_serialize(
        self,
        season,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/schedules/weeks',
