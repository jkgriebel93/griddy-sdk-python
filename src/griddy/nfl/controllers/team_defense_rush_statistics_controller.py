...
class TeamDefenseRushStatisticsController:
    ...
    def get_team_defense_rush_stats_by_season(
    ...
    ) -> NFLNFLTeamDefenseRushStatsResponse:
        ...
        _param = self._get_team_defense_rush_stats_by_season_serialize(
            season=season,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLTeamDefenseRushStatsResponse",
            '400': None,
            '401': None,
            '403': None,
            '500': None,
    ...
    @validate_call
    def get_team_defense_rush_stats_by_season_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of teams to return")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLTeamDefenseRushStatsResponse]:
        """Get Team Defense Rush Statistics by Season
    ...
    @validate_call
    def get_team_defense_rush_stats_by_season_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of teams to return")] = None,
    ...
    def _get_team_defense_rush_stats_by_season_serialize(
        self,
        season,
        season_type,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/secured/stats/team-defense/rush/season',
