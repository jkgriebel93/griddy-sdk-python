...
class FootballController:
    ...
    def get_draft_info(
        ...
        round: Annotated[
            Optional[Annotated[int, Field(le=7, strict=True, ge=1)]],
            Field(description="Filter by round"),
        ] = None,
        team_id: Annotated[
            Optional[StrictStr], Field(description="Filter by team")
        ] = None,
    ...
    def get_football_games(
        ...
        with_external_ids: Annotated[
            Optional[StrictBool], Field(description="Include external IDs in response")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_injury_reports(
        ...
        week: Annotated[StrictInt, Field(description="Week number")],
        team_id: Annotated[
            Optional[StrictStr], Field(description="Filter by specific team")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_play_by_play(
        ...
        include_penalties: Annotated[
            Optional[StrictBool], Field(description="Include penalty details")
        ] = None,
        include_formations: Annotated[
            Optional[StrictBool],
            Field(description="Include offensive/defensive formations"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_player_details(
        ...
        season: Annotated[
            Optional[StrictInt],
            Field(description="Season for statistics (defaults to current)"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_players_team_roster(
        ...
        include_stats: Annotated[
            Optional[StrictBool], Field(description="Include current season statistics")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_season_player_stats(
        ...
        season_type: Annotated[SeasonTypeEnum, Field(description="Type of season")],
        position: Annotated[
            Optional[StrictStr], Field(description="Filter by position group")
        ] = None,
        team_id: Annotated[
            Optional[StrictStr], Field(description="Filter by team")
        ] = None,
        stat_category: Annotated[
            Optional[StrictStr], Field(description="Statistical category to retrieve")
        ] = None,
        sort: Annotated[
            Optional[StrictStr], Field(description="Sort field and order")
        ] = None,
        limit: Annotated[
    ...
    def get_season_weeks(
        ...
        limit: Annotated[
            ...
            Field(description="Maximum number of weeks to return"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_transactions(
        ...
        start_date: Annotated[
            Optional[date], Field(description="Start date for transactions (ISO 8601)")
        ] = None,
        end_date: Annotated[
            Optional[date], Field(description="End date for transactions (ISO 8601)")
        ] = None,
        team_id: Annotated[
            Optional[StrictStr], Field(description="Filter by team")
        ] = None,
        transaction_type: Annotated[
            Optional[StrictStr], Field(description="Type of transaction")
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=100, strict=True, ge=1)]],
            Field(description="Maximum number of results"),
    ...
    def get_venues(
        ...
        limit: Annotated[
            Optional[Annotated[int, Field(le=100, strict=True, ge=1)]],
            Field(description="Maximum number of venues to return"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_weekly_game_details(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        type: Annotated[SeasonTypeEnum, Field(description="Season type")],
        week: Annotated[StrictInt, Field(description="Week number")],
        include_drive_chart: Annotated[
            Optional[StrictBool], Field(description="Include drive chart data")
        ] = None,
        include_replays: Annotated[
            Optional[StrictBool], Field(description="Include replay videos")
        ] = None,
        include_standings: Annotated[
            Optional[StrictBool], Field(description="Include team standings")
        ] = None,
        include_tagged_videos: Annotated[
            Optional[StrictBool], Field(description="Include tagged video content")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
