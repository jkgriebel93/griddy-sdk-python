...
class PlaysController:
    ...
    def get_summary_play(
        ...
        play_id: Annotated[StrictInt, Field(description="Play identifier within the game")],
        ...
        :type game_id: str
        :param play_id: Play identifier within the game (required)
        :type play_id: int
        ...
        _param = self._get_summary_play_serialize(
            game_id=game_id,
            play_id=play_id,
    ...
    @validate_call
    def get_summary_play_with_http_info(
        self,
        game_id: Annotated[StrictStr, Field(description="Game identifier (UUID format)")],
        play_id: Annotated[StrictInt, Field(description="Play identifier within the game")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLPlaySummaryResponse]:
        """Get Play Summary
    ...
    @validate_call
    def get_summary_play_without_preload_content(
        self,
        game_id: Annotated[StrictStr, Field(description="Game identifier (UUID format)")],
        play_id: Annotated[StrictInt, Field(description="Play identifier within the game")],
        _request_timeout: Union[
    ...
    def _get_summary_play_serialize(
        self,
        game_id,
        play_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/plays/summaryPlay',
