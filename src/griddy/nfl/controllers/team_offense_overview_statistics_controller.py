...
class TeamOffenseOverviewStatisticsController:
    ...
    def get_team_offense_overview_stats_by_season(
        ...
        limit: Annotated[
            ...
            Field(description="Maximum number of teams to return"),
        ] = None,
        offset: Annotated[
        ...
        split: Annotated[
            ...
            Field(
                description="Offensive situation splits to filter by (supports multiple values)"
            ),
        ] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "TeamOffenseOverviewStatsResponse",
            "400": None,
            "401": None,
            "403": None,
            "500": None,
