...
class PlayersController:
    ...
    def get_projected_stats(
        ...
        filter_nfl_team_id: Annotated[Optional[StrictStr], Field(description="Filter by NFL team ID (UUID format)")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLProjectedStatsResponse",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    def get_projected_stats_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLProjectedStatsResponse]:
        """Get Projected Player Statistics
    ...
    def search_players(
        self,
        term: Annotated[StrictStr, Field(description="Search term for player name (first or last name)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NFLNFLPlayerSearchResponse",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    def search_players_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLPlayerSearchResponse]:
        """Search Players
