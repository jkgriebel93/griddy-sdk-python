...
class ContentInsightsController:
    ...
    def get_season_content_insights(
        ...
        tags: Annotated[Optional[List[StrictStr]], Field(description="Content tags to filter by (supports multiple comma-separated tags)")] = None,
        team_id: Annotated[Optional[StrictStr], Field(description="Filter by specific team identifier")] = None,
        nfl_id: Annotated[Optional[StrictStr], Field(description="Filter by specific player NFL identifier")] = None,
    ...
    def get_season_content_insights_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[List[NFLNFLInsight]]:
        """Get Season Content Insights
