...
class ScoresController:
    ...
    def get_live_game_scores(
        ...
        _param = self._get_live_game_scores_serialize(
            season=season,
    ...
    @validate_call
    def get_live_game_scores_with_http_info(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[int, Field(le=18, strict=True, ge=1, description="Week number")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[NFLNFLLiveScoresResponse]:
        """Get Live Game Scores
    ...
    @validate_call
    def get_live_game_scores_without_preload_content(
        self,
        season: Annotated[StrictInt, Field(description="Season year")],
        season_type: Annotated[NFLSeasonTypeEnum, Field(description="Type of season")],
        week: Annotated[int, Field(le=18, strict=True, ge=1, description="Week number")],
    ...
    def _get_live_game_scores_serialize(
        self,
        season,
        season_type,
        week,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/scores/live/games',
