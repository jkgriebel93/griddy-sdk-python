...
from griddy.nfl import errors, utils
from griddy.nfl._hooks import (
    AfterErrorContext,
    AfterSuccessContext,
    BeforeRequestContext,
)
from griddy.nfl.utils import RetryConfig, SerializedRequestBody, get_body_content
import httpx
        ...
        def do():
            ...
            if utils.match_status_codes(error_status_codes, http_res.status_code):
                ...
                if result is not None:
                    ...
                    raise errors.GriddyNFLError("Unexpected error occurred", http_res)
