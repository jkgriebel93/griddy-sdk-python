...
class Players(BaseSDK):
    ...
    def get_player(
        ...
        *,
        ...
        if server_url is not None:
            ...
            base_url = models.GET_PLAYER_OP_SERVERS[0]
    ...
    def get_projected_stats(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.ProjectedStatsResponse]:
        ...
        if server_url is not None:
            ...
            base_url = models.GET_PROJECTED_STATS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.ProjectedStatsResponse], http_res
            )
    ...
    def search_players(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PlayerSearchResponse]:
        r"""Search Players
        ...
        if server_url is not None:
            ...
            base_url = models.SEARCH_PLAYERS_OP_SERVERS[0]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.PlayerSearchResponse], http_res
            )
        if utils.match_response(http_res, ["400", "401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.GriddyNFLError("API error occurred", http_res, http_res_text)
