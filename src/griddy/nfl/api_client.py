...
from nfl.configuration import Configuration
from nfl.api_response import ApiResponse, T as ApiResponseT
import nfl.models
from nfl import rest
from nfl.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(nfl.models, klass)
