...
json = "{}"
# create an instance of NFLDefensivePlayerStats from a JSON string
nfl_defensive_player_stats_instance = NFLDefensivePlayerStats.from_json(json)
# print the JSON string representation of the object
print(NFLDefensivePlayerStats.to_json())

# convert the object into a dict
nfl_defensive_player_stats_dict = nfl_defensive_player_stats_instance.to_dict()
# create an instance of NFLDefensivePlayerStats from a dict
nfl_defensive_player_stats_from_dict = NFLDefensivePlayerStats.from_dict(nfl_defensive_player_stats_dict)
```
