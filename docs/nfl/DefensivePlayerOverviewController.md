# nfl.DefensivePlayerOverviewController
...
> NFLNFLDefensiveOverviewStatsResponse get_defensive_overview_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, qualified_defender=qualified_defender, team_defense=team_defense)
...
```python
import nfl
from nfl.models.nflnfl_defensive_overview_stats_response import NFLNFLDefensiveOverviewStatsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.DefensivePlayerOverviewController(api_client)
...
[**NFLNFLDefensiveOverviewStatsResponse**](NFLDefensiveOverviewStatsResponse.md)
