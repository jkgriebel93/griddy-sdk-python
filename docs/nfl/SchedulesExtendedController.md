# nfl.SchedulesExtendedController
...
> NFLNFLCurrentGamesResponse get_current_week_games()
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.SchedulesExtendedController(api_client)
...
[**NFLNFLCurrentGamesResponse**](NFLCurrentGamesResponse.md)
...
> NFLNFLFuturesOddsResponse get_future_betting_odds()
...
[**NFLNFLFuturesOddsResponse**](NFLFuturesOddsResponse.md)
...
# **get_team_standings**
> NFLNFLStandingsResponse get_team_standings(season, season_type, week)
