...
json = "{}"
# create an instance of TeamDefenseStats from a JSON string
team_defense_stats_instance = TeamDefenseStats.from_json(json)
# print the JSON string representation of the object
print(TeamDefenseStats.to_json())

# convert the object into a dict
team_defense_stats_dict = team_defense_stats_instance.to_dict()
# create an instance of TeamDefenseStats from a dict
team_defense_stats_from_dict = TeamDefenseStats.from_dict(team_defense_stats_dict)
```
