# nfl.TeamOffenseOverviewStatisticsController
...
> NFLNFLTeamOffenseOverviewStatsResponse get_team_offense_overview_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, team_defense=team_defense, split=split)
...
```python
import nfl
from nfl.models.nflnfl_team_offense_overview_stats_response import NFLNFLTeamOffenseOverviewStatsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.TeamOffenseOverviewStatisticsController(api_client)
...
[**NFLNFLTeamOffenseOverviewStatsResponse**](NFLTeamOffenseOverviewStatsResponse.md)
