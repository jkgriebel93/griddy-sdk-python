# src.griddy.nfl.TeamDefenseStatisticsController
...
> TeamDefenseStatsResponse get_team_defense_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, split=split)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.TeamDefenseStatisticsController(api_client)
...
[**TeamDefenseStatsResponse**](TeamDefenseStatsResponse.md)
