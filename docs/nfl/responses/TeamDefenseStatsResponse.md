...
**defense** | [**List[TeamDefenseStats]**](TeamDefenseStats.md) |  | [optional] 
...
json = "{}"
# create an instance of TeamDefenseStatsResponse from a JSON string
team_defense_stats_response_instance = TeamDefenseStatsResponse.from_json(json)
# print the JSON string representation of the object
print(TeamDefenseStatsResponse.to_json())

# convert the object into a dict
team_defense_stats_response_dict = team_defense_stats_response_instance.to_dict()
# create an instance of TeamDefenseStatsResponse from a dict
team_defense_stats_response_from_dict = TeamDefenseStatsResponse.from_dict(team_defense_stats_response_dict)
```
