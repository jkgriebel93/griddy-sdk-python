...
**defenders** | [**List[DefensivePassRushStats]**](DefensivePassRushStats.md) |  | [optional] 
...
json = "{}"
# create an instance of PassRushStatsResponse from a JSON string
pass_rush_stats_response_instance = PassRushStatsResponse.from_json(json)
# print the JSON string representation of the object
print(PassRushStatsResponse.to_json())

# convert the object into a dict
pass_rush_stats_response_dict = pass_rush_stats_response_instance.to_dict()
# create an instance of PassRushStatsResponse from a dict
pass_rush_stats_response_from_dict = PassRushStatsResponse.from_dict(pass_rush_stats_response_dict)
```
