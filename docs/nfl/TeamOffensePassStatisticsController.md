# nfl.TeamOffensePassStatisticsController
...
> NFLNFLTeamOffensePassStatsResponse get_team_offense_pass_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, team_defense=team_defense)
...
```python
import nfl
from nfl.models.nflnfl_team_offense_pass_stats_response import NFLNFLTeamOffensePassStatsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.TeamOffensePassStatisticsController(api_client)
...
[**NFLNFLTeamOffensePassStatsResponse**](NFLTeamOffensePassStatsResponse.md)
