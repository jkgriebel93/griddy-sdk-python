# src.griddy.nfl.TeamsController
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.TeamsController(api_client)
...
# **get_team_roster**
> TeamRosterResponse get_team_roster(team_id, season)
...
[**TeamRosterResponse**](TeamRosterResponse.md)
...
# **get_team_schedule**
> List[ScheduledGame] get_team_schedule(team_id, season)
...
[**List[ScheduledGame]**](ScheduledGame.md)
...
> WeeklyRosterResponse get_weekly_team_roster(team_id, season, season_type, week)
...
[**WeeklyRosterResponse**](WeeklyRosterResponse.md)
