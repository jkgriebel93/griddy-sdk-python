# src.griddy.nfl.FantasyStatisticsController
...
> FantasyStatsResponse get_fantasy_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, position_group=position_group, team_offense=team_offense, team_defense=team_defense, min_offensive_snaps=min_offensive_snaps, last_n_weeks=last_n_weeks)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.FantasyStatisticsController(api_client)
...
[**FantasyStatsResponse**](FantasyStatsResponse.md)
