# src.griddy.nfl.DefensiveStatisticsController
...
> DefensiveStatsResponse get_defensive_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, qualified_defender=qualified_defender, team_defense=team_defense)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.DefensiveStatisticsController(api_client)
...
[**DefensiveStatsResponse**](DefensiveStatsResponse.md)
