# src.griddy.nfl.TeamDefensePassStatisticsController
...
> TeamDefensePassStatsResponse get_team_defense_pass_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.TeamDefensePassStatisticsController(api_client)
...
[**TeamDefensePassStatsResponse**](TeamDefensePassStatsResponse.md)
