# src.griddy.nfl.SecuredVideosController
...
> CoachesFilmResponse get_coaches_film_videos(game_id, play_id)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.SecuredVideosController(api_client)
...
[**CoachesFilmResponse**](CoachesFilmResponse.md)
