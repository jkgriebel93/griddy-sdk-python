# src.griddy.nfl.PlayersController
...
# **get_player**
> PlayerDetail get_player(nfl_id)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.PlayersController(api_client)
...
# **get_projected_stats**
> ProjectedStatsResponse get_projected_stats(season, week, filter_nfl_team_id=filter_nfl_team_id, page_size=page_size)
...
[**ProjectedStatsResponse**](ProjectedStatsResponse.md)
...
# **search_players**
> PlayerSearchResponse search_players(term)
...
[**PlayerSearchResponse**](PlayerSearchResponse.md)
