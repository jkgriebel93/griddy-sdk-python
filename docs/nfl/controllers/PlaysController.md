# src.griddy.nfl.PlaysController
...
# **get_summary_play**
> PlaySummaryResponse get_summary_play(game_id, play_id)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.PlaysController(api_client)
...
[**PlaySummaryResponse**](PlaySummaryResponse.md)
