...
json = "{}"
# create an instance of TeamOffenseOverviewStats from a JSON string
team_offense_overview_stats_instance = TeamOffenseOverviewStats.from_json(json)
# print the JSON string representation of the object
print(TeamOffenseOverviewStats.to_json())

# convert the object into a dict
team_offense_overview_stats_dict = team_offense_overview_stats_instance.to_dict()
# create an instance of TeamOffenseOverviewStats from a dict
team_offense_overview_stats_from_dict = TeamOffenseOverviewStats.from_dict(team_offense_overview_stats_dict)
```
