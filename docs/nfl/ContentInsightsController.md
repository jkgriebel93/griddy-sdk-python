# src.griddy.nfl.ContentInsightsController
...
> List[Insight] get_season_content_insights(season, limit=limit, tags=tags, team_id=team_id, nfl_id=nfl_id)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.ContentInsightsController(api_client)
