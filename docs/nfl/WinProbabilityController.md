...
> NFLNFLGetPlaysWinProbability200Response get_plays_win_probability(game_id)
...
```python
import nfl
from nfl.models.nflnfl_get_plays_win_probability200_response import NFLNFLGetPlaysWinProbability200Response
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.WinProbabilityController(api_client)
    game_id = nfl.NFLGetPlaysWinProbabilityGameIdParameter() # NFLGetPlaysWinProbabilityGameIdParameter | Game identifier(s) in 10-digit format (YYYYMMDDNN). Can be a single game ID or multiple game IDs for batch retrieval. 
...
------------- | ------------- | ------------- | -------------
 **game_id** | [**NFLGetPlaysWinProbabilityGameIdParameter**](.md)| Game identifier(s) in 10-digit format (YYYYMMDDNN). Can be a single game ID or multiple game IDs for batch retrieval.  | 

### Return type

[**NFLNFLGetPlaysWinProbability200Response**](NFLGetPlaysWinProbability200Response.md)
...
> NFLNFLWinProbabilityResponse get_win_probability_min(fapi_game_id)
...
```python
import nfl
from nfl.models.nflnfl_win_probability_response import NFLNFLWinProbabilityResponse
from nfl.rest import ApiException
from pprint import pprint
...
[**NFLNFLWinProbabilityResponse**](NFLWinProbabilityResponse.md)
