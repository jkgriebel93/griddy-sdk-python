...
json = "{}"
# create an instance of NFLPlayer from a JSON string
nfl_player_instance = NFLPlayer.from_json(json)
# print the JSON string representation of the object
print(NFLPlayer.to_json())

# convert the object into a dict
nfl_player_dict = nfl_player_instance.to_dict()
# create an instance of NFLPlayer from a dict
nfl_player_from_dict = NFLPlayer.from_dict(nfl_player_dict)
```
