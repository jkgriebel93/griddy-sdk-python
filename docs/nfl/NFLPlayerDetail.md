...
json = "{}"
# create an instance of NFLPlayerDetail from a JSON string
nfl_player_detail_instance = NFLPlayerDetail.from_json(json)
# print the JSON string representation of the object
print(NFLPlayerDetail.to_json())

# convert the object into a dict
nfl_player_detail_dict = nfl_player_detail_instance.to_dict()
# create an instance of NFLPlayerDetail from a dict
nfl_player_detail_from_dict = NFLPlayerDetail.from_dict(nfl_player_detail_dict)
```
