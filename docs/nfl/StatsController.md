...
> NFLNFLTeamRankingsResponse get_game_team_rankings(season, season_type, away_team_id, home_team_id, week)
...
```python
import nfl
from nfl.models.nflnfl_team_rankings_response import NFLNFLTeamRankingsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.StatsController(api_client)
...
[**NFLNFLTeamRankingsResponse**](NFLTeamRankingsResponse.md)
...
# **get_gamecenter**
> NFLNFLGamecenterResponse get_gamecenter(game_id)
...
```python
import nfl
from nfl.models.nflnfl_gamecenter_response import NFLNFLGamecenterResponse
from nfl.rest import ApiException
from pprint import pprint
...
[**NFLNFLGamecenterResponse**](NFLGamecenterResponse.md)
...
> List[NFLNFLMultipleRankingsCategory] get_multiple_rankings_all_teams(season, season_type, stat0, stat1=stat1, stat2=stat2, stat3=stat3, stat4=stat4)
...
```python
import nfl
from nfl.models.nflnfl_multiple_rankings_category import NFLNFLMultipleRankingsCategory
from nfl.models.nfl_season_type_enum import NFLSeasonTypeEnum
from nfl.rest import ApiException
from pprint import pprint
...
[**List[NFLNFLMultipleRankingsCategory]**](NFLMultipleRankingsCategory.md)
...
# **get_stats_boxscore**
> NFLNFLTeamBoxScore get_stats_boxscore(game_id)
...
```python
import nfl
from nfl.models.nflnfl_team_box_score import NFLNFLTeamBoxScore
from nfl.rest import ApiException
from pprint import pprint
...
[**NFLNFLTeamBoxScore**](NFLTeamBoxScore.md)
