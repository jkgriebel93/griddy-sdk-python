# src.griddy.nfl.PlayerStatisticsController
...
> PassingStatsResponse get_player_passing_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, qualified_passer=qualified_passer, team_offense=team_offense)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.PlayerStatisticsController(api_client)
...
[**PassingStatsResponse**](PassingStatsResponse.md)
