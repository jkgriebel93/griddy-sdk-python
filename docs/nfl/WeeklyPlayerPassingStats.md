...
weekly_player_passing_stats_instance = WeeklyPlayerPassingStats.from_json(json)
# print the JSON string representation of the object
print(WeeklyPlayerPassingStats.to_json())

# convert the object into a dict
weekly_player_passing_stats_dict = weekly_player_passing_stats_instance.to_dict()
# create an instance of WeeklyPlayerPassingStats from a dict
weekly_player_passing_stats_from_dict = WeeklyPlayerPassingStats.from_dict(weekly_player_passing_stats_dict)
```
