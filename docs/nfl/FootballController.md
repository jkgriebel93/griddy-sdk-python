...
# **get_draft_info**
> NFLNFLDraftResponse get_draft_info(year, round=round, team_id=team_id)
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.FootballController(api_client)
...
[**NFLNFLDraftResponse**](NFLDraftResponse.md)
...
> NFLNFLBoxScoreResponse get_football_box_score(game_id)
...
[**NFLNFLBoxScoreResponse**](NFLBoxScoreResponse.md)
...
# **get_football_games**
> NFLNFLFootballGamesResponse get_football_games(season, season_type, week, with_external_ids=with_external_ids)
...
[**NFLNFLFootballGamesResponse**](NFLFootballGamesResponse.md)
...
# **get_injury_reports**
> NFLNFLInjuryReportResponse get_injury_reports(season, week, team_id=team_id)
...
# **get_live_game_stats**
> NFLNFLGameStatsResponse get_live_game_stats(season, season_type, week)
...
[**NFLNFLGameStatsResponse**](NFLGameStatsResponse.md)
...
# **get_play_by_play**
> NFLNFLPlayByPlayResponse get_play_by_play(game_id, include_penalties=include_penalties, include_formations=include_formations)
...
[**NFLNFLPlayByPlayResponse**](NFLPlayByPlayResponse.md)
...
# **get_player_details**
> NFLNFLPlayerDetail get_player_details(player_id, season=season)
...
> NFLNFLRosterResponse get_players_team_roster(team_id, season, include_stats=include_stats)
...
[**NFLNFLRosterResponse**](NFLRosterResponse.md)
...
> NFLNFLPlayerStatsResponse get_season_player_stats(season, season_type, position=position, team_id=team_id, stat_category=stat_category, sort=sort, limit=limit, offset=offset)
...
[**NFLNFLPlayerStatsResponse**](NFLPlayerStatsResponse.md)
...
# **get_season_weeks**
> NFLNFLWeeksResponse get_season_weeks(season, limit=limit)
...
[**NFLNFLWeeksResponse**](NFLWeeksResponse.md)
...
# **get_standings**
> NFLNFLStandingsResponse get_standings(season, season_type, week, limit=limit)
...
[**NFLNFLStandingsResponse**](NFLStandingsResponse.md)
...
# **get_transactions**
> NFLNFLTransactionsResponse get_transactions(start_date=start_date, end_date=end_date, team_id=team_id, transaction_type=transaction_type, limit=limit)
...
[**NFLNFLTransactionsResponse**](NFLTransactionsResponse.md)
...
# **get_venues**
> NFLNFLVenuesResponse get_venues(season, limit=limit)
...
[**NFLNFLVenuesResponse**](NFLVenuesResponse.md)
...
> List[NFLNFLWeeklyGameDetail] get_weekly_game_details(season, type, week, include_drive_chart=include_drive_chart, include_replays=include_replays, include_standings=include_standings, include_tagged_videos=include_tagged_videos)
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.FootballController(api_client)
    season = 2025 # int | Season year
    type = nfl.NFLSeasonTypeEnum() # NFLSeasonTypeEnum | Season type
    week = 4 # int | Week number
...
------------- | ------------- | ------------- | -------------
 **season** | **int**| Season year | 
 **type** | [**NFLSeasonTypeEnum**](.md)| Season type | 
 **week** | **int**| Week number | 
...
[**List[NFLNFLWeeklyGameDetail]**](NFLWeeklyGameDetail.md)
