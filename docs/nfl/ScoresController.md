...
> NFLNFLLiveScoresResponse get_live_game_scores(season, season_type, week)
...
```python
import nfl
from nfl.models.nflnfl_live_scores_response import NFLNFLLiveScoresResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.ScoresController(api_client)
...
[**NFLNFLLiveScoresResponse**](NFLLiveScoresResponse.md)
