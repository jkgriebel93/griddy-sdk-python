# src.griddy.nfl.SeasonScheduleController
...
> SeasonWeeksResponse get_schedule_season_weeks(season)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.SeasonScheduleController(api_client)
...
[**SeasonWeeksResponse**](SeasonWeeksResponse.md)
