...
**position** | [**NFLNFLPositionGroupEnum**](NFLPositionGroupEnum.md) |  | [optional] 
...
json = "{}"
# create an instance of NFLInsight from a JSON string
nfl_insight_instance = NFLInsight.from_json(json)
# print the JSON string representation of the object
print(NFLInsight.to_json())

# convert the object into a dict
nfl_insight_dict = nfl_insight_instance.to_dict()
# create an instance of NFLInsight from a dict
nfl_insight_from_dict = NFLInsight.from_dict(nfl_insight_dict)
```
