...
json = "{}"
# create an instance of NFLWeeklyPlayerPassingStats from a JSON string
nfl_weekly_player_passing_stats_instance = NFLWeeklyPlayerPassingStats.from_json(json)
# print the JSON string representation of the object
print(NFLWeeklyPlayerPassingStats.to_json())

# convert the object into a dict
nfl_weekly_player_passing_stats_dict = nfl_weekly_player_passing_stats_instance.to_dict()
# create an instance of NFLWeeklyPlayerPassingStats from a dict
nfl_weekly_player_passing_stats_from_dict = NFLWeeklyPlayerPassingStats.from_dict(nfl_weekly_player_passing_stats_dict)
```
