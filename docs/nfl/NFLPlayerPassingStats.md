...
json = "{}"
# create an instance of NFLPlayerPassingStats from a JSON string
nfl_player_passing_stats_instance = NFLPlayerPassingStats.from_json(json)
# print the JSON string representation of the object
print(NFLPlayerPassingStats.to_json())

# convert the object into a dict
nfl_player_passing_stats_dict = nfl_player_passing_stats_instance.to_dict()
# create an instance of NFLPlayerPassingStats from a dict
nfl_player_passing_stats_from_dict = NFLPlayerPassingStats.from_dict(nfl_player_passing_stats_dict)
```
