...
json = "{}"
# create an instance of NFLWeeklyPlayer from a JSON string
nfl_weekly_player_instance = NFLWeeklyPlayer.from_json(json)
# print the JSON string representation of the object
print(NFLWeeklyPlayer.to_json())

# convert the object into a dict
nfl_weekly_player_dict = nfl_weekly_player_instance.to_dict()
# create an instance of NFLWeeklyPlayer from a dict
nfl_weekly_player_from_dict = NFLWeeklyPlayer.from_dict(nfl_weekly_player_dict)
```
