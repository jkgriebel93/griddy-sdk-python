# src.griddy.nfl.ContentController
...
# **get_game_insights**
> List[GameInsight] get_game_insights(season, fapi_game_id, away_team_id, home_team_id, limit=limit, tags=tags, exclude_tags=exclude_tags)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.ContentController(api_client)
...
[**List[GameInsight]**](GameInsight.md)
...
# **get_game_preview**
> GamePreviewResponse get_game_preview(season, season_type, week, visitor_display_name, home_display_name)
...
[**GamePreviewResponse**](GamePreviewResponse.md)
...
# **get_home_film_cards**
> HomeFilmCardsResponse get_home_film_cards()
...
[**HomeFilmCardsResponse**](HomeFilmCardsResponse.md)
