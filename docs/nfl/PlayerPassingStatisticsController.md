# nfl.PlayerPassingStatisticsController
...
> NFLNFLWeeklyPassingStatsResponse get_player_passing_stats_by_week(season, season_type, week, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value, qualified_passer=qualified_passer, team_offense=team_offense)
...
```python
import nfl
from nfl.models.nflnfl_weekly_passing_stats_response import NFLNFLWeeklyPassingStatsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.PlayerPassingStatisticsController(api_client)
...
[**NFLNFLWeeklyPassingStatsResponse**](NFLWeeklyPassingStatsResponse.md)
