...
**position** | [**FantasyPlayerPositionEnum**](FantasyPlayerPositionEnum.md) |  | [optional] 
**position_group** | [**FantasyPositionGroupEnum**](FantasyPositionGroupEnum.md) |  | [optional] 
...
json = "{}"
# create an instance of FantasyPlayerStats from a JSON string
fantasy_player_stats_instance = FantasyPlayerStats.from_json(json)
# print the JSON string representation of the object
print(FantasyPlayerStats.to_json())

# convert the object into a dict
fantasy_player_stats_dict = fantasy_player_stats_instance.to_dict()
# create an instance of FantasyPlayerStats from a dict
fantasy_player_stats_from_dict = FantasyPlayerStats.from_dict(fantasy_player_stats_dict)
```
