# src.griddy.nfl.AuthenticationController
...
# **generate_token**
> TokenResponse generate_token(token_request)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = src.griddy.nfl.AuthenticationController(api_client)
...
# **refresh_token**
> TokenResponse refresh_token(refresh_token_request)
...
with src.griddy.nfl.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = src.griddy.nfl.AuthenticationController(api_client)
    refresh_token_request = {"clientKey":"4cFUW6DmwJpzT9L7LrG3qRAcABG5s04g","clientSecret":"CZuvCL49d9OwfGsR","deviceId":"3cfdef35-c7fe-4f2d-8630-1ec72f52b44d","deviceInfo":"eyJtb2RlbCI6ImRlc2t0b3AiLCJ2ZXJzaW9uIjoiQ2hyb21lIiwib3NOYW1lIjoiV2luZG93cyIsIm9zVmVyc2lvbiI6IjEwIn0=","networkType":"other","refreshToken":"640b00c7-33d8-44f2-ab46-e3d1284a4061","signatureTimestamp":"1758729181","uid":"df990acd951e4bd6940c3babc4341584","uidSignature":"587bdNt6EKYhhX9ASFOELX+2lqE="} # RefreshTokenRequest | 
