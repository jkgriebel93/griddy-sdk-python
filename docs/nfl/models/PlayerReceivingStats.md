...
**game_result** | [**GameResultEnum**](GameResultEnum.md) |  | [optional] 
...
**ngs_position** | [**OffensiveSkillPositionEnum**](OffensiveSkillPositionEnum.md) |  | [optional] 
**ngs_position_group** | [**OffensiveSkillPositionEnum**](OffensiveSkillPositionEnum.md) |  | [optional] 
**opponent_team_id** | **str** | Opponent team identifier | [optional] 
**position** | [**OffensiveSkillPositionEnum**](OffensiveSkillPositionEnum.md) |  | [optional] 
**position_group** | [**OffensiveSkillPositionEnum**](OffensiveSkillPositionEnum.md) |  | [optional] 
...
json = "{}"
# create an instance of PlayerReceivingStats from a JSON string
player_receiving_stats_instance = PlayerReceivingStats.from_json(json)
# print the JSON string representation of the object
print(PlayerReceivingStats.to_json())

# convert the object into a dict
player_receiving_stats_dict = player_receiving_stats_instance.to_dict()
# create an instance of PlayerReceivingStats from a dict
player_receiving_stats_from_dict = PlayerReceivingStats.from_dict(player_receiving_stats_dict)
```
