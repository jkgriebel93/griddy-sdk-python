...
json = "{}"
# create an instance of WinProbabilityMetrics from a JSON string
win_probability_metrics_instance = WinProbabilityMetrics.from_json(json)
# print the JSON string representation of the object
print(WinProbabilityMetrics.to_json())

# convert the object into a dict
win_probability_metrics_dict = win_probability_metrics_instance.to_dict()
# create an instance of WinProbabilityMetrics from a dict
win_probability_metrics_from_dict = WinProbabilityMetrics.from_dict(win_probability_metrics_dict)
```
