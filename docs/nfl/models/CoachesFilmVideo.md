...
**authorizations** | [**VideoAuthorizations**](VideoAuthorizations.md) |  | [optional] 
**background** | **object** | Background configuration | [optional] 
**camera_source** | [**CameraSourceEnum**](CameraSourceEnum.md) |  | [optional] 
...
**ids** | [**VideoGamePlayIds**](VideoGamePlayIds.md) |  | [optional] 
...
**sub_type** | [**CoachesFileVideoSubTypeEnum**](CoachesFileVideoSubTypeEnum.md) |  | [optional] 
**summary** | **str** | Content summary | [optional] 
**tags** | [**List[VideoTag]**](VideoTag.md) | Content tags and metadata | [optional] 
...
coaches_film_video_instance = CoachesFilmVideo.from_json(json)
# print the JSON string representation of the object
print(CoachesFilmVideo.to_json())

# convert the object into a dict
coaches_film_video_dict = coaches_film_video_instance.to_dict()
# create an instance of CoachesFilmVideo from a dict
coaches_film_video_from_dict = CoachesFilmVideo.from_dict(coaches_film_video_dict)
```
