...
json = "{}"
# create an instance of WeeklyPlayerRushingStats from a JSON string
weekly_player_rushing_stats_instance = WeeklyPlayerRushingStats.from_json(json)
# print the JSON string representation of the object
print(WeeklyPlayerRushingStats.to_json())

# convert the object into a dict
weekly_player_rushing_stats_dict = weekly_player_rushing_stats_instance.to_dict()
# create an instance of WeeklyPlayerRushingStats from a dict
weekly_player_rushing_stats_from_dict = WeeklyPlayerRushingStats.from_dict(weekly_player_rushing_stats_dict)
```
