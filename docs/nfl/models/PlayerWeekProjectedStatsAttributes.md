...
```python
from src.griddy.nfl.models.player_week_projected_stats_attributes import PlayerWeekProjectedStatsAttributes

# TODO update the JSON string below
json = "{}"
# create an instance of PlayerWeekProjectedStatsAttributes from a JSON string
player_week_projected_stats_attributes_instance = PlayerWeekProjectedStatsAttributes.from_json(json)
# print the JSON string representation of the object
print(PlayerWeekProjectedStatsAttributes.to_json())

# convert the object into a dict
player_week_projected_stats_attributes_dict = player_week_projected_stats_attributes_instance.to_dict()
# create an instance of PlayerWeekProjectedStatsAttributes from a dict
player_week_projected_stats_attributes_from_dict = PlayerWeekProjectedStatsAttributes.from_dict(player_week_projected_stats_attributes_dict)
```
