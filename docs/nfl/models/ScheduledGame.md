...
json = "{}"
# create an instance of ScheduledGame from a JSON string
scheduled_game_instance = ScheduledGame.from_json(json)
# print the JSON string representation of the object
print(ScheduledGame.to_json())

# convert the object into a dict
scheduled_game_dict = scheduled_game_instance.to_dict()
# create an instance of ScheduledGame from a dict
scheduled_game_from_dict = ScheduledGame.from_dict(scheduled_game_dict)
```
