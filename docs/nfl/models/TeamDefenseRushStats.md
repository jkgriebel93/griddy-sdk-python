...
json = "{}"
# create an instance of TeamDefenseRushStats from a JSON string
team_defense_rush_stats_instance = TeamDefenseRushStats.from_json(json)
# print the JSON string representation of the object
print(TeamDefenseRushStats.to_json())

# convert the object into a dict
team_defense_rush_stats_dict = team_defense_rush_stats_instance.to_dict()
# create an instance of TeamDefenseRushStats from a dict
team_defense_rush_stats_from_dict = TeamDefenseRushStats.from_dict(team_defense_rush_stats_dict)
```
