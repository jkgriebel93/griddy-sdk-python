...
nfl_player_rushing_stats_instance = NFLPlayerRushingStats.from_json(json)
# print the JSON string representation of the object
print(NFLPlayerRushingStats.to_json())

# convert the object into a dict
nfl_player_rushing_stats_dict = nfl_player_rushing_stats_instance.to_dict()
# create an instance of NFLPlayerRushingStats from a dict
nfl_player_rushing_stats_from_dict = NFLPlayerRushingStats.from_dict(nfl_player_rushing_stats_dict)
```
