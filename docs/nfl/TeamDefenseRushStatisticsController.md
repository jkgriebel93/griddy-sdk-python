# nfl.TeamDefenseRushStatisticsController
...
> NFLNFLTeamDefenseRushStatsResponse get_team_defense_rush_stats_by_season(season, season_type, limit=limit, offset=offset, page=page, sort_key=sort_key, sort_value=sort_value)
...
```python
import nfl
from nfl.models.nflnfl_team_defense_rush_stats_response import NFLNFLTeamDefenseRushStatsResponse
...
with nfl.ApiClient(configuration) as api_client:
    ...
    api_instance = nfl.TeamDefenseRushStatisticsController(api_client)
...
[**NFLNFLTeamDefenseRushStatsResponse**](NFLTeamDefenseRushStatsResponse.md)
