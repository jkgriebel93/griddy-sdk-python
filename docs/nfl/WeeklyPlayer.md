...
json = "{}"
# create an instance of WeeklyPlayer from a JSON string
weekly_player_instance = WeeklyPlayer.from_json(json)
# print the JSON string representation of the object
print(WeeklyPlayer.to_json())

# convert the object into a dict
weekly_player_dict = weekly_player_instance.to_dict()
# create an instance of WeeklyPlayer from a dict
weekly_player_from_dict = WeeklyPlayer.from_dict(weekly_player_dict)
```
