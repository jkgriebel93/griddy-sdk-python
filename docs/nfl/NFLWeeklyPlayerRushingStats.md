...
**ngs_position** | [**NFLNFLOffensivePlayerPositionEnum**](NFLOffensivePlayerPositionEnum.md) |  | [optional] 
**ngs_position_group** | [**NFLNFLOffensivePlayerPositionEnum**](NFLOffensivePlayerPositionEnum.md) |  | [optional] 
**opponent_team_id** | **str** | Opponent team identifier | [optional] 
**position** | [**NFLNFLOffensivePlayerPositionEnum**](NFLOffensivePlayerPositionEnum.md) |  | [optional] 
**position_group** | [**NFLNFLOffensivePlayerPositionEnum**](NFLOffensivePlayerPositionEnum.md) |  | [optional] 
...
json = "{}"
# create an instance of NFLWeeklyPlayerRushingStats from a JSON string
nfl_weekly_player_rushing_stats_instance = NFLWeeklyPlayerRushingStats.from_json(json)
# print the JSON string representation of the object
print(NFLWeeklyPlayerRushingStats.to_json())

# convert the object into a dict
nfl_weekly_player_rushing_stats_dict = nfl_weekly_player_rushing_stats_instance.to_dict()
# create an instance of NFLWeeklyPlayerRushingStats from a dict
nfl_weekly_player_rushing_stats_from_dict = NFLWeeklyPlayerRushingStats.from_dict(nfl_weekly_player_rushing_stats_dict)
```
