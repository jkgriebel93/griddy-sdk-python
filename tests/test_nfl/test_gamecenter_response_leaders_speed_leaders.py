...
class TestGamecenterResponseLeadersSpeedLeaders(unittest.TestCase):
    """GamecenterResponseLeadersSpeedLeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GamecenterResponseLeadersSpeedLeaders:
        """Test GamecenterResponseLeadersSpeedLeaders
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GamecenterResponseLeadersSpeedLeaders`
        """
        model = GamecenterResponseLeadersSpeedLeaders()
        if include_optional:
            return GamecenterResponseLeadersSpeedLeaders(
                home = [
    ...
    def testGamecenterResponseLeadersSpeedLeaders(self):
        """Test GamecenterResponseLeadersSpeedLeaders"""
