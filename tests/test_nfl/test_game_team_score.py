...
class TestGameTeamScore(unittest.TestCase):
    """GameTeamScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameTeamScore:
        """Test GameTeamScore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GameTeamScore`
        """
        model = GameTeamScore()
        if include_optional:
