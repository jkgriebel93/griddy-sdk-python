...
class TestNFLInjuryEntry(unittest.TestCase):
    """NFLInjuryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLInjuryEntry:
        """Test NFLInjuryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLInjuryEntry`
        """
        model = NFLInjuryEntry()
        if include_optional:
            return NFLInjuryEntry(
