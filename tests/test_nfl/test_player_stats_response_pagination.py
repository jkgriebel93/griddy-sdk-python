...
class TestPlayerStatsResponsePagination(unittest.TestCase):
    """PlayerStatsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerStatsResponsePagination:
        """Test PlayerStatsResponsePagination
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerStatsResponsePagination`
        """
        model = PlayerStatsResponsePagination()
        if include_optional:
            return PlayerStatsResponsePagination(
                limit = 56,
                offset = 56,
                total = 56
            )
    ...
    def testPlayerStatsResponsePagination(self):
        """Test PlayerStatsResponsePagination"""
