...
class TestNFLDefensivePlayerOverviewStats(unittest.TestCase):
    """NFLDefensivePlayerOverviewStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensivePlayerOverviewStats:
        """Test NFLDefensivePlayerOverviewStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensivePlayerOverviewStats`
        """
        model = NFLDefensivePlayerOverviewStats()
        if include_optional:
            return NFLDefensivePlayerOverviewStats(
    ...
    def testNFLDefensivePlayerOverviewStats(self):
        """Test NFLDefensivePlayerOverviewStats"""
