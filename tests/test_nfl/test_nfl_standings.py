...
class TestNFLStandings(unittest.TestCase):
    """NFLStandings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStandings:
        """Test NFLStandings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStandings`
        """
        model = NFLStandings()
        if include_optional:
            return NFLStandings(
