...
class TestWeeksResponse(unittest.TestCase):
    """WeeksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeksResponse:
        """Test WeeksResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeksResponse`
        """
        model = WeeksResponse()
        if include_optional:
