...
class TestNFLDraftResponseRoundsInner(unittest.TestCase):
    """NFLDraftResponseRoundsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDraftResponseRoundsInner:
        """Test NFLDraftResponseRoundsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDraftResponseRoundsInner`
        """
        model = NFLDraftResponseRoundsInner()
        if include_optional:
            return NFLDraftResponseRoundsInner(
                picks = [
                    nfl.models.draft_pick.DraftPick(
                        college = '', 
                        is_compensatory = True, 
                        original_team = nfl.models.team.Team(
                            abbreviation = 'ARI', 
                            conference_abbr = 'AFC', 
    ...
    def testNFLDraftResponseRoundsInner(self):
        """Test NFLDraftResponseRoundsInner"""
