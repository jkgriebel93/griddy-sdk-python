...
class TestNFLDefensiveMetricsExplanationRyoe(unittest.TestCase):
    """NFLDefensiveMetricsExplanationRyoe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveMetricsExplanationRyoe:
        """Test NFLDefensiveMetricsExplanationRyoe
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveMetricsExplanationRyoe`
        """
        model = NFLDefensiveMetricsExplanationRyoe()
        if include_optional:
            return NFLDefensiveMetricsExplanationRyoe(
    ...
    def testNFLDefensiveMetricsExplanationRyoe(self):
        """Test NFLDefensiveMetricsExplanationRyoe"""
