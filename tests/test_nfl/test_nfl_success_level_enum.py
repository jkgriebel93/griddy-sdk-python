...
class TestNFLSuccessLevelEnum(unittest.TestCase):
    """NFLSuccessLevelEnum unit test stubs"""
    ...
    def testNFLSuccessLevelEnum(self):
        """Test NFLSuccessLevelEnum"""
        # inst = NFLSuccessLevelEnum()
