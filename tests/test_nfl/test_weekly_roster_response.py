...
class TestWeeklyRosterResponse(unittest.TestCase):
    """WeeklyRosterResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeklyRosterResponse:
        """Test WeeklyRosterResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeklyRosterResponse`
        """
        model = WeeklyRosterResponse()
        if include_optional:
            return WeeklyRosterResponse(
                ...
                team = src.griddy.nfl.models.team_info.TeamInfo(
                    ...
                    year_found = 56, ),
                team_players = [
                    src.griddy.nfl.models.weekly_player.WeeklyPlayer()
                    ],
                week = 3
            )
        else:
    ...
    def testWeeklyRosterResponse(self):
        """Test WeeklyRosterResponse"""
