...
class TestNFLPlayerPassingStats(unittest.TestCase):
    """NFLPlayerPassingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerPassingStats:
        """Test NFLPlayerPassingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerPassingStats`
        """
        model = NFLPlayerPassingStats()
        if include_optional:
            return NFLPlayerPassingStats(
                att = 108,
                att_pg = 36,
                avg_sep = 3.36518,
                avg_ttp = 2.68913,
    ...
    def testNFLPlayerPassingStats(self):
        """Test NFLPlayerPassingStats"""
