...
class TestNFLPlay(unittest.TestCase):
    """NFLPlay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlay:
        """Test NFLPlay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlay`
        """
        model = NFLPlay()
        if include_optional:
            return NFLPlay(
