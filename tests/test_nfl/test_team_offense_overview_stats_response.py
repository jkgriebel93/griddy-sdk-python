...
class TestTeamOffenseOverviewStatsResponse(unittest.TestCase):
    """TeamOffenseOverviewStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamOffenseOverviewStatsResponse:
        """Test TeamOffenseOverviewStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamOffenseOverviewStatsResponse`
        """
        model = TeamOffenseOverviewStatsResponse()
        if include_optional:
            return TeamOffenseOverviewStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                offense = [
                    src.griddy.nfl.models.team_offense_overview_stats.TeamOffenseOverviewStats(
                        epa = 15.245, 
                        epa_pp = 0.0824, 
                        epa_pass = 12.156, 
                        epa_pass_pp = 0.1085, 
    ...
    def testTeamOffenseOverviewStatsResponse(self):
        """Test TeamOffenseOverviewStatsResponse"""
