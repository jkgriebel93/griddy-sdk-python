...
class TestNFLNextGenStatsPositionGroupEnum(unittest.TestCase):
    """NFLNextGenStatsPositionGroupEnum unit test stubs"""
    ...
    def testNFLNextGenStatsPositionGroupEnum(self):
        """Test NFLNextGenStatsPositionGroupEnum"""
        # inst = NFLNextGenStatsPositionGroupEnum()
