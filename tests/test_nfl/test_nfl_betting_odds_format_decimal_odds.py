...
class TestNFLBettingOddsFormatDecimalOdds(unittest.TestCase):
    """NFLBettingOddsFormatDecimalOdds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBettingOddsFormatDecimalOdds:
        """Test NFLBettingOddsFormatDecimalOdds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBettingOddsFormatDecimalOdds`
        """
        model = NFLBettingOddsFormatDecimalOdds()
        if include_optional:
            return NFLBettingOddsFormatDecimalOdds(
    ...
    def testNFLBettingOddsFormatDecimalOdds(self):
        """Test NFLBettingOddsFormatDecimalOdds"""
