...
class TestNFLGameResultEnum(unittest.TestCase):
    """NFLGameResultEnum unit test stubs"""
    ...
    def testNFLGameResultEnum(self):
        """Test NFLGameResultEnum"""
        # inst = NFLGameResultEnum()
