...
class TestNFLPassingZone(unittest.TestCase):
    """NFLPassingZone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassingZone:
        """Test NFLPassingZone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassingZone`
        """
        model = NFLPassingZone()
        if include_optional:
            return NFLPassingZone(
                type = 'threeColumns',
