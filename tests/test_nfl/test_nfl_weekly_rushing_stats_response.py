...
class TestNFLWeeklyRushingStatsResponse(unittest.TestCase):
    """NFLWeeklyRushingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeeklyRushingStatsResponse:
        """Test NFLWeeklyRushingStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeeklyRushingStatsResponse`
        """
        model = NFLWeeklyRushingStatsResponse()
        if include_optional:
            return NFLWeeklyRushingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                rushers = [
                    nfl.models.weekly_player_rushing_stats.WeeklyPlayerRushingStats(
                        att = 7, 
                        att_pg = 7, 
    ...
    def testNFLWeeklyRushingStatsResponse(self):
        """Test NFLWeeklyRushingStatsResponse"""
