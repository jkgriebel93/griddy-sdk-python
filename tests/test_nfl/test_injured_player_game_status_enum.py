...
class TestInjuredPlayerGameStatusEnum(unittest.TestCase):
    """InjuredPlayerGameStatusEnum unit test stubs"""
    ...
    def testInjuredPlayerGameStatusEnum(self):
        """Test InjuredPlayerGameStatusEnum"""
        # inst = InjuredPlayerGameStatusEnum()
