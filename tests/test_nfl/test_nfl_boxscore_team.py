...
class TestNFLBoxscoreTeam(unittest.TestCase):
    """NFLBoxscoreTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBoxscoreTeam:
        """Test NFLBoxscoreTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBoxscoreTeam`
        """
        model = NFLBoxscoreTeam()
        if include_optional:
            return NFLBoxscoreTeam(
                abbr = 'PIT',
