...
class TestNFLSeasonTypeEnum(unittest.TestCase):
    """NFLSeasonTypeEnum unit test stubs"""
    ...
    def testNFLSeasonTypeEnum(self):
        """Test NFLSeasonTypeEnum"""
        # inst = NFLSeasonTypeEnum()
