...
class TestNextGenStatsPositionGroupEnum(unittest.TestCase):
    """NextGenStatsPositionGroupEnum unit test stubs"""
    ...
    def testNextGenStatsPositionGroupEnum(self):
        """Test NextGenStatsPositionGroupEnum"""
        # inst = NextGenStatsPositionGroupEnum()
