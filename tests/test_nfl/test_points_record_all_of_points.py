...
class TestPointsRecordAllOfPoints(unittest.TestCase):
    """PointsRecordAllOfPoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointsRecordAllOfPoints:
        """Test PointsRecordAllOfPoints
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PointsRecordAllOfPoints`
        """
        model = PointsRecordAllOfPoints()
        if include_optional:
            return PointsRecordAllOfPoints(
                against = 56,
                var_for = 56
            )
        else:
    ...
    def testPointsRecordAllOfPoints(self):
        """Test PointsRecordAllOfPoints"""
