...
class TestInjuryEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InjuryEntry:
        """Test InjuryEntry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InjuryEntry`
        """
        model = InjuryEntry()
        if include_optional:
            return InjuryEntry(
