...
class TestLeaderEntryBaseSchema(unittest.TestCase):
    """LeaderEntryBaseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeaderEntryBaseSchema:
        """Test LeaderEntryBaseSchema
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LeaderEntryBaseSchema`
        """
        model = LeaderEntryBaseSchema()
        if include_optional:
            return LeaderEntryBaseSchema(
                gsis_play_id = 4847,
                esb_id = 'ATW460468',
                jersey_number = 5,
    ...
    def testLeaderEntryBaseSchema(self):
        """Test LeaderEntryBaseSchema"""
