...
class TestNFLCalculationMethodEnum(unittest.TestCase):
    """NFLCalculationMethodEnum unit test stubs"""
    ...
    def testNFLCalculationMethodEnum(self):
        """Test NFLCalculationMethodEnum"""
        # inst = NFLCalculationMethodEnum()
