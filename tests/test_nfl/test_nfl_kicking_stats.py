...
class TestNFLKickingStats(unittest.TestCase):
    """NFLKickingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLKickingStats:
        """Test NFLKickingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLKickingStats`
        """
        model = NFLKickingStats()
        if include_optional:
            return NFLKickingStats(
