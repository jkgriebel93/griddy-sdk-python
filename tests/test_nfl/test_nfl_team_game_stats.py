...
class TestNFLTeamGameStats(unittest.TestCase):
    """NFLTeamGameStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamGameStats:
        """Test NFLTeamGameStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamGameStats`
        """
        model = NFLTeamGameStats()
        if include_optional:
            return NFLTeamGameStats(
                first_downs = 56,
