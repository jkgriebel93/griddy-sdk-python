...
class TestMultipleRankingsCategoryPagination(unittest.TestCase):
    """MultipleRankingsCategoryPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipleRankingsCategoryPagination:
        """Test MultipleRankingsCategoryPagination
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MultipleRankingsCategoryPagination`
        """
        model = MultipleRankingsCategoryPagination()
        if include_optional:
            return MultipleRankingsCategoryPagination(
                limit = 56,
                token = ''
            )
        else:
    ...
    def testMultipleRankingsCategoryPagination(self):
        """Test MultipleRankingsCategoryPagination"""
