...
class TestNFLCameraSourceEnum(unittest.TestCase):
    """NFLCameraSourceEnum unit test stubs"""
    ...
    def testNFLCameraSourceEnum(self):
        """Test NFLCameraSourceEnum"""
        # inst = NFLCameraSourceEnum()
