...
class TestOverallRecordAllOfStreak(unittest.TestCase):
    """OverallRecordAllOfStreak unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverallRecordAllOfStreak:
        """Test OverallRecordAllOfStreak
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OverallRecordAllOfStreak`
        """
        model = OverallRecordAllOfStreak()
        if include_optional:
            return OverallRecordAllOfStreak(
                length = 56,
                type = 'W'
            )
        else:
    ...
    def testOverallRecordAllOfStreak(self):
        """Test OverallRecordAllOfStreak"""
