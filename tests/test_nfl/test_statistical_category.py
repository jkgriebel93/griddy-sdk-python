...
class TestStatisticalCategory(unittest.TestCase):
    """StatisticalCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticalCategory:
        """Test StatisticalCategory
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StatisticalCategory`
        """
        model = StatisticalCategory()
        if include_optional:
    ...
    def testStatisticalCategory(self):
        """Test StatisticalCategory"""
