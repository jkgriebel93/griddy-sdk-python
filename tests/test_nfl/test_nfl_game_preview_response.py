...
class TestNFLGamePreviewResponse(unittest.TestCase):
    """NFLGamePreviewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamePreviewResponse:
        """Test NFLGamePreviewResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamePreviewResponse`
        """
        model = NFLGamePreviewResponse()
        if include_optional:
            return NFLGamePreviewResponse(
                preview = None
            )
        else:
            return NFLGamePreviewResponse(
    ...
    def testNFLGamePreviewResponse(self):
        """Test NFLGamePreviewResponse"""
