...
class TestFilmCard(unittest.TestCase):
    """FilmCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmCard:
        """Test FilmCard
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FilmCard`
        """
        model = FilmCard()
        if include_optional:
            return FilmCard(
