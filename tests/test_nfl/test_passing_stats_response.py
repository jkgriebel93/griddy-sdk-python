...
class TestPassingStatsResponse(unittest.TestCase):
    """PassingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassingStatsResponse:
        """Test PassingStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassingStatsResponse`
        """
        model = PassingStatsResponse()
        if include_optional:
            return PassingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                passers = [
                    src.griddy.nfl.models.player_passing_stats.PlayerPassingStats(
                        att = 108, 
                        att_pg = 36, 
                        avg_sep = 3.36518, 
                        avg_ttp = 2.68913, 
    ...
    def testPassingStatsResponse(self):
        """Test PassingStatsResponse"""
