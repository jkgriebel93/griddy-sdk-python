...
class TestNFLVenue(unittest.TestCase):
    """NFLVenue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLVenue:
        """Test NFLVenue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLVenue`
        """
        model = NFLVenue()
        if include_optional:
            return NFLVenue(
