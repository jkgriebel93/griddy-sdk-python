...
class TestOffensiveSituationTypeEnum(unittest.TestCase):
    """OffensiveSituationTypeEnum unit test stubs"""
    ...
    def testOffensiveSituationTypeEnum(self):
        """Test OffensiveSituationTypeEnum"""
        # inst = OffensiveSituationTypeEnum()
