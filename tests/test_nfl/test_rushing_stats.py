...
class TestRushingStats(unittest.TestCase):
    """RushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RushingStats:
        """Test RushingStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RushingStats`
        """
        model = RushingStats()
        if include_optional:
            return RushingStats(
