...
class TestDefensiveStatisticsController(unittest.TestCase):
    """DefensiveStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = DefensiveStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_defensive_stats_by_season(self) -> None:
        """Test case for get_defensive_stats_by_season
