...
class TestNFLBettingOddsFormatFractionalOdds(unittest.TestCase):
    """NFLBettingOddsFormatFractionalOdds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBettingOddsFormatFractionalOdds:
        """Test NFLBettingOddsFormatFractionalOdds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBettingOddsFormatFractionalOdds`
        """
        model = NFLBettingOddsFormatFractionalOdds()
        if include_optional:
            return NFLBettingOddsFormatFractionalOdds(
    ...
    def testNFLBettingOddsFormatFractionalOdds(self):
        """Test NFLBettingOddsFormatFractionalOdds"""
