...
class TestNFLPlayerWeekProjectedStatsAttributes(unittest.TestCase):
    """NFLPlayerWeekProjectedStatsAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerWeekProjectedStatsAttributes:
        """Test NFLPlayerWeekProjectedStatsAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerWeekProjectedStatsAttributes`
        """
        model = NFLPlayerWeekProjectedStatsAttributes()
        if include_optional:
            return NFLPlayerWeekProjectedStatsAttributes(
    ...
    def testNFLPlayerWeekProjectedStatsAttributes(self):
        """Test NFLPlayerWeekProjectedStatsAttributes"""
