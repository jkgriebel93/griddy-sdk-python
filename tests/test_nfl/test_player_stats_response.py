...
class TestPlayerStatsResponse(unittest.TestCase):
    """PlayerStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerStatsResponse:
        """Test PlayerStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerStatsResponse`
        """
        model = PlayerStatsResponse()
        if include_optional:
            return PlayerStatsResponse(
                pagination = src.griddy.nfl.models.player_stats_response_pagination.PlayerStatsResponse_pagination(
                    limit = 56, 
                    offset = 56, 
                    total = 56, ),
                players = [
                    src.griddy.nfl.models.player_stats_response_players_inner.PlayerStatsResponse_players_inner(
    ...
    def testPlayerStatsResponse(self):
        """Test PlayerStatsResponse"""
