...
class TestNFLPointSpread(unittest.TestCase):
    """NFLPointSpread unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPointSpread:
        """Test NFLPointSpread
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPointSpread`
        """
        model = NFLPointSpread()
        if include_optional:
            return NFLPointSpread(
                away_handicap = '-1.5',
                away_price = '-105',
                home_handicap = '+1.5',
                home_price = '-115'
