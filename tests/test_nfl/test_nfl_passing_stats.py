...
class TestNFLPassingStats(unittest.TestCase):
    """NFLPassingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassingStats:
        """Test NFLPassingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassingStats`
        """
        model = NFLPassingStats()
        if include_optional:
            return NFLPassingStats(
                attempts = 56,
