...
class TestDefensiveStatsResponse(unittest.TestCase):
    """DefensiveStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensiveStatsResponse:
        """Test DefensiveStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveStatsResponse`
        """
        model = DefensiveStatsResponse()
        if include_optional:
            return DefensiveStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defenders = [
                    src.griddy.nfl.models.defensive_player_stats.DefensivePlayerStats(
                        bh_pct = 0.0625, 
                        catch_nd = 0.5625, 
                        cov = 147, 
                        cov_nd = 143, 
    ...
    def testDefensiveStatsResponse(self):
        """Test DefensiveStatsResponse"""
