...
class TestNFLFuturesOddsResponse(unittest.TestCase):
    """NFLFuturesOddsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLFuturesOddsResponse:
        """Test NFLFuturesOddsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLFuturesOddsResponse`
        """
        model = NFLFuturesOddsResponse()
        if include_optional:
            return NFLFuturesOddsResponse(
                data = nfl.models.futures_odds_response_data.FuturesOddsResponse_data(
                    conference = [
                        nfl.models.futures_market.FuturesMarket(
                            fixture = nfl.models.fixture.fixture(), 
                            fixture_id = '', 
    ...
    def testNFLFuturesOddsResponse(self):
        """Test NFLFuturesOddsResponse"""
