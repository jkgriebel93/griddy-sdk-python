...
class TestNFLBinaryFlagEnum(unittest.TestCase):
    """NFLBinaryFlagEnum unit test stubs"""
    ...
    def testNFLBinaryFlagEnum(self):
        """Test NFLBinaryFlagEnum"""
        # inst = NFLBinaryFlagEnum()
