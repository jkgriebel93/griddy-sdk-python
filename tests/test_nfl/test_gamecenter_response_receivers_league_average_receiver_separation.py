...
class TestGamecenterResponseReceiversLeagueAverageReceiverSeparation(unittest.TestCase):
    """GamecenterResponseReceiversLeagueAverageReceiverSeparation unit test stubs"""
    ...
    def make_instance(
        ...
        """Test GamecenterResponseReceiversLeagueAverageReceiverSeparation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GamecenterResponseReceiversLeagueAverageReceiverSeparation`
        """
        model = GamecenterResponseReceiversLeagueAverageReceiverSeparation()
        if include_optional:
            return GamecenterResponseReceiversLeagueAverageReceiverSeparation(
    ...
    def testGamecenterResponseReceiversLeagueAverageReceiverSeparation(self):
        """Test GamecenterResponseReceiversLeagueAverageReceiverSeparation"""
