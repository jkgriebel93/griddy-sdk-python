...
class TestBettingOddsFormatFractionalOdds(unittest.TestCase):
    """BettingOddsFormatFractionalOdds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BettingOddsFormatFractionalOdds:
        """Test BettingOddsFormatFractionalOdds
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BettingOddsFormatFractionalOdds`
        """
        model = BettingOddsFormatFractionalOdds()
        if include_optional:
            return BettingOddsFormatFractionalOdds(
    ...
    def testBettingOddsFormatFractionalOdds(self):
        """Test BettingOddsFormatFractionalOdds"""
