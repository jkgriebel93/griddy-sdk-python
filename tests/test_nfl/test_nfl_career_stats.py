...
class TestNFLCareerStats(unittest.TestCase):
    """NFLCareerStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLCareerStats:
        """Test NFLCareerStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLCareerStats`
        """
        model = NFLCareerStats()
        if include_optional:
