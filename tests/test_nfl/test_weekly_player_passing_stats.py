...
class TestWeeklyPlayerPassingStats(unittest.TestCase):
    """WeeklyPlayerPassingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeklyPlayerPassingStats:
        """Test WeeklyPlayerPassingStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeklyPlayerPassingStats`
        """
        model = WeeklyPlayerPassingStats()
        if include_optional:
            return WeeklyPlayerPassingStats(
                att = 108,
                att_pg = 36,
                avg_sep = 3.36518,
                avg_ttp = 2.68913,
    ...
    def testWeeklyPlayerPassingStats(self):
        """Test WeeklyPlayerPassingStats"""
