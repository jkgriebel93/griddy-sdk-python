...
class TestNFLPassRushMetricsExplanationPassRushRating(unittest.TestCase):
    """NFLPassRushMetricsExplanationPassRushRating unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassRushMetricsExplanationPassRushRating:
        """Test NFLPassRushMetricsExplanationPassRushRating
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassRushMetricsExplanationPassRushRating`
        """
        model = NFLPassRushMetricsExplanationPassRushRating()
        if include_optional:
            return NFLPassRushMetricsExplanationPassRushRating(
    ...
    def testNFLPassRushMetricsExplanationPassRushRating(self):
        """Test NFLPassRushMetricsExplanationPassRushRating"""
