...
class TestNFLTeamDefenseRushStatsResponse(unittest.TestCase):
    """NFLTeamDefenseRushStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamDefenseRushStatsResponse:
        """Test NFLTeamDefenseRushStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamDefenseRushStatsResponse`
        """
        model = NFLTeamDefenseRushStatsResponse()
        if include_optional:
            return NFLTeamDefenseRushStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defense = [
                    nfl.models.team_defense_rush_stats.TeamDefenseRushStats(
                        epa_rush = -17.00447, 
                        epa_rush_pp = -0.22673, 
                        gp = 3, 
                        in_pct = 0.41333, 
    ...
    def testNFLTeamDefenseRushStatsResponse(self):
        """Test NFLTeamDefenseRushStatsResponse"""
