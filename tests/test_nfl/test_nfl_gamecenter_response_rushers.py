...
class TestNFLGamecenterResponseRushers(unittest.TestCase):
    """NFLGamecenterResponseRushers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamecenterResponseRushers:
        """Test NFLGamecenterResponseRushers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamecenterResponseRushers`
        """
        model = NFLGamecenterResponseRushers()
        if include_optional:
            return NFLGamecenterResponseRushers(
                home = [
    ...
    def testNFLGamecenterResponseRushers(self):
        """Test NFLGamecenterResponseRushers"""
