...
class TestPlayerStatsResponsePlayersInner(unittest.TestCase):
    """PlayerStatsResponsePlayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerStatsResponsePlayersInner:
        """Test PlayerStatsResponsePlayersInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerStatsResponsePlayersInner`
        """
        model = PlayerStatsResponsePlayersInner()
        if include_optional:
            return PlayerStatsResponsePlayersInner(
    ...
    def testPlayerStatsResponsePlayersInner(self):
        """Test PlayerStatsResponsePlayersInner"""
