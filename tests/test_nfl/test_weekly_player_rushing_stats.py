...
class TestWeeklyPlayerRushingStats(unittest.TestCase):
    """WeeklyPlayerRushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeklyPlayerRushingStats:
        """Test WeeklyPlayerRushingStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeklyPlayerRushingStats`
        """
        model = WeeklyPlayerRushingStats()
        if include_optional:
            return WeeklyPlayerRushingStats(
                att = 7,
                att_pg = 7,
    ...
    def testWeeklyPlayerRushingStats(self):
        """Test WeeklyPlayerRushingStats"""
