...
class TestNFLProjectedStatsResponseMetaPage(unittest.TestCase):
    """NFLProjectedStatsResponseMetaPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProjectedStatsResponseMetaPage:
        """Test NFLProjectedStatsResponseMetaPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProjectedStatsResponseMetaPage`
        """
        model = NFLProjectedStatsResponseMetaPage()
        if include_optional:
            return NFLProjectedStatsResponseMetaPage(
                number = 56,
                size = 56
            )
        else:
    ...
    def testNFLProjectedStatsResponseMetaPage(self):
        """Test NFLProjectedStatsResponseMetaPage"""
