...
class TestNFLStatisticRanking(unittest.TestCase):
    """NFLStatisticRanking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStatisticRanking:
        """Test NFLStatisticRanking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStatisticRanking`
        """
        model = NFLStatisticRanking()
        if include_optional:
            return NFLStatisticRanking(
                rank = 11,
    ...
    def testNFLStatisticRanking(self):
        """Test NFLStatisticRanking"""
