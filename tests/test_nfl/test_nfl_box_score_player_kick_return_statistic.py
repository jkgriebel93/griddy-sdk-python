...
class TestNFLBoxScorePlayerKickReturnStatistic(unittest.TestCase):
    """NFLBoxScorePlayerKickReturnStatistic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBoxScorePlayerKickReturnStatistic:
        """Test NFLBoxScorePlayerKickReturnStatistic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBoxScorePlayerKickReturnStatistic`
        """
        model = NFLBoxScorePlayerKickReturnStatistic()
        if include_optional:
            return NFLBoxScorePlayerKickReturnStatistic(
                nfl_id = 34452,
                gsis_id = '00-0039852',
                esb_id = 'NAC559347',
                jersey_number = 9,
    ...
    def testNFLBoxScorePlayerKickReturnStatistic(self):
        """Test NFLBoxScorePlayerKickReturnStatistic"""
