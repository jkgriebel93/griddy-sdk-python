...
class TestNFLExperienceTeamsResponse(unittest.TestCase):
    """NFLExperienceTeamsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLExperienceTeamsResponse:
        """Test NFLExperienceTeamsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLExperienceTeamsResponse`
        """
        model = NFLExperienceTeamsResponse()
        if include_optional:
            return NFLExperienceTeamsResponse(
                teams = [
    ...
    def testNFLExperienceTeamsResponse(self):
        """Test NFLExperienceTeamsResponse"""
