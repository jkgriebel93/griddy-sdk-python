...
class TestNFLSpeedLeaderEntry(unittest.TestCase):
    """NFLSpeedLeaderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLSpeedLeaderEntry:
        """Test NFLSpeedLeaderEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLSpeedLeaderEntry`
        """
        model = NFLSpeedLeaderEntry()
        if include_optional:
            return NFLSpeedLeaderEntry(
    ...
    def testNFLSpeedLeaderEntry(self):
        """Test NFLSpeedLeaderEntry"""
