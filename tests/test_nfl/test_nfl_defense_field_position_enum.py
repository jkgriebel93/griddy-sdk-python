...
class TestNFLDefenseFieldPositionEnum(unittest.TestCase):
    """NFLDefenseFieldPositionEnum unit test stubs"""
    ...
    def testNFLDefenseFieldPositionEnum(self):
        """Test NFLDefenseFieldPositionEnum"""
        # inst = NFLDefenseFieldPositionEnum()
