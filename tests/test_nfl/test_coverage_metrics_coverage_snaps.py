...
class TestCoverageMetricsCoverageSnaps(unittest.TestCase):
    """CoverageMetricsCoverageSnaps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoverageMetricsCoverageSnaps:
        """Test CoverageMetricsCoverageSnaps
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CoverageMetricsCoverageSnaps`
        """
        model = CoverageMetricsCoverageSnaps()
        if include_optional:
            return CoverageMetricsCoverageSnaps(
    ...
    def testCoverageMetricsCoverageSnaps(self):
        """Test CoverageMetricsCoverageSnaps"""
