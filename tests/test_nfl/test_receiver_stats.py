...
class TestReceiverStats(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReceiverStats:
        """Test ReceiverStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReceiverStats`
        """
        model = ReceiverStats()
        if include_optional:
            return ReceiverStats(
                ...
                receptions = 10,
                touchdowns = 1,
                reception_info = src.griddy.nfl.models.receiver_stats_all_of_reception_info.ReceiverStats_allOf_receptionInfo(
