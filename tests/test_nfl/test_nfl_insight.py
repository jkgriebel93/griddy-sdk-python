...
class TestNFLInsight(unittest.TestCase):
    """NFLInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLInsight:
        """Test NFLInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLInsight`
        """
        model = NFLInsight()
        if include_optional:
            return NFLInsight(
