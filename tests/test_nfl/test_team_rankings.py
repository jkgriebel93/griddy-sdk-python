...
class TestTeamRankings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TeamRankings:
        """Test TeamRankings
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamRankings`
        """
        model = TeamRankings()
        if include_optional:
            return TeamRankings(
