...
class TestSchedulesExtended:
    ...
    def test_get_data_success(
        self, mock_do_request, schedules_extended, mock_http_response
    ):
    ...
    def test_invalid_parameters(
        self, mock_do_request, schedules_extended, mock_error_response
    ):
...
class TestSchedulesExtendedAsync:
    ...
    async def test_get_data_async(
        self, mock_do_request_async, schedules_extended, mock_http_response
    ):
