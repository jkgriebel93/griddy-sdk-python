...
class TestTeamDefensePassStatistics:
    ...
    @patch(
        "griddy.nfl.team_defense_pass_statistics.TeamDefensePassStatistics.do_request"
    )
    def test_get_pass_defense_stats_success(
        self, mock_do_request, team_defense_pass_statistics, mock_http_response
    ):
    ...
    def test_get_pass_defense_stats_by_season(
        self, mock_do_request, team_defense_pass_statistics, mock_http_response
    ):
    ...
    def test_invalid_parameters(
        self, mock_do_request, team_defense_pass_statistics, mock_error_response
    ):
...
class TestTeamDefensePassStatisticsAsync:
    ...
    @pytest.mark.async_
    @patch(
        "griddy.nfl.team_defense_pass_statistics.TeamDefensePassStatistics.do_request_async"
    )
    async def test_get_pass_defense_stats_async(
        self, mock_do_request_async, team_defense_pass_statistics, mock_http_response
    ):
