...
Tests for team pass offense statistics
Related to GitHub issue #35.
"""
...
class TestTeamOffensePassStatistics:
    ...
    @pytest.fixture
    def team_offense_pass_statistics_instance(self, mock_sdk_configuration):
        """Create a TeamOffensePassStatistics instance."""
        return TeamOffensePassStatistics(mock_sdk_configuration)

    def test_initialization(self, team_offense_pass_statistics_instance, mock_sdk_configuration):
        """Test initialization with SDK configuration."""
        assert team_offense_pass_statistics_instance.sdk_configuration == mock_sdk_configuration

    @patch('griddy.nfl.team_offense_pass_statistics.TeamOffensePassStatistics.do_request')
    def test_get_data_success(
        self, mock_do_request, team_offense_pass_statistics_instance, mock_http_response
    ):
    ...
    def test_error_handling(
        self, mock_do_request, team_offense_pass_statistics_instance, mock_error_response
    ):
        """Test error handling."""
    ...
    def test_parameter_validation(self, team_offense_pass_statistics_instance):
...
class TestTeamOffensePassStatisticsAsync:
    """Test suite for async TeamOffensePassStatistics methods."""
    ...
    async def test_get_data_async(
        self, mock_do_request_async, team_offense_pass_statistics_instance, mock_http_response
    ):
