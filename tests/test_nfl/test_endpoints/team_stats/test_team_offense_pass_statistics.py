...
class TestTeamOffensePassStatistics:
    ...
    @patch(
        "griddy.nfl.team_offense_pass_statistics.TeamOffensePassStatistics.do_request"
    )
    def test_get_pass_offense_stats_success(
        self, mock_do_request, team_offense_pass_statistics, mock_http_response
    ):
    ...
    def test_get_pass_offense_stats_by_season(
        self, mock_do_request, team_offense_pass_statistics, mock_http_response
    ):
    ...
    def test_invalid_parameters(
        self, mock_do_request, team_offense_pass_statistics, mock_error_response
    ):
...
class TestTeamOffensePassStatisticsAsync:
    ...
    @pytest.mark.async_
    @patch(
        "griddy.nfl.team_offense_pass_statistics.TeamOffensePassStatistics.do_request_async"
    )
    async def test_get_pass_offense_stats_async(
        self, mock_do_request_async, team_offense_pass_statistics, mock_http_response
    ):
