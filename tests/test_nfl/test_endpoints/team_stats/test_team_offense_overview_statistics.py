...
class TestTeamOffenseOverviewStatistics:
    ...
    def test_initialization(self, team_offense_overview_statistics, mock_sdk_configuration):
        """Test TeamOffenseOverviewStatistics initialization with SDK configuration."""
        assert team_offense_overview_statistics.sdk_configuration == mock_sdk_configuration
    ...
    def test_get_offense_overview_success(self, mock_do_request, team_offense_overview_statistics, mock_http_response):
        """Test successful retrieval of team offense overview."""
        pass

    @patch('griddy.nfl.team_offense_overview_statistics.TeamOffenseOverviewStatistics.do_request')
    def test_get_offense_overview_by_season(self, mock_do_request, team_offense_overview_statistics, mock_http_response):
        """Test retrieval of offense overview by season."""
        pass

    @patch('griddy.nfl.team_offense_overview_statistics.TeamOffenseOverviewStatistics.do_request')
    def test_invalid_parameters(self, mock_do_request, team_offense_overview_statistics, mock_error_response):
        """Test error handling for invalid parameters."""
        pass

    @patch('griddy.nfl.team_offense_overview_statistics.TeamOffenseOverviewStatistics.do_request')
    def test_empty_response(self, mock_do_request, team_offense_overview_statistics, mock_http_response):
    ...
    @patch('griddy.nfl.team_offense_overview_statistics.TeamOffenseOverviewStatistics.do_request')
    def test_response_schema_validation(self, mock_do_request, team_offense_overview_statistics, mock_http_response):
...
class TestTeamOffenseOverviewStatisticsAsync:
    ...
    async def test_get_offense_overview_async(self, mock_do_request_async, team_offense_overview_statistics, mock_http_response):
