...
class TestWinProbability:
    ...
    def test_get_data_success(self, mock_do_request, win_probability, mock_http_response):
        """Test successful retrieval of data."""
        pass

    @patch('griddy.nfl.win_probability.WinProbability.do_request')
    def test_get_data_by_game(self, mock_do_request, win_probability, mock_http_response):
        """Test retrieval of data by game."""
        pass

    @patch('griddy.nfl.win_probability.WinProbability.do_request')
    def test_invalid_parameters(self, mock_do_request, win_probability, mock_error_response):
    ...
    @patch('griddy.nfl.win_probability.WinProbability.do_request')
    def test_response_schema_validation(self, mock_do_request, win_probability, mock_http_response):
