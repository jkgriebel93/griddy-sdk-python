...
class TestPlayers:
    ...
    @patch('griddy.nfl.players.Players.do_request')
    def test_get_players_by_position(self, mock_do_request, players, mock_http_response):
    ...
    @patch('griddy.nfl.players.Players.do_request')
    def test_response_schema_validation(self, mock_do_request, players, mock_http_response):
...
class TestPlayersAsync:
    ...
    async def test_get_players_async(self, mock_do_request_async, players, mock_http_response):
