...
class TestPlayerPassingStatistics:
    ...
    def test_get_passing_stats_success(self, mock_do_request, player_passing_statistics, mock_http_response):
        """Test successful retrieval of passing statistics."""
        pass

    @patch('griddy.nfl.player_passing_statistics.PlayerPassingStatistics.do_request')
    def test_get_passing_stats_by_season(self, mock_do_request, player_passing_statistics, mock_http_response):
        """Test retrieval of passing stats by season."""
        pass

    @patch('griddy.nfl.player_passing_statistics.PlayerPassingStatistics.do_request')
    def test_get_passing_stats_by_week(self, mock_do_request, player_passing_statistics, mock_http_response):
        """Test retrieval of passing stats by week."""
        pass

    @patch('griddy.nfl.player_passing_statistics.PlayerPassingStatistics.do_request')
    def test_invalid_season_parameter(self, mock_do_request, player_passing_statistics, mock_error_response):
        """Test error handling for invalid season parameter."""
        pass

    @patch('griddy.nfl.player_passing_statistics.PlayerPassingStatistics.do_request')
    def test_empty_response(self, mock_do_request, player_passing_statistics, mock_http_response):
    ...
    @patch('griddy.nfl.player_passing_statistics.PlayerPassingStatistics.do_request')
    def test_response_schema_validation(self, mock_do_request, player_passing_statistics, mock_http_response):
        """Test response schema validation."""
        pass

    @pytest.mark.parametrize("season,week,expected_valid", [
        (2024, 1, True),
        (2024, 18, True),
        (2024, 0, False),
        (2024, 25, False),
    ])
    def test_week_parameter_range(self, player_passing_statistics, season, week, expected_valid):
...
class TestPlayerPassingStatisticsAsync:
    ...
    async def test_get_passing_stats_async(self, mock_do_request_async, player_passing_statistics, mock_http_response):
