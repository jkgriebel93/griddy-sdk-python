...
class TestSecuredVideos:
    ...
    def test_get_data_success(
        self, mock_do_request, secured_videos, mock_http_response
    ):
    ...
    def test_invalid_parameters(
        self, mock_do_request, secured_videos, mock_error_response
    ):
...
class TestSecuredVideosAsync:
    ...
    async def test_get_data_async(
        self, mock_do_request_async, secured_videos, mock_http_response
    ):
