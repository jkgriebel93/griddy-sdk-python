...
class TestReplayIds(unittest.TestCase):
    """ReplayIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplayIds:
        """Test ReplayIds
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReplayIds`
        """
        model = ReplayIds()
        if include_optional:
            return ReplayIds(
