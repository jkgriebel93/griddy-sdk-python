...
class TestPlayerWeekProjectedStatsAttributes(unittest.TestCase):
    """PlayerWeekProjectedStatsAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerWeekProjectedStatsAttributes:
        """Test PlayerWeekProjectedStatsAttributes
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerWeekProjectedStatsAttributes`
        """
        model = PlayerWeekProjectedStatsAttributes()
        if include_optional:
            return PlayerWeekProjectedStatsAttributes(
    ...
    def testPlayerWeekProjectedStatsAttributes(self):
        """Test PlayerWeekProjectedStatsAttributes"""
