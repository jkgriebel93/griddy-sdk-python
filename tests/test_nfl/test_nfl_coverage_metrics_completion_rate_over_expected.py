...
class TestNFLCoverageMetricsCompletionRateOverExpected(unittest.TestCase):
    """NFLCoverageMetricsCompletionRateOverExpected unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLCoverageMetricsCompletionRateOverExpected:
        """Test NFLCoverageMetricsCompletionRateOverExpected
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLCoverageMetricsCompletionRateOverExpected`
        """
        model = NFLCoverageMetricsCompletionRateOverExpected()
        if include_optional:
            return NFLCoverageMetricsCompletionRateOverExpected(
    ...
    def testNFLCoverageMetricsCompletionRateOverExpected(self):
        """Test NFLCoverageMetricsCompletionRateOverExpected"""
