...
class TestNFLGameStatusEnum(unittest.TestCase):
    """NFLGameStatusEnum unit test stubs"""
    ...
    def testNFLGameStatusEnum(self):
        """Test NFLGameStatusEnum"""
        # inst = NFLGameStatusEnum()
