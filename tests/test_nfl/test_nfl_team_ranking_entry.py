...
class TestNFLTeamRankingEntry(unittest.TestCase):
    """NFLTeamRankingEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamRankingEntry:
        """Test NFLTeamRankingEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamRankingEntry`
        """
        model = NFLTeamRankingEntry()
        if include_optional:
            return NFLTeamRankingEntry(
                rank = 1,
                stats = 37,
    ...
    def testNFLTeamRankingEntry(self):
        """Test NFLTeamRankingEntry"""
