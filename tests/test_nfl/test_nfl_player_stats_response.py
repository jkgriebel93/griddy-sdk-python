...
class TestNFLPlayerStatsResponse(unittest.TestCase):
    """NFLPlayerStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerStatsResponse:
        """Test NFLPlayerStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerStatsResponse`
        """
        model = NFLPlayerStatsResponse()
        if include_optional:
            return NFLPlayerStatsResponse(
                pagination = nfl.models.player_stats_response_pagination.PlayerStatsResponse_pagination(
                    limit = 56, 
                    offset = 56, 
                    total = 56, ),
                players = [
                    nfl.models.player_stats_response_players_inner.PlayerStatsResponse_players_inner(
    ...
    def testNFLPlayerStatsResponse(self):
        """Test NFLPlayerStatsResponse"""
