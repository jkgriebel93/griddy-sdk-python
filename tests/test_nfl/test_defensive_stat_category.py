...
class TestDefensiveStatCategory(unittest.TestCase):
    """DefensiveStatCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensiveStatCategory:
        """Test DefensiveStatCategory
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveStatCategory`
        """
        model = DefensiveStatCategory()
        if include_optional:
            return DefensiveStatCategory(
                category = '',
                data_type = 'integer',
                description = '',
                unit = ''
    ...
    def testDefensiveStatCategory(self):
        """Test DefensiveStatCategory"""
