...
class TestOffensiveMetricsExplanationThirdDownConversion(unittest.TestCase):
    """OffensiveMetricsExplanationThirdDownConversion unit test stubs"""
    ...
    def make_instance(
        ...
        """Test OffensiveMetricsExplanationThirdDownConversion
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OffensiveMetricsExplanationThirdDownConversion`
        """
        model = OffensiveMetricsExplanationThirdDownConversion()
        if include_optional:
            return OffensiveMetricsExplanationThirdDownConversion(
    ...
    def testOffensiveMetricsExplanationThirdDownConversion(self):
        """Test OffensiveMetricsExplanationThirdDownConversion"""
