...
class TestNFLContentTagEnum(unittest.TestCase):
    """NFLContentTagEnum unit test stubs"""
    ...
    def testNFLContentTagEnum(self):
        """Test NFLContentTagEnum"""
        # inst = NFLContentTagEnum()
