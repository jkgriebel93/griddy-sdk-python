...
class TestNFLAward(unittest.TestCase):
    """NFLAward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLAward:
        """Test NFLAward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLAward`
        """
        model = NFLAward()
        if include_optional:
            return NFLAward(
