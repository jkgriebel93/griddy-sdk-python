...
class TestCoverageMetricsCompletionRateOverExpected(unittest.TestCase):
    """CoverageMetricsCompletionRateOverExpected unit test stubs"""
    ...
    def make_instance(
        ...
        """Test CoverageMetricsCompletionRateOverExpected
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CoverageMetricsCompletionRateOverExpected`
        """
        model = CoverageMetricsCompletionRateOverExpected()
        if include_optional:
            return CoverageMetricsCompletionRateOverExpected(
    ...
    def testCoverageMetricsCompletionRateOverExpected(self):
        """Test CoverageMetricsCompletionRateOverExpected"""
