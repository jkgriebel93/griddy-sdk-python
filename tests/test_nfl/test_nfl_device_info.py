...
class TestNFLDeviceInfo(unittest.TestCase):
    """NFLDeviceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDeviceInfo:
        """Test NFLDeviceInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDeviceInfo`
        """
        model = NFLDeviceInfo()
        if include_optional:
            return NFLDeviceInfo(
                model = 'desktop',
                os_name = 'Windows',
                os_version = '10',
                version = 'Chrome'
