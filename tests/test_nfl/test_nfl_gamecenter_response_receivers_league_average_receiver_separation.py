...
class TestNFLGamecenterResponseReceiversLeagueAverageReceiverSeparation(unittest.TestCase):
    """NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation:
        """Test NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation`
        """
        model = NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation()
        if include_optional:
            return NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation(
    ...
    def testNFLGamecenterResponseReceiversLeagueAverageReceiverSeparation(self):
        """Test NFLGamecenterResponseReceiversLeagueAverageReceiverSeparation"""
