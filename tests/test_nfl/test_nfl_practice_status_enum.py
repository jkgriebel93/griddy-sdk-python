...
class TestNFLPracticeStatusEnum(unittest.TestCase):
    """NFLPracticeStatusEnum unit test stubs"""
    ...
    def testNFLPracticeStatusEnum(self):
        """Test NFLPracticeStatusEnum"""
        # inst = NFLPracticeStatusEnum()
