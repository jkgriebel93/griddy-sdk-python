...
class TestNFLOverallRecordAllOfStreak(unittest.TestCase):
    """NFLOverallRecordAllOfStreak unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOverallRecordAllOfStreak:
        """Test NFLOverallRecordAllOfStreak
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOverallRecordAllOfStreak`
        """
        model = NFLOverallRecordAllOfStreak()
        if include_optional:
            return NFLOverallRecordAllOfStreak(
                length = 56,
                type = 'W'
            )
        else:
    ...
    def testNFLOverallRecordAllOfStreak(self):
        """Test NFLOverallRecordAllOfStreak"""
