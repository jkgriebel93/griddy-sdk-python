...
class TestPlayerProjectionRelationshipsWeekStatsInner(unittest.TestCase):
    """PlayerProjectionRelationshipsWeekStatsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PlayerProjectionRelationshipsWeekStatsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerProjectionRelationshipsWeekStatsInner`
        """
        model = PlayerProjectionRelationshipsWeekStatsInner()
        if include_optional:
            return PlayerProjectionRelationshipsWeekStatsInner(
                id = '',
    ...
    def testPlayerProjectionRelationshipsWeekStatsInner(self):
        """Test PlayerProjectionRelationshipsWeekStatsInner"""
