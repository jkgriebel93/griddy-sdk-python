...
class TestNFLDefensiveOverviewMetricsExplanationPressureRate(unittest.TestCase):
    """NFLDefensiveOverviewMetricsExplanationPressureRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveOverviewMetricsExplanationPressureRate:
        """Test NFLDefensiveOverviewMetricsExplanationPressureRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveOverviewMetricsExplanationPressureRate`
        """
        model = NFLDefensiveOverviewMetricsExplanationPressureRate()
        if include_optional:
            return NFLDefensiveOverviewMetricsExplanationPressureRate(
    ...
    def testNFLDefensiveOverviewMetricsExplanationPressureRate(self):
        """Test NFLDefensiveOverviewMetricsExplanationPressureRate"""
