...
class TestNFLTeamDefenseRushStats(unittest.TestCase):
    """NFLTeamDefenseRushStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamDefenseRushStats:
        """Test NFLTeamDefenseRushStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamDefenseRushStats`
        """
        model = NFLTeamDefenseRushStats()
        if include_optional:
            return NFLTeamDefenseRushStats(
                epa_rush = -17.00447,
                epa_rush_pp = -0.22673,
                gp = 3,
                in_pct = 0.41333,
    ...
    def testNFLTeamDefenseRushStats(self):
        """Test NFLTeamDefenseRushStats"""
