...
class TestNFLReceivingStats(unittest.TestCase):
    """NFLReceivingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReceivingStats:
        """Test NFLReceivingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReceivingStats`
        """
        model = NFLReceivingStats()
        if include_optional:
            return NFLReceivingStats(
                drops = 56,
                long_reception = 56,
                receptions = 56,
                targets = 56,
    ...
    def testNFLReceivingStats(self):
        """Test NFLReceivingStats"""
