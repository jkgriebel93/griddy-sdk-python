...
class TestDefensiveSplitCategory(unittest.TestCase):
    """DefensiveSplitCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensiveSplitCategory:
        """Test DefensiveSplitCategory
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveSplitCategory`
        """
        model = DefensiveSplitCategory()
        if include_optional:
            return DefensiveSplitCategory(
                category = '',
                description = '',
    ...
    def testDefensiveSplitCategory(self):
        """Test DefensiveSplitCategory"""
