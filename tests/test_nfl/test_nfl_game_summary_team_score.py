...
class TestNFLGameSummaryTeamScore(unittest.TestCase):
    """NFLGameSummaryTeamScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameSummaryTeamScore:
        """Test NFLGameSummaryTeamScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameSummaryTeamScore`
        """
        model = NFLGameSummaryTeamScore()
        if include_optional:
            return NFLGameSummaryTeamScore(
                q1 = 56,
                q2 = 56,
                q3 = 56,
                q4 = 56,
    ...
    def testNFLGameSummaryTeamScore(self):
        """Test NFLGameSummaryTeamScore"""
