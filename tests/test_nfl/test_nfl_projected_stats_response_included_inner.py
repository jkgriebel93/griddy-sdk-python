...
class TestNFLProjectedStatsResponseIncludedInner(unittest.TestCase):
    """NFLProjectedStatsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProjectedStatsResponseIncludedInner:
        """Test NFLProjectedStatsResponseIncludedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProjectedStatsResponseIncludedInner`
        """
        model = NFLProjectedStatsResponseIncludedInner()
        if include_optional:
            return NFLProjectedStatsResponseIncludedInner(
                attributes = nfl.models.player_week_projected_stats_attributes.PlayerWeekProjectedStats_attributes(
    ...
    def testNFLProjectedStatsResponseIncludedInner(self):
        """Test NFLProjectedStatsResponseIncludedInner"""
