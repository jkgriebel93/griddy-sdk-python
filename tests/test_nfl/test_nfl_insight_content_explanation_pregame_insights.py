...
class TestNFLInsightContentExplanationPregameInsights(unittest.TestCase):
    """NFLInsightContentExplanationPregameInsights unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLInsightContentExplanationPregameInsights:
        """Test NFLInsightContentExplanationPregameInsights
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLInsightContentExplanationPregameInsights`
        """
        model = NFLInsightContentExplanationPregameInsights()
        if include_optional:
            return NFLInsightContentExplanationPregameInsights(
    ...
    def testNFLInsightContentExplanationPregameInsights(self):
        """Test NFLInsightContentExplanationPregameInsights"""
