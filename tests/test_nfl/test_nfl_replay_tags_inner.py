...
class TestNFLReplayTagsInner(unittest.TestCase):
    """NFLReplayTagsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReplayTagsInner:
        """Test NFLReplayTagsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReplayTagsInner`
        """
        model = NFLReplayTagsInner()
        if include_optional:
            return NFLReplayTagsInner(
                game_id = '',
                season = '',
                season_type = '',
                week = ''
    ...
    def testNFLReplayTagsInner(self):
        """Test NFLReplayTagsInner"""
