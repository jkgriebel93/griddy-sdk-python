...
class TestNFLDefensiveMetricsExplanationEpa(unittest.TestCase):
    """NFLDefensiveMetricsExplanationEpa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveMetricsExplanationEpa:
        """Test NFLDefensiveMetricsExplanationEpa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveMetricsExplanationEpa`
        """
        model = NFLDefensiveMetricsExplanationEpa()
        if include_optional:
            return NFLDefensiveMetricsExplanationEpa(
    ...
    def testNFLDefensiveMetricsExplanationEpa(self):
        """Test NFLDefensiveMetricsExplanationEpa"""
