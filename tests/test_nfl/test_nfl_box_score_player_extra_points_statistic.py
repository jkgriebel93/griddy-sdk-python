...
class TestNFLBoxScorePlayerExtraPointsStatistic(unittest.TestCase):
    """NFLBoxScorePlayerExtraPointsStatistic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBoxScorePlayerExtraPointsStatistic:
        """Test NFLBoxScorePlayerExtraPointsStatistic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBoxScorePlayerExtraPointsStatistic`
        """
        model = NFLBoxScorePlayerExtraPointsStatistic()
        if include_optional:
            return NFLBoxScorePlayerExtraPointsStatistic(
                nfl_id = 34452,
                gsis_id = '00-0039852',
                esb_id = 'NAC559347',
                jersey_number = 9,
    ...
    def testNFLBoxScorePlayerExtraPointsStatistic(self):
        """Test NFLBoxScorePlayerExtraPointsStatistic"""
