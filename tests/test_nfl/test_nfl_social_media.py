...
class TestNFLSocialMedia(unittest.TestCase):
    """NFLSocialMedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLSocialMedia:
        """Test NFLSocialMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLSocialMedia`
        """
        model = NFLSocialMedia()
        if include_optional:
            return NFLSocialMedia(
                link = '',
                platform = 'Facebook'
            )
        else:
