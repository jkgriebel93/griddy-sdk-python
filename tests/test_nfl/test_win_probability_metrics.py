...
class TestWinProbabilityMetrics(unittest.TestCase):
    """WinProbabilityMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WinProbabilityMetrics:
        """Test WinProbabilityMetrics
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WinProbabilityMetrics`
        """
        model = WinProbabilityMetrics()
        if include_optional:
    ...
    def testWinProbabilityMetrics(self):
        """Test WinProbabilityMetrics"""
