...
class TestCoachesFileVideoSubTypeEnum(unittest.TestCase):
    """CoachesFileVideoSubTypeEnum unit test stubs"""
    ...
    def testCoachesFileVideoSubTypeEnum(self):
        """Test CoachesFileVideoSubTypeEnum"""
        # inst = CoachesFileVideoSubTypeEnum()
