...
class TestDefensiveRushMetricsExplanationBoxCount(unittest.TestCase):
    """DefensiveRushMetricsExplanationBoxCount unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DefensiveRushMetricsExplanationBoxCount
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveRushMetricsExplanationBoxCount`
        """
        model = DefensiveRushMetricsExplanationBoxCount()
        if include_optional:
            return DefensiveRushMetricsExplanationBoxCount(
    ...
    def testDefensiveRushMetricsExplanationBoxCount(self):
        """Test DefensiveRushMetricsExplanationBoxCount"""
