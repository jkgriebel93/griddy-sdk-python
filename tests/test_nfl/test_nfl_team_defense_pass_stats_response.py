...
class TestNFLTeamDefensePassStatsResponse(unittest.TestCase):
    """NFLTeamDefensePassStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamDefensePassStatsResponse:
        """Test NFLTeamDefensePassStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamDefensePassStatsResponse`
        """
        model = NFLTeamDefensePassStatsResponse()
        if include_optional:
            return NFLTeamDefensePassStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defense = [
                    nfl.models.team_defense_pass_stats.TeamDefensePassStats(
                        blitz_pct = 0.40426, 
                        epa_pass = -18.49695, 
                        epa_pass_pp = -0.21761, 
                        go = 0.82397, 
    ...
    def testNFLTeamDefensePassStatsResponse(self):
        """Test NFLTeamDefensePassStatsResponse"""
