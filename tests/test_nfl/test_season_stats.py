...
class TestSeasonStats(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SeasonStats:
        """Test SeasonStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SeasonStats`
        """
        model = SeasonStats()
        if include_optional:
            return SeasonStats(
