...
class TestNFLOffensiveFormationEnum(unittest.TestCase):
    """NFLOffensiveFormationEnum unit test stubs"""
    ...
    def testNFLOffensiveFormationEnum(self):
        """Test NFLOffensiveFormationEnum"""
        # inst = NFLOffensiveFormationEnum()
