...
class TestNFLDefensivePassRushStats(unittest.TestCase):
    """NFLDefensivePassRushStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensivePassRushStats:
        """Test NFLDefensivePassRushStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensivePassRushStats`
        """
        model = NFLDefensivePassRushStats()
        if include_optional:
            return NFLDefensivePassRushStats(
    ...
    def testNFLDefensivePassRushStats(self):
        """Test NFLDefensivePassRushStats"""
