...
class TestNFLQualifiedDefenderCriteria(unittest.TestCase):
    """NFLQualifiedDefenderCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLQualifiedDefenderCriteria:
        """Test NFLQualifiedDefenderCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLQualifiedDefenderCriteria`
        """
        model = NFLQualifiedDefenderCriteria()
        if include_optional:
            return NFLQualifiedDefenderCriteria(
                description = '',
    ...
    def testNFLQualifiedDefenderCriteria(self):
        """Test NFLQualifiedDefenderCriteria"""
