...
class TestNFLSite(unittest.TestCase):
    """NFLSite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLSite:
        """Test NFLSite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLSite`
        """
        model = NFLSite()
        if include_optional:
            return NFLSite(
