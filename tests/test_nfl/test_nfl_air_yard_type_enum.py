...
class TestNFLAirYardTypeEnum(unittest.TestCase):
    """NFLAirYardTypeEnum unit test stubs"""
    ...
    def testNFLAirYardTypeEnum(self):
        """Test NFLAirYardTypeEnum"""
        # inst = NFLAirYardTypeEnum()
