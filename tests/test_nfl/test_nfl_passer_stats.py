...
class TestNFLPasserStats(unittest.TestCase):
    """NFLPasserStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPasserStats:
        """Test NFLPasserStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPasserStats`
        """
        model = NFLPasserStats()
        if include_optional:
            return NFLPasserStats(
                attempts = 56,
                completions = 56,
                game_id = '',
                interceptions = 56,
