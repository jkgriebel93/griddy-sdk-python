...
class TestNFLOffensiveSplitCategory(unittest.TestCase):
    """NFLOffensiveSplitCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOffensiveSplitCategory:
        """Test NFLOffensiveSplitCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOffensiveSplitCategory`
        """
        model = NFLOffensiveSplitCategory()
        if include_optional:
            return NFLOffensiveSplitCategory(
                category = '',
                description = '',
                situation_type = 'FORMATION'
            )
        else:
            return NFLOffensiveSplitCategory(
        )
    ...
    def testNFLOffensiveSplitCategory(self):
        """Test NFLOffensiveSplitCategory"""
