...
class TestNFLOffenseGameSituationEnum(unittest.TestCase):
    """NFLOffenseGameSituationEnum unit test stubs"""
    ...
    def testNFLOffenseGameSituationEnum(self):
        """Test NFLOffenseGameSituationEnum"""
        # inst = NFLOffenseGameSituationEnum()
