...
class TestNFLStandingsResponseWeeksInner(unittest.TestCase):
    """NFLStandingsResponseWeeksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStandingsResponseWeeksInner:
        """Test NFLStandingsResponseWeeksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStandingsResponseWeeksInner`
        """
        model = NFLStandingsResponseWeeksInner()
        if include_optional:
            return NFLStandingsResponseWeeksInner(
                standings = [
    ...
    def testNFLStandingsResponseWeeksInner(self):
        """Test NFLStandingsResponseWeeksInner"""
