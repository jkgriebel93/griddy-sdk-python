...
class TestNFLPlayerWeekProjectedPointsAttributes(unittest.TestCase):
    """NFLPlayerWeekProjectedPointsAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerWeekProjectedPointsAttributes:
        """Test NFLPlayerWeekProjectedPointsAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerWeekProjectedPointsAttributes`
        """
        model = NFLPlayerWeekProjectedPointsAttributes()
        if include_optional:
            return NFLPlayerWeekProjectedPointsAttributes(
                player_id = '',
                points = 1.337,
                season = 56,
                settings_code = '',
    ...
    def testNFLPlayerWeekProjectedPointsAttributes(self):
        """Test NFLPlayerWeekProjectedPointsAttributes"""
