...
class TestNFLPlayStat(unittest.TestCase):
    """NFLPlayStat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayStat:
        """Test NFLPlayStat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayStat`
        """
        model = NFLPlayStat()
        if include_optional:
            return NFLPlayStat(
