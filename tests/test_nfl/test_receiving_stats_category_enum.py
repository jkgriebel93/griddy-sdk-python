...
class TestReceivingStatsCategoryEnum(unittest.TestCase):
    """ReceivingStatsCategoryEnum unit test stubs"""
    ...
    def testReceivingStatsCategoryEnum(self):
        """Test ReceivingStatsCategoryEnum"""
        # inst = ReceivingStatsCategoryEnum()
