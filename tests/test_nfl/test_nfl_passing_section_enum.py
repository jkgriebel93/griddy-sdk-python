...
class TestNFLPassingSectionEnum(unittest.TestCase):
    """NFLPassingSectionEnum unit test stubs"""
    ...
    def testNFLPassingSectionEnum(self):
        """Test NFLPassingSectionEnum"""
        # inst = NFLPassingSectionEnum()
