...
class TestNFLPlayerWeekProjectedStats(unittest.TestCase):
    """NFLPlayerWeekProjectedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerWeekProjectedStats:
        """Test NFLPlayerWeekProjectedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerWeekProjectedStats`
        """
        model = NFLPlayerWeekProjectedStats()
        if include_optional:
            return NFLPlayerWeekProjectedStats(
    ...
    def testNFLPlayerWeekProjectedStats(self):
        """Test NFLPlayerWeekProjectedStats"""
