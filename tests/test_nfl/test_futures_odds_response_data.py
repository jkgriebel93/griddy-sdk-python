...
class TestFuturesOddsResponseData(unittest.TestCase):
    """FuturesOddsResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FuturesOddsResponseData:
        """Test FuturesOddsResponseData
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FuturesOddsResponseData`
        """
        model = FuturesOddsResponseData()
        if include_optional:
            return FuturesOddsResponseData(
                conference = [
    ...
    def testFuturesOddsResponseData(self):
        """Test FuturesOddsResponseData"""
