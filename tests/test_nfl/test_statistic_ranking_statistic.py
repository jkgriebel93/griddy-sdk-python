...
class TestStatisticRankingStatistic(unittest.TestCase):
    """StatisticRankingStatistic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticRankingStatistic:
        """Test StatisticRankingStatistic
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StatisticRankingStatistic`
        """
        model = StatisticRankingStatistic()
        if include_optional:
            return StatisticRankingStatistic(
    ...
    def testStatisticRankingStatistic(self):
        """Test StatisticRankingStatistic"""
