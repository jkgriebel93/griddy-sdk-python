...
class TestStandingsTeam(unittest.TestCase):
    """StandingsTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandingsTeam:
        """Test StandingsTeam
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StandingsTeam`
        """
        model = StandingsTeam()
        if include_optional:
