...
class TestNFLWinProbabilityMetadata(unittest.TestCase):
    """NFLWinProbabilityMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWinProbabilityMetadata:
        """Test NFLWinProbabilityMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWinProbabilityMetadata`
        """
        model = NFLWinProbabilityMetadata()
        if include_optional:
            return NFLWinProbabilityMetadata(
    ...
    def testNFLWinProbabilityMetadata(self):
        """Test NFLWinProbabilityMetadata"""
