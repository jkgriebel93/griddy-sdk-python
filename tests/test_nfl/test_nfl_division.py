...
class TestNFLDivision(unittest.TestCase):
    """NFLDivision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDivision:
        """Test NFLDivision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDivision`
        """
        model = NFLDivision()
        if include_optional:
            return NFLDivision(
