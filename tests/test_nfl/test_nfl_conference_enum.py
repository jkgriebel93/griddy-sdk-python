...
class TestNFLConferenceEnum(unittest.TestCase):
    """NFLConferenceEnum unit test stubs"""
    ...
    def testNFLConferenceEnum(self):
        """Test NFLConferenceEnum"""
        # inst = NFLConferenceEnum()
