...
class TestBettingOddsFormatAmericanOddsExamplesInner(unittest.TestCase):
    """BettingOddsFormatAmericanOddsExamplesInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test BettingOddsFormatAmericanOddsExamplesInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BettingOddsFormatAmericanOddsExamplesInner`
        """
        model = BettingOddsFormatAmericanOddsExamplesInner()
        if include_optional:
            return BettingOddsFormatAmericanOddsExamplesInner(
    ...
    def testBettingOddsFormatAmericanOddsExamplesInner(self):
        """Test BettingOddsFormatAmericanOddsExamplesInner"""
