...
class TestDefensiveOverviewMetricsExplanationPressureRate(unittest.TestCase):
    """DefensiveOverviewMetricsExplanationPressureRate unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DefensiveOverviewMetricsExplanationPressureRate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveOverviewMetricsExplanationPressureRate`
        """
        model = DefensiveOverviewMetricsExplanationPressureRate()
        if include_optional:
            return DefensiveOverviewMetricsExplanationPressureRate(
    ...
    def testDefensiveOverviewMetricsExplanationPressureRate(self):
        """Test DefensiveOverviewMetricsExplanationPressureRate"""
