...
class TestWeeklyGameDetailSummaryScore(unittest.TestCase):
    """WeeklyGameDetailSummaryScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeklyGameDetailSummaryScore:
        """Test WeeklyGameDetailSummaryScore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeklyGameDetailSummaryScore`
        """
        model = WeeklyGameDetailSummaryScore()
        if include_optional:
            return WeeklyGameDetailSummaryScore(
                ot = 3,
                q1 = 7,
                q2 = 10,
                q3 = 3,
    ...
    def testWeeklyGameDetailSummaryScore(self):
        """Test WeeklyGameDetailSummaryScore"""
