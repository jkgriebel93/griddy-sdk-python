...
class TestNFLMultipleRankingsCategoryPagination(unittest.TestCase):
    """NFLMultipleRankingsCategoryPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLMultipleRankingsCategoryPagination:
        """Test NFLMultipleRankingsCategoryPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLMultipleRankingsCategoryPagination`
        """
        model = NFLMultipleRankingsCategoryPagination()
        if include_optional:
            return NFLMultipleRankingsCategoryPagination(
                limit = 56,
                token = ''
            )
        else:
    ...
    def testNFLMultipleRankingsCategoryPagination(self):
        """Test NFLMultipleRankingsCategoryPagination"""
