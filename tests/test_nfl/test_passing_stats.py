...
class TestPassingStats(unittest.TestCase):
    """PassingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassingStats:
        """Test PassingStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassingStats`
        """
        model = PassingStats()
        if include_optional:
            return PassingStats(
