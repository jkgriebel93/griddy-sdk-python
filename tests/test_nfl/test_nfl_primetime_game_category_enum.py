...
class TestNFLPrimetimeGameCategoryEnum(unittest.TestCase):
    """NFLPrimetimeGameCategoryEnum unit test stubs"""
    ...
    def testNFLPrimetimeGameCategoryEnum(self):
        """Test NFLPrimetimeGameCategoryEnum"""
        # inst = NFLPrimetimeGameCategoryEnum()
