...
class TestProInjuryReportResponsePagination(unittest.TestCase):
    """ProInjuryReportResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProInjuryReportResponsePagination:
        """Test ProInjuryReportResponsePagination
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProInjuryReportResponsePagination`
        """
        model = ProInjuryReportResponsePagination()
        if include_optional:
            return ProInjuryReportResponsePagination(
                limit = 20,
                token = ''
            )
        else:
    ...
    def testProInjuryReportResponsePagination(self):
        """Test ProInjuryReportResponsePagination"""
