...
class TestParticipantPlayerInfo(unittest.TestCase):
    """ParticipantPlayerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParticipantPlayerInfo:
        """Test ParticipantPlayerInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ParticipantPlayerInfo`
        """
        model = ParticipantPlayerInfo()
        if include_optional:
            return ParticipantPlayerInfo(
                first_name = '',
                gsis_id = '',
                last_name = '',
                nfl_id = 56,
    ...
    def testParticipantPlayerInfo(self):
        """Test ParticipantPlayerInfo"""
