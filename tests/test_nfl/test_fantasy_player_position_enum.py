...
class TestFantasyPlayerPositionEnum(unittest.TestCase):
    """FantasyPlayerPositionEnum unit test stubs"""
    ...
    def testFantasyPlayerPositionEnum(self):
        """Test FantasyPlayerPositionEnum"""
        # inst = FantasyPlayerPositionEnum()
