...
class TestNFLBroadcastInfoStreamingNetworksInner(unittest.TestCase):
    """NFLBroadcastInfoStreamingNetworksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBroadcastInfoStreamingNetworksInner:
        """Test NFLBroadcastInfoStreamingNetworksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBroadcastInfoStreamingNetworksInner`
        """
        model = NFLBroadcastInfoStreamingNetworksInner()
        if include_optional:
            return NFLBroadcastInfoStreamingNetworksInner(
                host_network = '',
                networks = [
                    ''
                    ]
    ...
    def testNFLBroadcastInfoStreamingNetworksInner(self):
        """Test NFLBroadcastInfoStreamingNetworksInner"""
