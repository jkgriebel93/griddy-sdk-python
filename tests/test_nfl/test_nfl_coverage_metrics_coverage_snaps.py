...
class TestNFLCoverageMetricsCoverageSnaps(unittest.TestCase):
    """NFLCoverageMetricsCoverageSnaps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLCoverageMetricsCoverageSnaps:
        """Test NFLCoverageMetricsCoverageSnaps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLCoverageMetricsCoverageSnaps`
        """
        model = NFLCoverageMetricsCoverageSnaps()
        if include_optional:
            return NFLCoverageMetricsCoverageSnaps(
    ...
    def testNFLCoverageMetricsCoverageSnaps(self):
        """Test NFLCoverageMetricsCoverageSnaps"""
