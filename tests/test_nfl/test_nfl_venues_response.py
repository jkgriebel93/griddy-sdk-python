...
class TestNFLVenuesResponse(unittest.TestCase):
    """NFLVenuesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLVenuesResponse:
        """Test NFLVenuesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLVenuesResponse`
        """
        model = NFLVenuesResponse()
        if include_optional:
            return NFLVenuesResponse(
    ...
    def testNFLVenuesResponse(self):
        """Test NFLVenuesResponse"""
