...
class TestPasserStats(unittest.TestCase):
    """PasserStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PasserStats:
        """Test PasserStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PasserStats`
        """
        model = PasserStats()
        if include_optional:
            return PasserStats(
