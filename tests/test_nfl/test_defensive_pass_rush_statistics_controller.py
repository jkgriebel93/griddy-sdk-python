...
class TestDefensivePassRushStatisticsController(unittest.TestCase):
    """DefensivePassRushStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = DefensivePassRushStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_defensive_pass_rush_stats_by_season(self) -> None:
        """Test case for get_defensive_pass_rush_stats_by_season
