...
class TestNFLStandingsRecordAllOfPoints(unittest.TestCase):
    """NFLStandingsRecordAllOfPoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStandingsRecordAllOfPoints:
        """Test NFLStandingsRecordAllOfPoints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStandingsRecordAllOfPoints`
        """
        model = NFLStandingsRecordAllOfPoints()
        if include_optional:
            return NFLStandingsRecordAllOfPoints(
                against = 56,
                var_for = 56
            )
        else:
    ...
    def testNFLStandingsRecordAllOfPoints(self):
        """Test NFLStandingsRecordAllOfPoints"""
