...
class TestNFLProInjuryReportResponse(unittest.TestCase):
    """NFLProInjuryReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProInjuryReportResponse:
        """Test NFLProInjuryReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProInjuryReportResponse`
        """
        model = NFLProInjuryReportResponse()
        if include_optional:
            return NFLProInjuryReportResponse(
                injuries = [
                    { }
                    ],
                pagination = nfl.models.pro_injury_report_response_pagination.ProInjuryReportResponse_pagination(
                    limit = 20, 
                    token = '', )
            )
        else:
    ...
    def testNFLProInjuryReportResponse(self):
        """Test NFLProInjuryReportResponse"""
