...
class TestTeamDefenseStatsResponse(unittest.TestCase):
    """TeamDefenseStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamDefenseStatsResponse:
        """Test TeamDefenseStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamDefenseStatsResponse`
        """
        model = TeamDefenseStatsResponse()
        if include_optional:
            return TeamDefenseStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defense = [
                    src.griddy.nfl.models.team_defense_stats.TeamDefenseStats(
    ...
    def testTeamDefenseStatsResponse(self):
        """Test TeamDefenseStatsResponse"""
