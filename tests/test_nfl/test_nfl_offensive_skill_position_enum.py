...
class TestNFLOffensiveSkillPositionEnum(unittest.TestCase):
    """NFLOffensiveSkillPositionEnum unit test stubs"""
    ...
    def testNFLOffensiveSkillPositionEnum(self):
        """Test NFLOffensiveSkillPositionEnum"""
        # inst = NFLOffensiveSkillPositionEnum()
