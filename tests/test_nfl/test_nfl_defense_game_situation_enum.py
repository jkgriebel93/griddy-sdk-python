...
class TestNFLDefenseGameSituationEnum(unittest.TestCase):
    """NFLDefenseGameSituationEnum unit test stubs"""
    ...
    def testNFLDefenseGameSituationEnum(self):
        """Test NFLDefenseGameSituationEnum"""
        # inst = NFLDefenseGameSituationEnum()
