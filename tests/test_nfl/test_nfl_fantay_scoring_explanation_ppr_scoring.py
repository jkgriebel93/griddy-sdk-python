...
class TestNFLFantayScoringExplanationPprScoring(unittest.TestCase):
    """NFLFantayScoringExplanationPprScoring unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLFantayScoringExplanationPprScoring:
        """Test NFLFantayScoringExplanationPprScoring
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLFantayScoringExplanationPprScoring`
        """
        model = NFLFantayScoringExplanationPprScoring()
        if include_optional:
            return NFLFantayScoringExplanationPprScoring(
    ...
    def testNFLFantayScoringExplanationPprScoring(self):
        """Test NFLFantayScoringExplanationPprScoring"""
