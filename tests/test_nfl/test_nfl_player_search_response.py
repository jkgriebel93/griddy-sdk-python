...
class TestNFLPlayerSearchResponse(unittest.TestCase):
    """NFLPlayerSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerSearchResponse:
        """Test NFLPlayerSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerSearchResponse`
        """
        model = NFLPlayerSearchResponse()
        if include_optional:
            return NFLPlayerSearchResponse(
                players = [
                    null
                    ],
                term = 'Pickens'
    ...
    def testNFLPlayerSearchResponse(self):
        """Test NFLPlayerSearchResponse"""
