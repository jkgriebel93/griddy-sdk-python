...
class TestPlayerStatisticsController(unittest.TestCase):
    """PlayerStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = PlayerStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_player_passing_stats_by_season(self) -> None:
        """Test case for get_player_passing_stats_by_season
