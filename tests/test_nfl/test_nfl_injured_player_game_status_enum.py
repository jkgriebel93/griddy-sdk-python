...
class TestNFLInjuredPlayerGameStatusEnum(unittest.TestCase):
    """NFLInjuredPlayerGameStatusEnum unit test stubs"""
    ...
    def testNFLInjuredPlayerGameStatusEnum(self):
        """Test NFLInjuredPlayerGameStatusEnum"""
        # inst = NFLInjuredPlayerGameStatusEnum()
