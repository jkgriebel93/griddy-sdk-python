...
class TestNFLHomeFilmCardsResponse(unittest.TestCase):
    """NFLHomeFilmCardsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLHomeFilmCardsResponse:
        """Test NFLHomeFilmCardsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLHomeFilmCardsResponse`
        """
        model = NFLHomeFilmCardsResponse()
        if include_optional:
            return NFLHomeFilmCardsResponse(
                cards = [
                    nfl.models.film_card.FilmCard(
                        link_params = nfl.models.film_card_link_params.FilmCard_linkParams(
                            dropback = 56, 
                            nfl_id = '', 
                            passer_id = '', 
                            rusher_id = '', 
    ...
    def testNFLHomeFilmCardsResponse(self):
        """Test NFLHomeFilmCardsResponse"""
