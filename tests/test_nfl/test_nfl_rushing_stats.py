...
class TestNFLRushingStats(unittest.TestCase):
    """NFLRushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLRushingStats:
        """Test NFLRushingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLRushingStats`
        """
        model = NFLRushingStats()
        if include_optional:
            return NFLRushingStats(
                carries = 56,
                fumbles = 56,
                long_rush = 56,
                touchdowns = 56,
