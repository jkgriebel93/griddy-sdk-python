...
class TestProInjuryReportResponse(unittest.TestCase):
    """ProInjuryReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProInjuryReportResponse:
        """Test ProInjuryReportResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProInjuryReportResponse`
        """
        model = ProInjuryReportResponse()
        if include_optional:
            return ProInjuryReportResponse(
                injuries = [
                    { }
                    ],
                pagination = src.griddy.nfl.models.pro_injury_report_response_pagination.ProInjuryReportResponse_pagination(
                    limit = 20, 
                    token = '', )
            )
        else:
    ...
    def testProInjuryReportResponse(self):
        """Test ProInjuryReportResponse"""
