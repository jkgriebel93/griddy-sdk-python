...
class TestNFLGamecenterResponsePassers(unittest.TestCase):
    """NFLGamecenterResponsePassers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamecenterResponsePassers:
        """Test NFLGamecenterResponsePassers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamecenterResponsePassers`
        """
        model = NFLGamecenterResponsePassers()
        if include_optional:
            return NFLGamecenterResponsePassers(
    ...
    def testNFLGamecenterResponsePassers(self):
        """Test NFLGamecenterResponsePassers"""
