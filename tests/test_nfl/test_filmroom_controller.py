...
class TestFilmroomController(unittest.TestCase):
    """FilmroomController unit test stubs"""

    def setUp(self) -> None:
        self.api = FilmroomController()

    def tearDown(self) -> None:
        pass

    def test_get_filmroom_plays(self) -> None:
        """Test case for get_filmroom_plays
