...
class TestNFLTeamScore(unittest.TestCase):
    """NFLTeamScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamScore:
        """Test NFLTeamScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamScore`
        """
        model = NFLTeamScore()
        if include_optional:
            return NFLTeamScore(
