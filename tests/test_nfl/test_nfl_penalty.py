...
class TestNFLPenalty(unittest.TestCase):
    """NFLPenalty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPenalty:
        """Test NFLPenalty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPenalty`
        """
        model = NFLPenalty()
        if include_optional:
            return NFLPenalty(
