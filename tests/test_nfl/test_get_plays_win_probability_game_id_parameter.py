...
class TestGetPlaysWinProbabilityGameIdParameter(unittest.TestCase):
    """GetPlaysWinProbabilityGameIdParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPlaysWinProbabilityGameIdParameter:
        """Test GetPlaysWinProbabilityGameIdParameter
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetPlaysWinProbabilityGameIdParameter`
        """
        model = GetPlaysWinProbabilityGameIdParameter()
        if include_optional:
            return GetPlaysWinProbabilityGameIdParameter(
            )
        else:
            return GetPlaysWinProbabilityGameIdParameter(
        )
    ...
    def testGetPlaysWinProbabilityGameIdParameter(self):
        """Test GetPlaysWinProbabilityGameIdParameter"""
