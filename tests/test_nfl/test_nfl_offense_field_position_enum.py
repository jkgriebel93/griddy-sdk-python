...
class TestNFLOffenseFieldPositionEnum(unittest.TestCase):
    """NFLOffenseFieldPositionEnum unit test stubs"""
    ...
    def testNFLOffenseFieldPositionEnum(self):
        """Test NFLOffenseFieldPositionEnum"""
        # inst = NFLOffenseFieldPositionEnum()
