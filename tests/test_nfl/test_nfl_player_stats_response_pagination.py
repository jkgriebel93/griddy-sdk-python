...
class TestNFLPlayerStatsResponsePagination(unittest.TestCase):
    """NFLPlayerStatsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerStatsResponsePagination:
        """Test NFLPlayerStatsResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerStatsResponsePagination`
        """
        model = NFLPlayerStatsResponsePagination()
        if include_optional:
            return NFLPlayerStatsResponsePagination(
                limit = 56,
                offset = 56,
                total = 56
            )
    ...
    def testNFLPlayerStatsResponsePagination(self):
        """Test NFLPlayerStatsResponsePagination"""
