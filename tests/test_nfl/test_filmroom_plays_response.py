...
class TestFilmroomPlaysResponse(unittest.TestCase):
    """FilmroomPlaysResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmroomPlaysResponse:
        """Test FilmroomPlaysResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FilmroomPlaysResponse`
        """
        model = FilmroomPlaysResponse()
        if include_optional:
            return FilmroomPlaysResponse(
                count = 148,
                plays = [
                    src.griddy.nfl.models.filmroom_play.FilmroomPlay(
    ...
    def testFilmroomPlaysResponse(self):
        """Test FilmroomPlaysResponse"""
