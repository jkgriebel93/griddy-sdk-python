...
class TestNFLGameInsight(unittest.TestCase):
    """NFLGameInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameInsight:
        """Test NFLGameInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameInsight`
        """
        model = NFLGameInsight()
        if include_optional:
            return NFLGameInsight(
                season = 56,
                season_type = 'REG',
                week = 56,
                nfl_id = 47834,
