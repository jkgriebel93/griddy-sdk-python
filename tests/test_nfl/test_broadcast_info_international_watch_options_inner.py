...
class TestBroadcastInfoInternationalWatchOptionsInner(unittest.TestCase):
    """BroadcastInfoInternationalWatchOptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test BroadcastInfoInternationalWatchOptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BroadcastInfoInternationalWatchOptionsInner`
        """
        model = BroadcastInfoInternationalWatchOptionsInner()
        if include_optional:
            return BroadcastInfoInternationalWatchOptionsInner(
                broadcasters = [
                    ''
                    ],
                country_code = ''
    ...
    def testBroadcastInfoInternationalWatchOptionsInner(self):
        """Test BroadcastInfoInternationalWatchOptionsInner"""
