...
class TestFantasyPlayerStats(unittest.TestCase):
    """FantasyPlayerStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FantasyPlayerStats:
        """Test FantasyPlayerStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FantasyPlayerStats`
        """
    ...
    def testFantasyPlayerStats(self):
        """Test FantasyPlayerStats"""
