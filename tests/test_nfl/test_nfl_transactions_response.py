...
class TestNFLTransactionsResponse(unittest.TestCase):
    """NFLTransactionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTransactionsResponse:
        """Test NFLTransactionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTransactionsResponse`
        """
        model = NFLTransactionsResponse()
        if include_optional:
            return NFLTransactionsResponse(
                pagination = nfl.models.pagination.Pagination(
                    limit = 40, 
                    token = '', ),
                transactions = [
                    nfl.models.transaction.Transaction(
                        ...
                        related_team = nfl.models.team.Team(
                            abbreviation = 'ARI', 
                            conference_abbr = 'AFC', 
    ...
    def testNFLTransactionsResponse(self):
        """Test NFLTransactionsResponse"""
