...
class TestNFLProTeam(unittest.TestCase):
    """NFLProTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProTeam:
        """Test NFLProTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProTeam`
        """
        model = NFLProTeam()
        if include_optional:
            return NFLProTeam(
