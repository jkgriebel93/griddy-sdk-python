...
class TestNFLYardsToGoTypeEnum(unittest.TestCase):
    """NFLYardsToGoTypeEnum unit test stubs"""
    ...
    def testNFLYardsToGoTypeEnum(self):
        """Test NFLYardsToGoTypeEnum"""
        # inst = NFLYardsToGoTypeEnum()
