...
class TestFilmroomPlay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FilmroomPlay:
        """Test FilmroomPlay
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FilmroomPlay`
        """
        model = FilmroomPlay()
        if include_optional:
            return FilmroomPlay(
