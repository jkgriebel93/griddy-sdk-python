...
class TestStatisticRanking(unittest.TestCase):
    """StatisticRanking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticRanking:
        """Test StatisticRanking
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StatisticRanking`
        """
        model = StatisticRanking()
        if include_optional:
            return StatisticRanking(
                rank = 11,
