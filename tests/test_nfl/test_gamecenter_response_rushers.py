...
class TestGamecenterResponseRushers(unittest.TestCase):
    """GamecenterResponseRushers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GamecenterResponseRushers:
        """Test GamecenterResponseRushers
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GamecenterResponseRushers`
        """
        model = GamecenterResponseRushers()
        if include_optional:
            return GamecenterResponseRushers(
                home = [
    ...
    def testGamecenterResponseRushers(self):
        """Test GamecenterResponseRushers"""
