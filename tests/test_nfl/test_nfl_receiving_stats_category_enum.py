...
class TestNFLReceivingStatsCategoryEnum(unittest.TestCase):
    """NFLReceivingStatsCategoryEnum unit test stubs"""
    ...
    def testNFLReceivingStatsCategoryEnum(self):
        """Test NFLReceivingStatsCategoryEnum"""
        # inst = NFLReceivingStatsCategoryEnum()
