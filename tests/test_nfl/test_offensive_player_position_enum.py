...
class TestOffensivePlayerPositionEnum(unittest.TestCase):
    """OffensivePlayerPositionEnum unit test stubs"""
    ...
    def testOffensivePlayerPositionEnum(self):
        """Test OffensivePlayerPositionEnum"""
        # inst = OffensivePlayerPositionEnum()
