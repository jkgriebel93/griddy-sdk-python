...
class TestNFLFantasyPositionGroupEnum(unittest.TestCase):
    """NFLFantasyPositionGroupEnum unit test stubs"""
    ...
    def testNFLFantasyPositionGroupEnum(self):
        """Test NFLFantasyPositionGroupEnum"""
        # inst = NFLFantasyPositionGroupEnum()
