...
class TestCoverageMetricsReceiverSeparation(unittest.TestCase):
    """CoverageMetricsReceiverSeparation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoverageMetricsReceiverSeparation:
        """Test CoverageMetricsReceiverSeparation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CoverageMetricsReceiverSeparation`
        """
        model = CoverageMetricsReceiverSeparation()
        if include_optional:
            return CoverageMetricsReceiverSeparation(
    ...
    def testCoverageMetricsReceiverSeparation(self):
        """Test CoverageMetricsReceiverSeparation"""
