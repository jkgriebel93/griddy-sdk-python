...
class TestNFLStatisticalCategory(unittest.TestCase):
    """NFLStatisticalCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStatisticalCategory:
        """Test NFLStatisticalCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStatisticalCategory`
        """
        model = NFLStatisticalCategory()
        if include_optional:
            return NFLStatisticalCategory(
                category = '',
                data_type = 'integer',
                description = '',
                unit = ''
    ...
    def testNFLStatisticalCategory(self):
        """Test NFLStatisticalCategory"""
