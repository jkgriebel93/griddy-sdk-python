...
class TestNFLOffensiveMetricsExplanationEpa(unittest.TestCase):
    """NFLOffensiveMetricsExplanationEpa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOffensiveMetricsExplanationEpa:
        """Test NFLOffensiveMetricsExplanationEpa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOffensiveMetricsExplanationEpa`
        """
        model = NFLOffensiveMetricsExplanationEpa()
        if include_optional:
            return NFLOffensiveMetricsExplanationEpa(
    ...
    def testNFLOffensiveMetricsExplanationEpa(self):
        """Test NFLOffensiveMetricsExplanationEpa"""
