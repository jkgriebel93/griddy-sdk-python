...
class TestNFLPlayParticipant(unittest.TestCase):
    """NFLPlayParticipant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayParticipant:
        """Test NFLPlayParticipant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayParticipant`
        """
        model = NFLPlayParticipant()
        if include_optional:
            return NFLPlayParticipant(
    ...
    def testNFLPlayParticipant(self):
        """Test NFLPlayParticipant"""
