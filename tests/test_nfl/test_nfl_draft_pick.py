...
class TestNFLDraftPick(unittest.TestCase):
    """NFLDraftPick unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDraftPick:
        """Test NFLDraftPick
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDraftPick`
        """
        model = NFLDraftPick()
        if include_optional:
            return NFLDraftPick(
