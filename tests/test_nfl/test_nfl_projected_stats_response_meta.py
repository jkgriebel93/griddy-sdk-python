...
class TestNFLProjectedStatsResponseMeta(unittest.TestCase):
    """NFLProjectedStatsResponseMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProjectedStatsResponseMeta:
        """Test NFLProjectedStatsResponseMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProjectedStatsResponseMeta`
        """
        model = NFLProjectedStatsResponseMeta()
        if include_optional:
            return NFLProjectedStatsResponseMeta(
    ...
    def testNFLProjectedStatsResponseMeta(self):
        """Test NFLProjectedStatsResponseMeta"""
