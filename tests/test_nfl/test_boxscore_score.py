...
class TestBoxscoreScore(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BoxscoreScore:
        """Test BoxscoreScore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BoxscoreScore`
        """
        model = BoxscoreScore()
        if include_optional:
            return BoxscoreScore(
