...
class TestNFLRushingMap(unittest.TestCase):
    """NFLRushingMap unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLRushingMap:
        """Test NFLRushingMap
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLRushingMap`
        """
        model = NFLRushingMap()
        if include_optional:
            return NFLRushingMap(
                ...
                outside_left = nfl.models.rush_location_map_entry.RushLocationMapEntry(
                    ...
                    avg_distance = 1.337, 
                    avg_time_to_los = 1.337, ),
                inside_left = nfl.models.rush_location_map_entry.RushLocationMapEntry(
                    yards = 56, 
                    attempts = 56, 
                    touchdowns = 56, 
                    distance = 1.337, 
                    ...
                    avg_distance = 1.337, 
                    avg_time_to_los = 1.337, ),
                inside_right = nfl.models.rush_location_map_entry.RushLocationMapEntry(
                    yards = 56, 
                    attempts = 56, 
                    touchdowns = 56, 
                    distance = 1.337, 
