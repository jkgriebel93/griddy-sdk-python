...
class TestRushLocationMapEntry(unittest.TestCase):
    """RushLocationMapEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RushLocationMapEntry:
        """Test RushLocationMapEntry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RushLocationMapEntry`
        """
        model = RushLocationMapEntry()
        if include_optional:
            return RushLocationMapEntry(
                yards = 56,
                attempts = 56,
                touchdowns = 56,
                distance = 1.337,
    ...
    def testRushLocationMapEntry(self):
        """Test RushLocationMapEntry"""
