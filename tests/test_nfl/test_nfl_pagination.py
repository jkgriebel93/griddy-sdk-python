...
class TestNFLPagination(unittest.TestCase):
    """NFLPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPagination:
        """Test NFLPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPagination`
        """
        model = NFLPagination()
        if include_optional:
            return NFLPagination(
                limit = 40,
                token = ''
            )
        else:
