...
class TestReceivingMetricsExplanationReceiverSeparation(unittest.TestCase):
    """ReceivingMetricsExplanationReceiverSeparation unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ReceivingMetricsExplanationReceiverSeparation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReceivingMetricsExplanationReceiverSeparation`
        """
        model = ReceivingMetricsExplanationReceiverSeparation()
        if include_optional:
            return ReceivingMetricsExplanationReceiverSeparation(
    ...
    def testReceivingMetricsExplanationReceiverSeparation(self):
        """Test ReceivingMetricsExplanationReceiverSeparation"""
