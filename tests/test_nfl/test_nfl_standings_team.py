...
class TestNFLStandingsTeam(unittest.TestCase):
    """NFLStandingsTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStandingsTeam:
        """Test NFLStandingsTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStandingsTeam`
        """
        model = NFLStandingsTeam()
        if include_optional:
            return NFLStandingsTeam(
                current_logo = '',
                full_name = '',
                id = ''
            )
