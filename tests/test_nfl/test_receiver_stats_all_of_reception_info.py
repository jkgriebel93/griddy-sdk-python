...
class TestReceiverStatsAllOfReceptionInfo(unittest.TestCase):
    """ReceiverStatsAllOfReceptionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReceiverStatsAllOfReceptionInfo:
        """Test ReceiverStatsAllOfReceptionInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReceiverStatsAllOfReceptionInfo`
        """
        model = ReceiverStatsAllOfReceptionInfo()
        if include_optional:
            return ReceiverStatsAllOfReceptionInfo(
    ...
    def testReceiverStatsAllOfReceptionInfo(self):
        """Test ReceiverStatsAllOfReceptionInfo"""
