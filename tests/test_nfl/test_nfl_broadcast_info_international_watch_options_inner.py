...
class TestNFLBroadcastInfoInternationalWatchOptionsInner(unittest.TestCase):
    """NFLBroadcastInfoInternationalWatchOptionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBroadcastInfoInternationalWatchOptionsInner:
        """Test NFLBroadcastInfoInternationalWatchOptionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBroadcastInfoInternationalWatchOptionsInner`
        """
        model = NFLBroadcastInfoInternationalWatchOptionsInner()
        if include_optional:
            return NFLBroadcastInfoInternationalWatchOptionsInner(
                broadcasters = [
                    ''
                    ],
                country_code = ''
    ...
    def testNFLBroadcastInfoInternationalWatchOptionsInner(self):
        """Test NFLBroadcastInfoInternationalWatchOptionsInner"""
