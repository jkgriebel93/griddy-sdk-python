...
class TestNFLWeeklyPlayerRushingStats(unittest.TestCase):
    """NFLWeeklyPlayerRushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeeklyPlayerRushingStats:
        """Test NFLWeeklyPlayerRushingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeeklyPlayerRushingStats`
        """
        model = NFLWeeklyPlayerRushingStats()
        if include_optional:
            return NFLWeeklyPlayerRushingStats(
                att = 7,
                att_pg = 7,
    ...
    def testNFLWeeklyPlayerRushingStats(self):
        """Test NFLWeeklyPlayerRushingStats"""
