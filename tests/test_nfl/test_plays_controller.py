...
class TestPlaysController(unittest.TestCase):
    """PlaysController unit test stubs"""

    def setUp(self) -> None:
        self.api = PlaysController()

    def tearDown(self) -> None:
        pass

    def test_get_summary_play(self) -> None:
        """Test case for get_summary_play
