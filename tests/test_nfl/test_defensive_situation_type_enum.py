...
class TestDefensiveSituationTypeEnum(unittest.TestCase):
    """DefensiveSituationTypeEnum unit test stubs"""
    ...
    def testDefensiveSituationTypeEnum(self):
        """Test DefensiveSituationTypeEnum"""
        # inst = DefensiveSituationTypeEnum()
