...
class TestDefenseGameSituationEnum(unittest.TestCase):
    """DefenseGameSituationEnum unit test stubs"""
    ...
    def testDefenseGameSituationEnum(self):
        """Test DefenseGameSituationEnum"""
        # inst = DefenseGameSituationEnum()
