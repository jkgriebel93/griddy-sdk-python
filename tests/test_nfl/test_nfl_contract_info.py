...
class TestNFLContractInfo(unittest.TestCase):
    """NFLContractInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLContractInfo:
        """Test NFLContractInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLContractInfo`
        """
        model = NFLContractInfo()
        if include_optional:
            return NFLContractInfo(
                expiration_year = 56,
                guaranteed = 1.337,
                signing_bonus = 1.337,
                total_value = 1.337,
