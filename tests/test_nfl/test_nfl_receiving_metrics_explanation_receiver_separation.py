...
class TestNFLReceivingMetricsExplanationReceiverSeparation(unittest.TestCase):
    """NFLReceivingMetricsExplanationReceiverSeparation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReceivingMetricsExplanationReceiverSeparation:
        """Test NFLReceivingMetricsExplanationReceiverSeparation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReceivingMetricsExplanationReceiverSeparation`
        """
        model = NFLReceivingMetricsExplanationReceiverSeparation()
        if include_optional:
            return NFLReceivingMetricsExplanationReceiverSeparation(
    ...
    def testNFLReceivingMetricsExplanationReceiverSeparation(self):
        """Test NFLReceivingMetricsExplanationReceiverSeparation"""
