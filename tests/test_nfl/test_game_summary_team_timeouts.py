...
class TestGameSummaryTeamTimeouts(unittest.TestCase):
    """GameSummaryTeamTimeouts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameSummaryTeamTimeouts:
        """Test GameSummaryTeamTimeouts
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GameSummaryTeamTimeouts`
        """
        model = GameSummaryTeamTimeouts()
        if include_optional:
            return GameSummaryTeamTimeouts(
                remaining = 0,
                used = 0
            )
        else:
    ...
    def testGameSummaryTeamTimeouts(self):
        """Test GameSummaryTeamTimeouts"""
