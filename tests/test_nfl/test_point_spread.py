...
class TestPointSpread(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PointSpread:
        """Test PointSpread
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PointSpread`
        """
        model = PointSpread()
        if include_optional:
            return PointSpread(
