...
class TestNFLTeam(unittest.TestCase):
    """NFLTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeam:
        """Test NFLTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeam`
        """
        model = NFLTeam()
        if include_optional:
            return NFLTeam(
