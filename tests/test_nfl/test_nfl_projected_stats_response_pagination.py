...
class TestNFLProjectedStatsResponsePagination(unittest.TestCase):
    """NFLProjectedStatsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProjectedStatsResponsePagination:
        """Test NFLProjectedStatsResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProjectedStatsResponsePagination`
        """
        model = NFLProjectedStatsResponsePagination()
        if include_optional:
            return NFLProjectedStatsResponsePagination(
                token = ''
            )
        else:
            return NFLProjectedStatsResponsePagination(
    ...
    def testNFLProjectedStatsResponsePagination(self):
        """Test NFLProjectedStatsResponsePagination"""
