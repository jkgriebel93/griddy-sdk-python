...
class TestNFLTokenRequest(unittest.TestCase):
    """NFLTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTokenRequest:
        """Test NFLTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTokenRequest`
        """
        model = NFLTokenRequest()
        if include_optional:
            return NFLTokenRequest(
