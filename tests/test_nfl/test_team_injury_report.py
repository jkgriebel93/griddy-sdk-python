...
class TestTeamInjuryReport(unittest.TestCase):
    """TeamInjuryReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamInjuryReport:
        """Test TeamInjuryReport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamInjuryReport`
        """
        model = TeamInjuryReport()
        if include_optional:
