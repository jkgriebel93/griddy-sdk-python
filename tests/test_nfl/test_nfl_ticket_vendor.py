...
class TestNFLTicketVendor(unittest.TestCase):
    """NFLTicketVendor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTicketVendor:
        """Test NFLTicketVendor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTicketVendor`
        """
        model = NFLTicketVendor()
        if include_optional:
            return NFLTicketVendor(
                ticket_url = '',
