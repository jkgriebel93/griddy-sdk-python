...
class TestNFLTeamDefenseStats(unittest.TestCase):
    """NFLTeamDefenseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamDefenseStats:
        """Test NFLTeamDefenseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamDefenseStats`
        """
        model = NFLTeamDefenseStats()
        if include_optional:
            return NFLTeamDefenseStats(
    ...
    def testNFLTeamDefenseStats(self):
        """Test NFLTeamDefenseStats"""
