...
class TestInjuryReportResponse(unittest.TestCase):
    """InjuryReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InjuryReportResponse:
        """Test InjuryReportResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InjuryReportResponse`
        """
        model = InjuryReportResponse()
        if include_optional:
            return InjuryReportResponse(
                reports = [
                    src.griddy.nfl.models.team_injury_report.TeamInjuryReport(
                        injuries = [
                            src.griddy.nfl.models.injury_entry.InjuryEntry(
                                ...
                                practice_status = src.griddy.nfl.models.injury_entry_practice_status.InjuryEntry_practiceStatus(
                                    friday = 'DNP', 
                                    thursday = 'DNP', 
                                    wednesday = 'DNP', ), )
                            ], 
    ...
    def testInjuryReportResponse(self):
        """Test InjuryReportResponse"""
