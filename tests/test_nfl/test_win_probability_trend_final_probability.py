...
class TestWinProbabilityTrendFinalProbability(unittest.TestCase):
    """WinProbabilityTrendFinalProbability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WinProbabilityTrendFinalProbability:
        """Test WinProbabilityTrendFinalProbability
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WinProbabilityTrendFinalProbability`
        """
        model = WinProbabilityTrendFinalProbability()
        if include_optional:
            return WinProbabilityTrendFinalProbability(
                away_team = 0,
                home_team = 0
            )
        else:
    ...
    def testWinProbabilityTrendFinalProbability(self):
        """Test WinProbabilityTrendFinalProbability"""
