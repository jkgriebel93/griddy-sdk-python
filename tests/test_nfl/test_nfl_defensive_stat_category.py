...
class TestNFLDefensiveStatCategory(unittest.TestCase):
    """NFLDefensiveStatCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveStatCategory:
        """Test NFLDefensiveStatCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveStatCategory`
        """
        model = NFLDefensiveStatCategory()
        if include_optional:
            return NFLDefensiveStatCategory(
                category = '',
                data_type = 'integer',
                description = '',
                unit = ''
    ...
    def testNFLDefensiveStatCategory(self):
        """Test NFLDefensiveStatCategory"""
