...
class TestNFLDefensivePositionGroupEnum(unittest.TestCase):
    """NFLDefensivePositionGroupEnum unit test stubs"""
    ...
    def testNFLDefensivePositionGroupEnum(self):
        """Test NFLDefensivePositionGroupEnum"""
        # inst = NFLDefensivePositionGroupEnum()
