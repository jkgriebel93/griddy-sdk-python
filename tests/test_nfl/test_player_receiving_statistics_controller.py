...
class TestPlayerReceivingStatisticsController(unittest.TestCase):
    """PlayerReceivingStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = PlayerReceivingStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_player_receiving_stats_by_season(self) -> None:
        """Test case for get_player_receiving_stats_by_season

        Get Player Receiving Statistics by Season
        """
        pass

    def test_get_player_receiving_stats_by_week(self) -> None:
        """Test case for get_player_receiving_stats_by_week
