...
class TestNFLOffensiveSituationTypeEnum(unittest.TestCase):
    """NFLOffensiveSituationTypeEnum unit test stubs"""
    ...
    def testNFLOffensiveSituationTypeEnum(self):
        """Test NFLOffensiveSituationTypeEnum"""
        # inst = NFLOffensiveSituationTypeEnum()
