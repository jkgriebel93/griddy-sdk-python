...
class TestNFLTeamOffenseOverviewStats(unittest.TestCase):
    """NFLTeamOffenseOverviewStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamOffenseOverviewStats:
        """Test NFLTeamOffenseOverviewStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamOffenseOverviewStats`
        """
        model = NFLTeamOffenseOverviewStats()
        if include_optional:
            return NFLTeamOffenseOverviewStats(
                epa = 15.245,
                epa_pp = 0.0824,
                epa_pass = 12.156,
                epa_pass_pp = 0.1085,
    ...
    def testNFLTeamOffenseOverviewStats(self):
        """Test NFLTeamOffenseOverviewStats"""
