...
class TestLiveGameAwayTeam(unittest.TestCase):
    """LiveGameAwayTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiveGameAwayTeam:
        """Test LiveGameAwayTeam
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LiveGameAwayTeam`
        """
        model = LiveGameAwayTeam()
        if include_optional:
            return LiveGameAwayTeam(
                abbreviation = '',
                score = 56,
                team_id = ''
            )
