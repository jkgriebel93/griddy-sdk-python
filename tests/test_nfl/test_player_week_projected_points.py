...
class TestPlayerWeekProjectedPoints(unittest.TestCase):
    """PlayerWeekProjectedPoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerWeekProjectedPoints:
        """Test PlayerWeekProjectedPoints
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerWeekProjectedPoints`
        """
        model = PlayerWeekProjectedPoints()
        if include_optional:
            return PlayerWeekProjectedPoints(
                attributes = src.griddy.nfl.models.player_week_projected_points_attributes.PlayerWeekProjectedPoints_attributes(
                    player_id = '', 
                    points = 1.337, 
                    season = 56, 
                    settings_code = '', 
    ...
    def testPlayerWeekProjectedPoints(self):
        """Test PlayerWeekProjectedPoints"""
