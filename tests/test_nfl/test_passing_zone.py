...
class TestPassingZone(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PassingZone:
        """Test PassingZone
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassingZone`
        """
        model = PassingZone()
        if include_optional:
            return PassingZone(
