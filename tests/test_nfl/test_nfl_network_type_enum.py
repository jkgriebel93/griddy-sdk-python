...
class TestNFLNetworkTypeEnum(unittest.TestCase):
    """NFLNetworkTypeEnum unit test stubs"""
    ...
    def testNFLNetworkTypeEnum(self):
        """Test NFLNetworkTypeEnum"""
        # inst = NFLNetworkTypeEnum()
