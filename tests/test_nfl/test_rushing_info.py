...
class TestRushingInfo(unittest.TestCase):
    """RushingInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RushingInfo:
        """Test RushingInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RushingInfo`
        """
        model = RushingInfo()
        if include_optional:
            return RushingInfo(
