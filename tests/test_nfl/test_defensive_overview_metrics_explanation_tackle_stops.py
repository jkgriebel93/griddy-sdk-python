...
class TestDefensiveOverviewMetricsExplanationTackleStops(unittest.TestCase):
    """DefensiveOverviewMetricsExplanationTackleStops unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DefensiveOverviewMetricsExplanationTackleStops
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveOverviewMetricsExplanationTackleStops`
        """
        model = DefensiveOverviewMetricsExplanationTackleStops()
        if include_optional:
            return DefensiveOverviewMetricsExplanationTackleStops(
    ...
    def testDefensiveOverviewMetricsExplanationTackleStops(self):
        """Test DefensiveOverviewMetricsExplanationTackleStops"""
