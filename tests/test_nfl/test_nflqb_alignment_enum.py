...
class TestNFLQBAlignmentEnum(unittest.TestCase):
    """NFLQBAlignmentEnum unit test stubs"""
    ...
    def testNFLQBAlignmentEnum(self):
        """Test NFLQBAlignmentEnum"""
        # inst = NFLQBAlignmentEnum()
