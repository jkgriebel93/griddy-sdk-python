...
class TestNFLConference(unittest.TestCase):
    """NFLConference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLConference:
        """Test NFLConference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLConference`
        """
        model = NFLConference()
        if include_optional:
