...
class TestNFLGameScore(unittest.TestCase):
    """NFLGameScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameScore:
        """Test NFLGameScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameScore`
        """
        model = NFLGameScore()
        if include_optional:
            return NFLGameScore(
