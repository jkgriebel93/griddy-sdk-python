...
class TestPlayerRushingStats(unittest.TestCase):
    """PlayerRushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerRushingStats:
        """Test PlayerRushingStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlayerRushingStats`
        """
        model = PlayerRushingStats()
        if include_optional:
            return PlayerRushingStats(
                att = 40,
                att_pg = 13.33333,
    ...
    def testPlayerRushingStats(self):
        """Test PlayerRushingStats"""
