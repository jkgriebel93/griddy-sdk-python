...
class TestNFLGamecenterResponseLeadersSpeedLeaders(unittest.TestCase):
    """NFLGamecenterResponseLeadersSpeedLeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamecenterResponseLeadersSpeedLeaders:
        """Test NFLGamecenterResponseLeadersSpeedLeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamecenterResponseLeadersSpeedLeaders`
        """
        model = NFLGamecenterResponseLeadersSpeedLeaders()
        if include_optional:
            return NFLGamecenterResponseLeadersSpeedLeaders(
                home = [
    ...
    def testNFLGamecenterResponseLeadersSpeedLeaders(self):
        """Test NFLGamecenterResponseLeadersSpeedLeaders"""
