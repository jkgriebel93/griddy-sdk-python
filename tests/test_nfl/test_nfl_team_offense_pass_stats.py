...
class TestNFLTeamOffensePassStats(unittest.TestCase):
    """NFLTeamOffensePassStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamOffensePassStats:
        """Test NFLTeamOffensePassStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamOffensePassStats`
        """
        model = NFLTeamOffensePassStats()
        if include_optional:
            return NFLTeamOffensePassStats(
                att = 45,
                blitz_pct = 0.29167,
                epa_pass = -4.45186,
                epa_pass_pp = -0.09275,
    ...
    def testNFLTeamOffensePassStats(self):
        """Test NFLTeamOffensePassStats"""
