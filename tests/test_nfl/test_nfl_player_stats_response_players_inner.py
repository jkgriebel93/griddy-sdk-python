...
class TestNFLPlayerStatsResponsePlayersInner(unittest.TestCase):
    """NFLPlayerStatsResponsePlayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerStatsResponsePlayersInner:
        """Test NFLPlayerStatsResponsePlayersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerStatsResponsePlayersInner`
        """
        model = NFLPlayerStatsResponsePlayersInner()
        if include_optional:
            return NFLPlayerStatsResponsePlayersInner(
    ...
    def testNFLPlayerStatsResponsePlayersInner(self):
        """Test NFLPlayerStatsResponsePlayersInner"""
