...
class TestNFLTimeToSackLeaderEntry(unittest.TestCase):
    """NFLTimeToSackLeaderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTimeToSackLeaderEntry:
        """Test NFLTimeToSackLeaderEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTimeToSackLeaderEntry`
        """
        model = NFLTimeToSackLeaderEntry()
        if include_optional:
            return NFLTimeToSackLeaderEntry(
                tackle_info = None,
                gsis_play_id = 4847,
                esb_id = 'ATW460468',
                jersey_number = 5,
    ...
    def testNFLTimeToSackLeaderEntry(self):
        """Test NFLTimeToSackLeaderEntry"""
