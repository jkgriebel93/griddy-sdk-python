...
class TestNFLPlayerRushingStats(unittest.TestCase):
    """NFLPlayerRushingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerRushingStats:
        """Test NFLPlayerRushingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerRushingStats`
        """
        model = NFLPlayerRushingStats()
        if include_optional:
            return NFLPlayerRushingStats(
                att = 40,
                att_pg = 13.33333,
    ...
    def testNFLPlayerRushingStats(self):
        """Test NFLPlayerRushingStats"""
