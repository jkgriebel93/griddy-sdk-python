...
class TestTeamDefensePassStats(unittest.TestCase):
    """TeamDefensePassStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamDefensePassStats:
        """Test TeamDefensePassStats
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamDefensePassStats`
        """
        model = TeamDefensePassStats()
        if include_optional:
            return TeamDefensePassStats(
                blitz_pct = 0.40426,
                epa_pass = -18.49695,
                epa_pass_pp = -0.21761,
                go = 0.82397,
    ...
    def testTeamDefensePassStats(self):
        """Test TeamDefensePassStats"""
