...
class TestDraftResponseRoundsInner(unittest.TestCase):
    """DraftResponseRoundsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DraftResponseRoundsInner:
        """Test DraftResponseRoundsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DraftResponseRoundsInner`
        """
        model = DraftResponseRoundsInner()
        if include_optional:
            return DraftResponseRoundsInner(
                picks = [
                    src.griddy.nfl.models.draft_pick.DraftPick(
                        college = '', 
                        is_compensatory = True, 
                        original_team = src.griddy.nfl.models.team.Team(
                            abbreviation = 'ARI', 
                            conference_abbr = 'AFC', 
    ...
    def testDraftResponseRoundsInner(self):
        """Test DraftResponseRoundsInner"""
