...
class TestNFLWeeklyPlayer(unittest.TestCase):
    """NFLWeeklyPlayer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeeklyPlayer:
        """Test NFLWeeklyPlayer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeeklyPlayer`
        """
        model = NFLWeeklyPlayer()
        if include_optional:
            return NFLWeeklyPlayer(
