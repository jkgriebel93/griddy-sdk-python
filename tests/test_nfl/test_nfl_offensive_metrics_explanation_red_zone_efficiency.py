...
class TestNFLOffensiveMetricsExplanationRedZoneEfficiency(unittest.TestCase):
    """NFLOffensiveMetricsExplanationRedZoneEfficiency unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOffensiveMetricsExplanationRedZoneEfficiency:
        """Test NFLOffensiveMetricsExplanationRedZoneEfficiency
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOffensiveMetricsExplanationRedZoneEfficiency`
        """
        model = NFLOffensiveMetricsExplanationRedZoneEfficiency()
        if include_optional:
            return NFLOffensiveMetricsExplanationRedZoneEfficiency(
    ...
    def testNFLOffensiveMetricsExplanationRedZoneEfficiency(self):
        """Test NFLOffensiveMetricsExplanationRedZoneEfficiency"""
