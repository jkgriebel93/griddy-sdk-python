...
class TestNFLPlayerProjectionRelationshipsWeekPointsInner(unittest.TestCase):
    """NFLPlayerProjectionRelationshipsWeekPointsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerProjectionRelationshipsWeekPointsInner:
        """Test NFLPlayerProjectionRelationshipsWeekPointsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerProjectionRelationshipsWeekPointsInner`
        """
        model = NFLPlayerProjectionRelationshipsWeekPointsInner()
        if include_optional:
            return NFLPlayerProjectionRelationshipsWeekPointsInner(
                id = '',
    ...
    def testNFLPlayerProjectionRelationshipsWeekPointsInner(self):
        """Test NFLPlayerProjectionRelationshipsWeekPointsInner"""
