...
class TestDefensivePassMetricsExplanationReceiverSeparation(unittest.TestCase):
    """DefensivePassMetricsExplanationReceiverSeparation unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DefensivePassMetricsExplanationReceiverSeparation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensivePassMetricsExplanationReceiverSeparation`
        """
        model = DefensivePassMetricsExplanationReceiverSeparation()
        if include_optional:
            return DefensivePassMetricsExplanationReceiverSeparation(
    ...
    def testDefensivePassMetricsExplanationReceiverSeparation(self):
        """Test DefensivePassMetricsExplanationReceiverSeparation"""
