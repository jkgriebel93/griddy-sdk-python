...
class TestBettingController(unittest.TestCase):
    """BettingController unit test stubs"""

    def setUp(self) -> None:
        self.api = BettingController()

    def tearDown(self) -> None:
        pass

    def test_get_weekly_betting_odds(self) -> None:
        """Test case for get_weekly_betting_odds
