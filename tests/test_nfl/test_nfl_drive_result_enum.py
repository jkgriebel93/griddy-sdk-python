...
class TestNFLDriveResultEnum(unittest.TestCase):
    """NFLDriveResultEnum unit test stubs"""
    ...
    def testNFLDriveResultEnum(self):
        """Test NFLDriveResultEnum"""
        # inst = NFLDriveResultEnum()
