...
class TestNFLInjuryEntryPracticeStatus(unittest.TestCase):
    """NFLInjuryEntryPracticeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLInjuryEntryPracticeStatus:
        """Test NFLInjuryEntryPracticeStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLInjuryEntryPracticeStatus`
        """
        model = NFLInjuryEntryPracticeStatus()
        if include_optional:
            return NFLInjuryEntryPracticeStatus(
                friday = 'DNP',
                thursday = 'DNP',
                wednesday = 'DNP'
            )
    ...
    def testNFLInjuryEntryPracticeStatus(self):
        """Test NFLInjuryEntryPracticeStatus"""
