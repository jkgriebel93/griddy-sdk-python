...
class TestNFLBettingOddsFormatAmericanOddsExamplesInner(unittest.TestCase):
    """NFLBettingOddsFormatAmericanOddsExamplesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLBettingOddsFormatAmericanOddsExamplesInner:
        """Test NFLBettingOddsFormatAmericanOddsExamplesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLBettingOddsFormatAmericanOddsExamplesInner`
        """
        model = NFLBettingOddsFormatAmericanOddsExamplesInner()
        if include_optional:
            return NFLBettingOddsFormatAmericanOddsExamplesInner(
    ...
    def testNFLBettingOddsFormatAmericanOddsExamplesInner(self):
        """Test NFLBettingOddsFormatAmericanOddsExamplesInner"""
