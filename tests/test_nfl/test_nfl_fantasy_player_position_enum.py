...
class TestNFLFantasyPlayerPositionEnum(unittest.TestCase):
    """NFLFantasyPlayerPositionEnum unit test stubs"""
    ...
    def testNFLFantasyPlayerPositionEnum(self):
        """Test NFLFantasyPlayerPositionEnum"""
        # inst = NFLFantasyPlayerPositionEnum()
