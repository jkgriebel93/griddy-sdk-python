...
class TestNFLWinProbabilityMetrics(unittest.TestCase):
    """NFLWinProbabilityMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWinProbabilityMetrics:
        """Test NFLWinProbabilityMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWinProbabilityMetrics`
        """
        model = NFLWinProbabilityMetrics()
        if include_optional:
            return NFLWinProbabilityMetrics(
                critical_plays = '',
                win_probability = '',
    ...
    def testNFLWinProbabilityMetrics(self):
        """Test NFLWinProbabilityMetrics"""
