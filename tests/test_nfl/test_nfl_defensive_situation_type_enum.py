...
class TestNFLDefensiveSituationTypeEnum(unittest.TestCase):
    """NFLDefensiveSituationTypeEnum unit test stubs"""
    ...
    def testNFLDefensiveSituationTypeEnum(self):
        """Test NFLDefensiveSituationTypeEnum"""
        # inst = NFLDefensiveSituationTypeEnum()
