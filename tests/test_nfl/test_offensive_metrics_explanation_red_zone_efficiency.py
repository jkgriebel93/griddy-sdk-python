...
class TestOffensiveMetricsExplanationRedZoneEfficiency(unittest.TestCase):
    """OffensiveMetricsExplanationRedZoneEfficiency unit test stubs"""
    ...
    def make_instance(
        ...
        """Test OffensiveMetricsExplanationRedZoneEfficiency
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OffensiveMetricsExplanationRedZoneEfficiency`
        """
        model = OffensiveMetricsExplanationRedZoneEfficiency()
        if include_optional:
            return OffensiveMetricsExplanationRedZoneEfficiency(
    ...
    def testOffensiveMetricsExplanationRedZoneEfficiency(self):
        """Test OffensiveMetricsExplanationRedZoneEfficiency"""
