...
class TestWeeklyPassingStatsResponse(unittest.TestCase):
    """WeeklyPassingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeeklyPassingStatsResponse:
        """Test WeeklyPassingStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WeeklyPassingStatsResponse`
        """
        model = WeeklyPassingStatsResponse()
        if include_optional:
            return WeeklyPassingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
    ...
    def testWeeklyPassingStatsResponse(self):
        """Test WeeklyPassingStatsResponse"""
