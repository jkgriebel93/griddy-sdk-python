...
class TestNFLCoachesFileVideoSubTypeEnum(unittest.TestCase):
    """NFLCoachesFileVideoSubTypeEnum unit test stubs"""
    ...
    def testNFLCoachesFileVideoSubTypeEnum(self):
        """Test NFLCoachesFileVideoSubTypeEnum"""
        # inst = NFLCoachesFileVideoSubTypeEnum()
