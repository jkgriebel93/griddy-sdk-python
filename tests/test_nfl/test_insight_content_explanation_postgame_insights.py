...
class TestInsightContentExplanationPostgameInsights(unittest.TestCase):
    """InsightContentExplanationPostgameInsights unit test stubs"""
    ...
    def make_instance(
        ...
        """Test InsightContentExplanationPostgameInsights
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InsightContentExplanationPostgameInsights`
        """
        model = InsightContentExplanationPostgameInsights()
        if include_optional:
            return InsightContentExplanationPostgameInsights(
    ...
    def testInsightContentExplanationPostgameInsights(self):
        """Test InsightContentExplanationPostgameInsights"""
