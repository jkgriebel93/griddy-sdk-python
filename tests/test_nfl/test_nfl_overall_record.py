...
class TestNFLOverallRecord(unittest.TestCase):
    """NFLOverallRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOverallRecord:
        """Test NFLOverallRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOverallRecord`
        """
        model = NFLOverallRecord()
        if include_optional:
            return NFLOverallRecord(
                losses = 56,
                ties = 56,
                wins = 56,
                points = nfl.models.points_record_all_of_points.PointsRecord_allOf_points(
                    against = 56, 
                    for = 56, ),
                win_pct = 1.337,
                games = 56,
                streak = nfl.models.overall_record_all_of_streak.OverallRecord_allOf_streak(
                    length = 56, 
                    type = 'W', )
            )
        else:
