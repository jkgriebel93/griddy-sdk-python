...
class TestFantayScoringExplanationPprScoring(unittest.TestCase):
    """FantayScoringExplanationPprScoring unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FantayScoringExplanationPprScoring:
        """Test FantayScoringExplanationPprScoring
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FantayScoringExplanationPprScoring`
        """
        model = FantayScoringExplanationPprScoring()
        if include_optional:
            return FantayScoringExplanationPprScoring(
    ...
    def testFantayScoringExplanationPprScoring(self):
        """Test FantayScoringExplanationPprScoring"""
