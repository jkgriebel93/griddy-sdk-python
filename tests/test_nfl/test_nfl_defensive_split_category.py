...
class TestNFLDefensiveSplitCategory(unittest.TestCase):
    """NFLDefensiveSplitCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveSplitCategory:
        """Test NFLDefensiveSplitCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveSplitCategory`
        """
        model = NFLDefensiveSplitCategory()
        if include_optional:
            return NFLDefensiveSplitCategory(
                category = '',
                description = '',
                situation_type = 'PERSONNEL'
            )
        else:
            return NFLDefensiveSplitCategory(
        )
    ...
    def testNFLDefensiveSplitCategory(self):
        """Test NFLDefensiveSplitCategory"""
