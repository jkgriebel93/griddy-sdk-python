...
class TestCoverageMetricsTargetsAllowed(unittest.TestCase):
    """CoverageMetricsTargetsAllowed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoverageMetricsTargetsAllowed:
        """Test CoverageMetricsTargetsAllowed
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CoverageMetricsTargetsAllowed`
        """
        model = CoverageMetricsTargetsAllowed()
        if include_optional:
            return CoverageMetricsTargetsAllowed(
    ...
    def testCoverageMetricsTargetsAllowed(self):
        """Test CoverageMetricsTargetsAllowed"""
