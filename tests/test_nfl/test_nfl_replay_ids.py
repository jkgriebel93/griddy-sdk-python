...
class TestNFLReplayIds(unittest.TestCase):
    """NFLReplayIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReplayIds:
        """Test NFLReplayIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReplayIds`
        """
        model = NFLReplayIds()
        if include_optional:
            return NFLReplayIds(
