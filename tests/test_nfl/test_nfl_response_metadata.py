...
class TestNFLResponseMetadata(unittest.TestCase):
    """NFLResponseMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLResponseMetadata:
        """Test NFLResponseMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLResponseMetadata`
        """
        model = NFLResponseMetadata()
        if include_optional:
            return NFLResponseMetadata(
    ...
    def testNFLResponseMetadata(self):
        """Test NFLResponseMetadata"""
