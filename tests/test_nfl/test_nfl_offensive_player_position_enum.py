...
class TestNFLOffensivePlayerPositionEnum(unittest.TestCase):
    """NFLOffensivePlayerPositionEnum unit test stubs"""
    ...
    def testNFLOffensivePlayerPositionEnum(self):
        """Test NFLOffensivePlayerPositionEnum"""
        # inst = NFLOffensivePlayerPositionEnum()
