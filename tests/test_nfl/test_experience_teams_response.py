...
class TestExperienceTeamsResponse(unittest.TestCase):
    """ExperienceTeamsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperienceTeamsResponse:
        """Test ExperienceTeamsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExperienceTeamsResponse`
        """
        model = ExperienceTeamsResponse()
        if include_optional:
            return ExperienceTeamsResponse(
                teams = [
    ...
    def testExperienceTeamsResponse(self):
        """Test ExperienceTeamsResponse"""
