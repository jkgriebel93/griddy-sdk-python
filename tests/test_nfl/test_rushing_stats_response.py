...
class TestRushingStatsResponse(unittest.TestCase):
    """RushingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RushingStatsResponse:
        """Test RushingStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RushingStatsResponse`
        """
        model = RushingStatsResponse()
        if include_optional:
            return RushingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                rushers = [
                    src.griddy.nfl.models.player_rushing_stats.PlayerRushingStats(
                        att = 40, 
                        att_pg = 13.33333, 
    ...
    def testRushingStatsResponse(self):
        """Test RushingStatsResponse"""
