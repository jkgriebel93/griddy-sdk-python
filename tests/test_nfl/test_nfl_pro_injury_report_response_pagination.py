...
class TestNFLProInjuryReportResponsePagination(unittest.TestCase):
    """NFLProInjuryReportResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLProInjuryReportResponsePagination:
        """Test NFLProInjuryReportResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLProInjuryReportResponsePagination`
        """
        model = NFLProInjuryReportResponsePagination()
        if include_optional:
            return NFLProInjuryReportResponsePagination(
                limit = 20,
                token = ''
            )
        else:
    ...
    def testNFLProInjuryReportResponsePagination(self):
        """Test NFLProInjuryReportResponsePagination"""
