...
class TestNFLPassDistanceLeaderEntry(unittest.TestCase):
    """NFLPassDistanceLeaderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassDistanceLeaderEntry:
        """Test NFLPassDistanceLeaderEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassDistanceLeaderEntry`
        """
        model = NFLPassDistanceLeaderEntry()
        if include_optional:
            return NFLPassDistanceLeaderEntry(
                pass_info = None,
                gsis_play_id = 4847,
                esb_id = 'ATW460468',
                jersey_number = 5,
    ...
    def testNFLPassDistanceLeaderEntry(self):
        """Test NFLPassDistanceLeaderEntry"""
