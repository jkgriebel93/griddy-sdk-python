...
class TestGameSummaryTeam(unittest.TestCase):
    """GameSummaryTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameSummaryTeam:
        """Test GameSummaryTeam
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GameSummaryTeam`
        """
        model = GameSummaryTeam()
        if include_optional:
            return GameSummaryTeam(
                team_id = '',
                has_possession = True,
