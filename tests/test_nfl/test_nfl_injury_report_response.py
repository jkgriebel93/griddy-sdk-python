...
class TestNFLInjuryReportResponse(unittest.TestCase):
    """NFLInjuryReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLInjuryReportResponse:
        """Test NFLInjuryReportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLInjuryReportResponse`
        """
        model = NFLInjuryReportResponse()
        if include_optional:
            return NFLInjuryReportResponse(
                reports = [
                    nfl.models.team_injury_report.TeamInjuryReport(
                        injuries = [
                            nfl.models.injury_entry.InjuryEntry(
                                ...
                                practice_status = nfl.models.injury_entry_practice_status.InjuryEntry_practiceStatus(
                                    friday = 'DNP', 
                                    thursday = 'DNP', 
                                    wednesday = 'DNP', ), )
                            ], 
    ...
    def testNFLInjuryReportResponse(self):
        """Test NFLInjuryReportResponse"""
