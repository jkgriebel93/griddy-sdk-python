...
class TestNFLReceivingStatsResponse(unittest.TestCase):
    """NFLReceivingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReceivingStatsResponse:
        """Test NFLReceivingStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReceivingStatsResponse`
        """
        model = NFLReceivingStatsResponse()
        if include_optional:
            return NFLReceivingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                receivers = [
                    nfl.models.player_receiving_stats.PlayerReceivingStats(
                        avg_rt_dep = 8, 
                        avg_sep = 2.78224, 
                        ay = 89.74, 
                        ay_pg = 89.74, 
    ...
    def testNFLReceivingStatsResponse(self):
        """Test NFLReceivingStatsResponse"""
