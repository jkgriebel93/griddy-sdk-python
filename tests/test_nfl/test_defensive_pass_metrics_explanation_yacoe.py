...
class TestDefensivePassMetricsExplanationYacoe(unittest.TestCase):
    """DefensivePassMetricsExplanationYacoe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensivePassMetricsExplanationYacoe:
        """Test DefensivePassMetricsExplanationYacoe
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensivePassMetricsExplanationYacoe`
        """
        model = DefensivePassMetricsExplanationYacoe()
        if include_optional:
            return DefensivePassMetricsExplanationYacoe(
    ...
    def testDefensivePassMetricsExplanationYacoe(self):
        """Test DefensivePassMetricsExplanationYacoe"""
