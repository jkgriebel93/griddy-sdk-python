...
class TestNFLLeaderEntryBaseSchema(unittest.TestCase):
    """NFLLeaderEntryBaseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLLeaderEntryBaseSchema:
        """Test NFLLeaderEntryBaseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLLeaderEntryBaseSchema`
        """
        model = NFLLeaderEntryBaseSchema()
        if include_optional:
            return NFLLeaderEntryBaseSchema(
                gsis_play_id = 4847,
                esb_id = 'ATW460468',
                jersey_number = 5,
    ...
    def testNFLLeaderEntryBaseSchema(self):
        """Test NFLLeaderEntryBaseSchema"""
