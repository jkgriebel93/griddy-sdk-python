...
class TestProjectedStatsResponseMetaPage(unittest.TestCase):
    """ProjectedStatsResponseMetaPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectedStatsResponseMetaPage:
        """Test ProjectedStatsResponseMetaPage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectedStatsResponseMetaPage`
        """
        model = ProjectedStatsResponseMetaPage()
        if include_optional:
            return ProjectedStatsResponseMetaPage(
                number = 56,
                size = 56
            )
        else:
    ...
    def testProjectedStatsResponseMetaPage(self):
        """Test ProjectedStatsResponseMetaPage"""
