...
class TestReceivingMetricsExplanationCatchRateOverExpected(unittest.TestCase):
    """ReceivingMetricsExplanationCatchRateOverExpected unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ReceivingMetricsExplanationCatchRateOverExpected
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReceivingMetricsExplanationCatchRateOverExpected`
        """
        model = ReceivingMetricsExplanationCatchRateOverExpected()
        if include_optional:
            return ReceivingMetricsExplanationCatchRateOverExpected(
    ...
    def testReceivingMetricsExplanationCatchRateOverExpected(self):
        """Test ReceivingMetricsExplanationCatchRateOverExpected"""
