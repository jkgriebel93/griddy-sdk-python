...
class TestNFLTeamDefenseStatsResponse(unittest.TestCase):
    """NFLTeamDefenseStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamDefenseStatsResponse:
        """Test NFLTeamDefenseStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamDefenseStatsResponse`
        """
        model = NFLTeamDefenseStatsResponse()
        if include_optional:
            return NFLTeamDefenseStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defense = [
                    nfl.models.team_defense_stats.TeamDefenseStats(
    ...
    def testNFLTeamDefenseStatsResponse(self):
        """Test NFLTeamDefenseStatsResponse"""
