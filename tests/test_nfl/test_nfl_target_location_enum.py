...
class TestNFLTargetLocationEnum(unittest.TestCase):
    """NFLTargetLocationEnum unit test stubs"""
    ...
    def testNFLTargetLocationEnum(self):
        """Test NFLTargetLocationEnum"""
        # inst = NFLTargetLocationEnum()
