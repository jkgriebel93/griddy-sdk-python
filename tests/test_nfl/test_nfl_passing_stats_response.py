...
class TestNFLPassingStatsResponse(unittest.TestCase):
    """NFLPassingStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassingStatsResponse:
        """Test NFLPassingStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassingStatsResponse`
        """
        model = NFLPassingStatsResponse()
        if include_optional:
            return NFLPassingStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                passers = [
                    nfl.models.player_passing_stats.PlayerPassingStats(
                        att = 108, 
                        att_pg = 36, 
                        avg_sep = 3.36518, 
                        avg_ttp = 2.68913, 
    ...
    def testNFLPassingStatsResponse(self):
        """Test NFLPassingStatsResponse"""
