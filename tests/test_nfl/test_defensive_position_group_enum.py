...
class TestDefensivePositionGroupEnum(unittest.TestCase):
    """DefensivePositionGroupEnum unit test stubs"""
    ...
    def testDefensivePositionGroupEnum(self):
        """Test DefensivePositionGroupEnum"""
        # inst = DefensivePositionGroupEnum()
