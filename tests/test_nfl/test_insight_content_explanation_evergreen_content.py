...
class TestInsightContentExplanationEvergreenContent(unittest.TestCase):
    """InsightContentExplanationEvergreenContent unit test stubs"""
    ...
    def make_instance(
        ...
        """Test InsightContentExplanationEvergreenContent
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InsightContentExplanationEvergreenContent`
        """
        model = InsightContentExplanationEvergreenContent()
        if include_optional:
            return InsightContentExplanationEvergreenContent(
    ...
    def testInsightContentExplanationEvergreenContent(self):
        """Test InsightContentExplanationEvergreenContent"""
