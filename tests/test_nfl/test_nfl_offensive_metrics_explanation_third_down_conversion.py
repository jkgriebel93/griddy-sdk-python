...
class TestNFLOffensiveMetricsExplanationThirdDownConversion(unittest.TestCase):
    """NFLOffensiveMetricsExplanationThirdDownConversion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOffensiveMetricsExplanationThirdDownConversion:
        """Test NFLOffensiveMetricsExplanationThirdDownConversion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOffensiveMetricsExplanationThirdDownConversion`
        """
        model = NFLOffensiveMetricsExplanationThirdDownConversion()
        if include_optional:
            return NFLOffensiveMetricsExplanationThirdDownConversion(
    ...
    def testNFLOffensiveMetricsExplanationThirdDownConversion(self):
        """Test NFLOffensiveMetricsExplanationThirdDownConversion"""
