...
class TestTicketVendor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TicketVendor:
        """Test TicketVendor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TicketVendor`
        """
        model = TicketVendor()
        if include_optional:
            return TicketVendor(
