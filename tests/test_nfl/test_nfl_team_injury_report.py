...
class TestNFLTeamInjuryReport(unittest.TestCase):
    """NFLTeamInjuryReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamInjuryReport:
        """Test NFLTeamInjuryReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamInjuryReport`
        """
        model = NFLTeamInjuryReport()
        if include_optional:
            return NFLTeamInjuryReport(
                injuries = [
    ...
    def testNFLTeamInjuryReport(self):
        """Test NFLTeamInjuryReport"""
