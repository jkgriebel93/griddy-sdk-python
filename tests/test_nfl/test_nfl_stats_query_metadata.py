...
class TestNFLStatsQueryMetadata(unittest.TestCase):
    """NFLStatsQueryMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLStatsQueryMetadata:
        """Test NFLStatsQueryMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLStatsQueryMetadata`
        """
        model = NFLStatsQueryMetadata()
        if include_optional:
            return NFLStatsQueryMetadata(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
    ...
    def testNFLStatsQueryMetadata(self):
        """Test NFLStatsQueryMetadata"""
