...
class TestNFLQualifiedPasserCriteria(unittest.TestCase):
    """NFLQualifiedPasserCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLQualifiedPasserCriteria:
        """Test NFLQualifiedPasserCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLQualifiedPasserCriteria`
        """
        model = NFLQualifiedPasserCriteria()
        if include_optional:
            return NFLQualifiedPasserCriteria(
                description = '',
                minimum_attempts = 56,
    ...
    def testNFLQualifiedPasserCriteria(self):
        """Test NFLQualifiedPasserCriteria"""
