...
class TestDefensiveRushMetricsExplanationRyoe(unittest.TestCase):
    """DefensiveRushMetricsExplanationRyoe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensiveRushMetricsExplanationRyoe:
        """Test DefensiveRushMetricsExplanationRyoe
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveRushMetricsExplanationRyoe`
        """
        model = DefensiveRushMetricsExplanationRyoe()
        if include_optional:
            return DefensiveRushMetricsExplanationRyoe(
    ...
    def testDefensiveRushMetricsExplanationRyoe(self):
        """Test DefensiveRushMetricsExplanationRyoe"""
