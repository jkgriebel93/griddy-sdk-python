...
class TestNFLDefensivePlayerStats(unittest.TestCase):
    """NFLDefensivePlayerStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensivePlayerStats:
        """Test NFLDefensivePlayerStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensivePlayerStats`
        """
        model = NFLDefensivePlayerStats()
        if include_optional:
            return NFLDefensivePlayerStats(
                bh_pct = 0.0625,
                catch_nd = 0.5625,
                cov = 147,
                cov_nd = 143,
    ...
    def testNFLDefensivePlayerStats(self):
        """Test NFLDefensivePlayerStats"""
