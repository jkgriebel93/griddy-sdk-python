...
class TestNFLDefensiveStats(unittest.TestCase):
    """NFLDefensiveStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveStats:
        """Test NFLDefensiveStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveStats`
        """
        model = NFLDefensiveStats()
        if include_optional:
            return NFLDefensiveStats(
                assisted_tackles = 56,
                forced_fumbles = 56,
    ...
    def testNFLDefensiveStats(self):
        """Test NFLDefensiveStats"""
