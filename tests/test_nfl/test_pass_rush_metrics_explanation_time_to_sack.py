...
class TestPassRushMetricsExplanationTimeToSack(unittest.TestCase):
    """PassRushMetricsExplanationTimeToSack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassRushMetricsExplanationTimeToSack:
        """Test PassRushMetricsExplanationTimeToSack
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassRushMetricsExplanationTimeToSack`
        """
        model = PassRushMetricsExplanationTimeToSack()
        if include_optional:
            return PassRushMetricsExplanationTimeToSack(
    ...
    def testPassRushMetricsExplanationTimeToSack(self):
        """Test PassRushMetricsExplanationTimeToSack"""
