...
class TestNFLGameSummaryTeamTimeouts(unittest.TestCase):
    """NFLGameSummaryTeamTimeouts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameSummaryTeamTimeouts:
        """Test NFLGameSummaryTeamTimeouts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameSummaryTeamTimeouts`
        """
        model = NFLGameSummaryTeamTimeouts()
        if include_optional:
            return NFLGameSummaryTeamTimeouts(
                remaining = 0,
                used = 0
            )
        else:
    ...
    def testNFLGameSummaryTeamTimeouts(self):
        """Test NFLGameSummaryTeamTimeouts"""
