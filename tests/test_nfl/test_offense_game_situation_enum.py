...
class TestOffenseGameSituationEnum(unittest.TestCase):
    """OffenseGameSituationEnum unit test stubs"""
    ...
    def testOffenseGameSituationEnum(self):
        """Test OffenseGameSituationEnum"""
        # inst = OffenseGameSituationEnum()
