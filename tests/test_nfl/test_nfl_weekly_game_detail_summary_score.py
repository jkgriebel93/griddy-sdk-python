...
class TestNFLWeeklyGameDetailSummaryScore(unittest.TestCase):
    """NFLWeeklyGameDetailSummaryScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeeklyGameDetailSummaryScore:
        """Test NFLWeeklyGameDetailSummaryScore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeeklyGameDetailSummaryScore`
        """
        model = NFLWeeklyGameDetailSummaryScore()
        if include_optional:
            return NFLWeeklyGameDetailSummaryScore(
                ot = 3,
                q1 = 7,
                q2 = 10,
                q3 = 3,
    ...
    def testNFLWeeklyGameDetailSummaryScore(self):
        """Test NFLWeeklyGameDetailSummaryScore"""
