...
class TestOffensiveSkillPositionEnum(unittest.TestCase):
    """OffensiveSkillPositionEnum unit test stubs"""
    ...
    def testOffensiveSkillPositionEnum(self):
        """Test OffensiveSkillPositionEnum"""
        # inst = OffensiveSkillPositionEnum()
