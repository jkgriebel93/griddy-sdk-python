...
class TestDefensivePositionEnum(unittest.TestCase):
    """DefensivePositionEnum unit test stubs"""
    ...
    def testDefensivePositionEnum(self):
        """Test DefensivePositionEnum"""
        # inst = DefensivePositionEnum()
