...
class TestNFLDrive(unittest.TestCase):
    """NFLDrive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDrive:
        """Test NFLDrive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDrive`
        """
        model = NFLDrive()
        if include_optional:
            return NFLDrive(
