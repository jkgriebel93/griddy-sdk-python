...
class TestNFLPlayer(unittest.TestCase):
    """NFLPlayer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayer:
        """Test NFLPlayer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayer`
        """
        model = NFLPlayer()
        if include_optional:
            return NFLPlayer(
