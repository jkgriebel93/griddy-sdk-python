...
class TestOffensiveSplitCategory(unittest.TestCase):
    """OffensiveSplitCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OffensiveSplitCategory:
        """Test OffensiveSplitCategory
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OffensiveSplitCategory`
        """
        model = OffensiveSplitCategory()
        if include_optional:
            return OffensiveSplitCategory(
                category = '',
                description = '',
    ...
    def testOffensiveSplitCategory(self):
        """Test OffensiveSplitCategory"""
