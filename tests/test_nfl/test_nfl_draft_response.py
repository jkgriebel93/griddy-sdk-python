...
class TestNFLDraftResponse(unittest.TestCase):
    """NFLDraftResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDraftResponse:
        """Test NFLDraftResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDraftResponse`
        """
        model = NFLDraftResponse()
        if include_optional:
            return NFLDraftResponse(
                rounds = [
                    nfl.models.draft_response_rounds_inner.DraftResponse_rounds_inner(
                        picks = [
