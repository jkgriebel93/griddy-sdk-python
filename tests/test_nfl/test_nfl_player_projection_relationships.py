...
class TestNFLPlayerProjectionRelationships(unittest.TestCase):
    """NFLPlayerProjectionRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerProjectionRelationships:
        """Test NFLPlayerProjectionRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerProjectionRelationships`
        """
        model = NFLPlayerProjectionRelationships()
        if include_optional:
            return NFLPlayerProjectionRelationships(
                week_points = [
    ...
    def testNFLPlayerProjectionRelationships(self):
        """Test NFLPlayerProjectionRelationships"""
