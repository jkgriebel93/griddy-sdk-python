...
class TestNFLPassRushMetricsExplanationTimeToSack(unittest.TestCase):
    """NFLPassRushMetricsExplanationTimeToSack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassRushMetricsExplanationTimeToSack:
        """Test NFLPassRushMetricsExplanationTimeToSack
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassRushMetricsExplanationTimeToSack`
        """
        model = NFLPassRushMetricsExplanationTimeToSack()
        if include_optional:
            return NFLPassRushMetricsExplanationTimeToSack(
    ...
    def testNFLPassRushMetricsExplanationTimeToSack(self):
        """Test NFLPassRushMetricsExplanationTimeToSack"""
