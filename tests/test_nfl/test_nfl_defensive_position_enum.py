...
class TestNFLDefensivePositionEnum(unittest.TestCase):
    """NFLDefensivePositionEnum unit test stubs"""
    ...
    def testNFLDefensivePositionEnum(self):
        """Test NFLDefensivePositionEnum"""
        # inst = NFLDefensivePositionEnum()
