...
class TestNFLPassingStatsCategoryEnum(unittest.TestCase):
    """NFLPassingStatsCategoryEnum unit test stubs"""
    ...
    def testNFLPassingStatsCategoryEnum(self):
        """Test NFLPassingStatsCategoryEnum"""
        # inst = NFLPassingStatsCategoryEnum()
