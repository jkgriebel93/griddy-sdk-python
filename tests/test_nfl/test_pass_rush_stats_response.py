...
class TestPassRushStatsResponse(unittest.TestCase):
    """PassRushStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassRushStatsResponse:
        """Test PassRushStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassRushStatsResponse`
        """
        model = PassRushStatsResponse()
        if include_optional:
            return PassRushStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defenders = [
                    src.griddy.nfl.models.defensive_pass_rush_stats.DefensivePassRushStats(
    ...
    def testPassRushStatsResponse(self):
        """Test PassRushStatsResponse"""
