...
class TestNFLLineOfScrimmageDistanceEnum(unittest.TestCase):
    """NFLLineOfScrimmageDistanceEnum unit test stubs"""
    ...
    def testNFLLineOfScrimmageDistanceEnum(self):
        """Test NFLLineOfScrimmageDistanceEnum"""
        # inst = NFLLineOfScrimmageDistanceEnum()
