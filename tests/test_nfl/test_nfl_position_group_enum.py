...
class TestNFLPositionGroupEnum(unittest.TestCase):
    """NFLPositionGroupEnum unit test stubs"""
    ...
    def testNFLPositionGroupEnum(self):
        """Test NFLPositionGroupEnum"""
        # inst = NFLPositionGroupEnum()
