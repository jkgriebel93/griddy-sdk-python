...
class TestNFLPointsRecord(unittest.TestCase):
    """NFLPointsRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPointsRecord:
        """Test NFLPointsRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPointsRecord`
        """
        model = NFLPointsRecord()
        if include_optional:
            return NFLPointsRecord(
                losses = 56,
                ties = 56,
                wins = 56,
