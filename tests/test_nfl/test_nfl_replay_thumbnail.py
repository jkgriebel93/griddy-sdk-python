...
class TestNFLReplayThumbnail(unittest.TestCase):
    """NFLReplayThumbnail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLReplayThumbnail:
        """Test NFLReplayThumbnail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLReplayThumbnail`
        """
        model = NFLReplayThumbnail()
        if include_optional:
            return NFLReplayThumbnail(
                thumbnail_url = ''
            )
        else:
            return NFLReplayThumbnail(
    ...
    def testNFLReplayThumbnail(self):
        """Test NFLReplayThumbnail"""
