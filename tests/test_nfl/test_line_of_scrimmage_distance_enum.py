...
class TestLineOfScrimmageDistanceEnum(unittest.TestCase):
    """LineOfScrimmageDistanceEnum unit test stubs"""
    ...
    def testLineOfScrimmageDistanceEnum(self):
        """Test LineOfScrimmageDistanceEnum"""
        # inst = LineOfScrimmageDistanceEnum()
