...
class TestNFLGameSituation(unittest.TestCase):
    """NFLGameSituation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameSituation:
        """Test NFLGameSituation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameSituation`
        """
        model = NFLGameSituation()
        if include_optional:
            return NFLGameSituation(
                down = 1,
