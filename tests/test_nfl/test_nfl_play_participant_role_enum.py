...
class TestNFLPlayParticipantRoleEnum(unittest.TestCase):
    """NFLPlayParticipantRoleEnum unit test stubs"""
    ...
    def testNFLPlayParticipantRoleEnum(self):
        """Test NFLPlayParticipantRoleEnum"""
        # inst = NFLPlayParticipantRoleEnum()
