...
class TestNFLPlayerReceivingStats(unittest.TestCase):
    """NFLPlayerReceivingStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerReceivingStats:
        """Test NFLPlayerReceivingStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerReceivingStats`
        """
        model = NFLPlayerReceivingStats()
        if include_optional:
            return NFLPlayerReceivingStats(
                avg_rt_dep = 8,
                avg_sep = 2.78224,
                ay = 89.74,
                ay_pg = 89.74,
    ...
    def testNFLPlayerReceivingStats(self):
        """Test NFLPlayerReceivingStats"""
