...
class TestInjuryEntryPracticeStatus(unittest.TestCase):
    """InjuryEntryPracticeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InjuryEntryPracticeStatus:
        """Test InjuryEntryPracticeStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InjuryEntryPracticeStatus`
        """
        model = InjuryEntryPracticeStatus()
        if include_optional:
            return InjuryEntryPracticeStatus(
                friday = 'DNP',
                thursday = 'DNP',
                wednesday = 'DNP'
            )
    ...
    def testInjuryEntryPracticeStatus(self):
        """Test InjuryEntryPracticeStatus"""
