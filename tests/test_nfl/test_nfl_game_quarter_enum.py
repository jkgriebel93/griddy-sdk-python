...
class TestNFLGameQuarterEnum(unittest.TestCase):
    """NFLGameQuarterEnum unit test stubs"""
    ...
    def testNFLGameQuarterEnum(self):
        """Test NFLGameQuarterEnum"""
        # inst = NFLGameQuarterEnum()
