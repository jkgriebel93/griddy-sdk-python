...
class TestFantasyStatsResponse(unittest.TestCase):
    """FantasyStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FantasyStatsResponse:
        """Test FantasyStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FantasyStatsResponse`
        """
        model = FantasyStatsResponse()
        if include_optional:
            return FantasyStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                players = [
                    src.griddy.nfl.models.fantasy_player_stats.FantasyPlayerStats(
    ...
    def testFantasyStatsResponse(self):
        """Test FantasyStatsResponse"""
