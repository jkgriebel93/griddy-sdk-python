...
class TestNFLTransaction(unittest.TestCase):
    """NFLTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTransaction:
        """Test NFLTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTransaction`
        """
        model = NFLTransaction()
        if include_optional:
            return NFLTransaction(
