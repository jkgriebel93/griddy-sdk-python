...
class TestNFLGameTeam(unittest.TestCase):
    """NFLGameTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGameTeam:
        """Test NFLGameTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGameTeam`
        """
        model = NFLGameTeam()
        if include_optional:
            return NFLGameTeam(
