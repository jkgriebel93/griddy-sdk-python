...
class TestNFLRushLocationMapEntry(unittest.TestCase):
    """NFLRushLocationMapEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLRushLocationMapEntry:
        """Test NFLRushLocationMapEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLRushLocationMapEntry`
        """
        model = NFLRushLocationMapEntry()
        if include_optional:
            return NFLRushLocationMapEntry(
                yards = 56,
                attempts = 56,
                touchdowns = 56,
                distance = 1.337,
    ...
    def testNFLRushLocationMapEntry(self):
        """Test NFLRushLocationMapEntry"""
