...
class TestNFLFilmCard(unittest.TestCase):
    """NFLFilmCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLFilmCard:
        """Test NFLFilmCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLFilmCard`
        """
        model = NFLFilmCard()
        if include_optional:
            return NFLFilmCard(
