...
class TestNFLPointsRecordAllOfPoints(unittest.TestCase):
    """NFLPointsRecordAllOfPoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPointsRecordAllOfPoints:
        """Test NFLPointsRecordAllOfPoints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPointsRecordAllOfPoints`
        """
        model = NFLPointsRecordAllOfPoints()
        if include_optional:
            return NFLPointsRecordAllOfPoints(
                against = 56,
                var_for = 56
            )
        else:
    ...
    def testNFLPointsRecordAllOfPoints(self):
        """Test NFLPointsRecordAllOfPoints"""
