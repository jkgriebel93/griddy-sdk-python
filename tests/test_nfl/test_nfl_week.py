...
class TestNFLWeek(unittest.TestCase):
    """NFLWeek unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeek:
        """Test NFLWeek
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeek`
        """
        model = NFLWeek()
        if include_optional:
            return NFLWeek(
