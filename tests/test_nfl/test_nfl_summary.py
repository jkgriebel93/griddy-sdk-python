...
class TestNFLSummary(unittest.TestCase):
    """NFLSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLSummary:
        """Test NFLSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLSummary`
        """
        model = NFLSummary()
        if include_optional:
            return NFLSummary(
