...
class TestSpeedLeaderEntry(unittest.TestCase):
    """SpeedLeaderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpeedLeaderEntry:
        """Test SpeedLeaderEntry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpeedLeaderEntry`
        """
        model = SpeedLeaderEntry()
        if include_optional:
            return SpeedLeaderEntry(
