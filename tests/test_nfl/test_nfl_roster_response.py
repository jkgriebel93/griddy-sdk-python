...
class TestNFLRosterResponse(unittest.TestCase):
    """NFLRosterResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLRosterResponse:
        """Test NFLRosterResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLRosterResponse`
        """
        model = NFLRosterResponse()
        if include_optional:
            return NFLRosterResponse(
                roster = nfl.models.roster_response_roster.RosterResponse_roster(
                    defense = [
                        nfl.models.player.Player(
    ...
    def testNFLRosterResponse(self):
        """Test NFLRosterResponse"""
