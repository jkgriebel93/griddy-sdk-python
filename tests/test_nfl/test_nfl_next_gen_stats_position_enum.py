...
class TestNFLNextGenStatsPositionEnum(unittest.TestCase):
    """NFLNextGenStatsPositionEnum unit test stubs"""
    ...
    def testNFLNextGenStatsPositionEnum(self):
        """Test NFLNextGenStatsPositionEnum"""
        # inst = NFLNextGenStatsPositionEnum()
