...
class TestNFLPlayerProjection(unittest.TestCase):
    """NFLPlayerProjection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerProjection:
        """Test NFLPlayerProjection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerProjection`
        """
        model = NFLPlayerProjection()
        if include_optional:
            return NFLPlayerProjection(
    ...
    def testNFLPlayerProjection(self):
        """Test NFLPlayerProjection"""
