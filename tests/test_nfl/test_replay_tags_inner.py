...
class TestReplayTagsInner(unittest.TestCase):
    """ReplayTagsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplayTagsInner:
        """Test ReplayTagsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReplayTagsInner`
        """
        model = ReplayTagsInner()
        if include_optional:
            return ReplayTagsInner(
                game_id = '',
                season = '',
                season_type = '',
                week = ''
