...
class TestTeamOffenseOverviewStatisticsController(unittest.TestCase):
    """TeamOffenseOverviewStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = TeamOffenseOverviewStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_team_offense_overview_stats_by_season(self) -> None:
        """Test case for get_team_offense_overview_stats_by_season
