...
class TestNFLGetPlaysWinProbabilityGameIdParameter(unittest.TestCase):
    """NFLGetPlaysWinProbabilityGameIdParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGetPlaysWinProbabilityGameIdParameter:
        """Test NFLGetPlaysWinProbabilityGameIdParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGetPlaysWinProbabilityGameIdParameter`
        """
        model = NFLGetPlaysWinProbabilityGameIdParameter()
        if include_optional:
            return NFLGetPlaysWinProbabilityGameIdParameter(
            )
        else:
            return NFLGetPlaysWinProbabilityGameIdParameter(
        )
    ...
    def testNFLGetPlaysWinProbabilityGameIdParameter(self):
        """Test NFLGetPlaysWinProbabilityGameIdParameter"""
