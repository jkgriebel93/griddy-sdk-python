...
class TestNFLPersonnelPackageEnum(unittest.TestCase):
    """NFLPersonnelPackageEnum unit test stubs"""
    ...
    def testNFLPersonnelPackageEnum(self):
        """Test NFLPersonnelPackageEnum"""
        # inst = NFLPersonnelPackageEnum()
