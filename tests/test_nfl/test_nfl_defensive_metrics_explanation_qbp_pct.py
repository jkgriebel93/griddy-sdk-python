...
class TestNFLDefensiveMetricsExplanationQbpPct(unittest.TestCase):
    """NFLDefensiveMetricsExplanationQbpPct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLDefensiveMetricsExplanationQbpPct:
        """Test NFLDefensiveMetricsExplanationQbpPct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLDefensiveMetricsExplanationQbpPct`
        """
        model = NFLDefensiveMetricsExplanationQbpPct()
        if include_optional:
            return NFLDefensiveMetricsExplanationQbpPct(
    ...
    def testNFLDefensiveMetricsExplanationQbpPct(self):
        """Test NFLDefensiveMetricsExplanationQbpPct"""
