...
class TestNFLOddsSelection(unittest.TestCase):
    """NFLOddsSelection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLOddsSelection:
        """Test NFLOddsSelection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLOddsSelection`
        """
        model = NFLOddsSelection()
        if include_optional:
            return NFLOddsSelection(
                decimal = 5.5,
                is_available = True,
                name = ''
            )
