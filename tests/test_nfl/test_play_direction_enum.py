...
class TestPlayDirectionEnum(unittest.TestCase):
    """PlayDirectionEnum unit test stubs"""
    ...
    def testPlayDirectionEnum(self):
        """Test PlayDirectionEnum"""
        # inst = PlayDirectionEnum()
