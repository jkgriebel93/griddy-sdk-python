...
class TestProjectedStatsResponseIncludedInner(unittest.TestCase):
    """ProjectedStatsResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectedStatsResponseIncludedInner:
        """Test ProjectedStatsResponseIncludedInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectedStatsResponseIncludedInner`
        """
        model = ProjectedStatsResponseIncludedInner()
        if include_optional:
            return ProjectedStatsResponseIncludedInner(
    ...
    def testProjectedStatsResponseIncludedInner(self):
        """Test ProjectedStatsResponseIncludedInner"""
