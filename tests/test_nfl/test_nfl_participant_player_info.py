...
class TestNFLParticipantPlayerInfo(unittest.TestCase):
    """NFLParticipantPlayerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLParticipantPlayerInfo:
        """Test NFLParticipantPlayerInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLParticipantPlayerInfo`
        """
        model = NFLParticipantPlayerInfo()
        if include_optional:
            return NFLParticipantPlayerInfo(
                first_name = '',
                gsis_id = '',
                last_name = '',
                nfl_id = 56,
    ...
    def testNFLParticipantPlayerInfo(self):
        """Test NFLParticipantPlayerInfo"""
