...
class TestNFLExternalId(unittest.TestCase):
    """NFLExternalId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLExternalId:
        """Test NFLExternalId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLExternalId`
        """
        model = NFLExternalId()
        if include_optional:
            return NFLExternalId(
                id = '',
                source = 'elias'
            )
        else:
