...
class TestNFLTransactionTypeEnum(unittest.TestCase):
    """NFLTransactionTypeEnum unit test stubs"""
    ...
    def testNFLTransactionTypeEnum(self):
        """Test NFLTransactionTypeEnum"""
        # inst = NFLTransactionTypeEnum()
