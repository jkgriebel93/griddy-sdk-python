...
class TestNFLRecord(unittest.TestCase):
    """NFLRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLRecord:
        """Test NFLRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLRecord`
        """
        model = NFLRecord()
        if include_optional:
            return NFLRecord(
