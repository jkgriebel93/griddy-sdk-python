...
class TestNFLGamecenterSchedule(unittest.TestCase):
    """NFLGamecenterSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLGamecenterSchedule:
        """Test NFLGamecenterSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLGamecenterSchedule`
        """
        model = NFLGamecenterSchedule()
        if include_optional:
            return NFLGamecenterSchedule(
                game_date = '',
                game_id = '',
                game_key = 56,
                game_time_eastern = '',
    ...
    def testNFLGamecenterSchedule(self):
        """Test NFLGamecenterSchedule"""
