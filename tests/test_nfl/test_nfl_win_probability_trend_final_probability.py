...
class TestNFLWinProbabilityTrendFinalProbability(unittest.TestCase):
    """NFLWinProbabilityTrendFinalProbability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWinProbabilityTrendFinalProbability:
        """Test NFLWinProbabilityTrendFinalProbability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWinProbabilityTrendFinalProbability`
        """
        model = NFLWinProbabilityTrendFinalProbability()
        if include_optional:
            return NFLWinProbabilityTrendFinalProbability(
                away_team = 0,
                home_team = 0
            )
        else:
    ...
    def testNFLWinProbabilityTrendFinalProbability(self):
        """Test NFLWinProbabilityTrendFinalProbability"""
