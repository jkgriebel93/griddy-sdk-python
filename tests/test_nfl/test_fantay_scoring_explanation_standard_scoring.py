...
class TestFantayScoringExplanationStandardScoring(unittest.TestCase):
    """FantayScoringExplanationStandardScoring unit test stubs"""
    ...
    def make_instance(
        ...
        """Test FantayScoringExplanationStandardScoring
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FantayScoringExplanationStandardScoring`
        """
        model = FantayScoringExplanationStandardScoring()
        if include_optional:
            return FantayScoringExplanationStandardScoring(
    ...
    def testFantayScoringExplanationStandardScoring(self):
        """Test FantayScoringExplanationStandardScoring"""
