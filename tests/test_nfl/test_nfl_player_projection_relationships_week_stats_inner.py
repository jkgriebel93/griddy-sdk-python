...
class TestNFLPlayerProjectionRelationshipsWeekStatsInner(unittest.TestCase):
    """NFLPlayerProjectionRelationshipsWeekStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPlayerProjectionRelationshipsWeekStatsInner:
        """Test NFLPlayerProjectionRelationshipsWeekStatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPlayerProjectionRelationshipsWeekStatsInner`
        """
        model = NFLPlayerProjectionRelationshipsWeekStatsInner()
        if include_optional:
            return NFLPlayerProjectionRelationshipsWeekStatsInner(
                id = '',
    ...
    def testNFLPlayerProjectionRelationshipsWeekStatsInner(self):
        """Test NFLPlayerProjectionRelationshipsWeekStatsInner"""
