...
class TestDefensiveOverviewStatsResponse(unittest.TestCase):
    """DefensiveOverviewStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefensiveOverviewStatsResponse:
        """Test DefensiveOverviewStatsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveOverviewStatsResponse`
        """
        model = DefensiveOverviewStatsResponse()
        if include_optional:
            return DefensiveOverviewStatsResponse(
                limit = 56,
                offset = 56,
                season = 56,
                season_type = 'REG',
                ...
                total = 56,
                defenders = [
                    src.griddy.nfl.models.defensive_player_overview_stats.DefensivePlayerOverviewStats(
    ...
    def testDefensiveOverviewStatsResponse(self):
        """Test DefensiveOverviewStatsResponse"""
