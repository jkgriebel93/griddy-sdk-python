...
class TestNFLTeamRankings(unittest.TestCase):
    """NFLTeamRankings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLTeamRankings:
        """Test NFLTeamRankings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLTeamRankings`
        """
        model = NFLTeamRankings()
        if include_optional:
            return NFLTeamRankings(
                season = 2025,
                season_type = 'REG',
                statistics = [
