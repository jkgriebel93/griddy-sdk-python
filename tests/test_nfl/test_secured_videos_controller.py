...
class TestSecuredVideosController(unittest.TestCase):
    """SecuredVideosController unit test stubs"""

    def setUp(self) -> None:
        self.api = SecuredVideosController()

    def tearDown(self) -> None:
        pass

    def test_get_coaches_film_videos(self) -> None:
        """Test case for get_coaches_film_videos
