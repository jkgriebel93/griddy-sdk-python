...
class TestNFLPassingZoneStats(unittest.TestCase):
    """NFLPassingZoneStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLPassingZoneStats:
        """Test NFLPassingZoneStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLPassingZoneStats`
        """
        model = NFLPassingZoneStats()
        if include_optional:
            return NFLPassingZoneStats(
                type = 'threeColumns',
    ...
    def testNFLPassingZoneStats(self):
        """Test NFLPassingZoneStats"""
