...
class TestPassDistanceLeaderEntry(unittest.TestCase):
    """PassDistanceLeaderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassDistanceLeaderEntry:
        """Test PassDistanceLeaderEntry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PassDistanceLeaderEntry`
        """
        model = PassDistanceLeaderEntry()
        if include_optional:
            return PassDistanceLeaderEntry(
                pass_info = None,
                gsis_play_id = 4847,
                esb_id = 'ATW460468',
                jersey_number = 5,
    ...
    def testPassDistanceLeaderEntry(self):
        """Test PassDistanceLeaderEntry"""
