...
class TestTeamDefenseRushStatisticsController(unittest.TestCase):
    """TeamDefenseRushStatisticsController unit test stubs"""

    def setUp(self) -> None:
        self.api = TeamDefenseRushStatisticsController()

    def tearDown(self) -> None:
        pass

    def test_get_team_defense_rush_stats_by_season(self) -> None:
        """Test case for get_team_defense_rush_stats_by_season
