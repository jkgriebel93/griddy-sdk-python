...
class TestNFLWeeksResponse(unittest.TestCase):
    """NFLWeeksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLWeeksResponse:
        """Test NFLWeeksResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLWeeksResponse`
        """
        model = NFLWeeksResponse()
        if include_optional:
            return NFLWeeksResponse(
