...
class TestNFLLiveGameAwayTeam(unittest.TestCase):
    """NFLLiveGameAwayTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NFLLiveGameAwayTeam:
        """Test NFLLiveGameAwayTeam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NFLLiveGameAwayTeam`
        """
        model = NFLLiveGameAwayTeam()
        if include_optional:
            return NFLLiveGameAwayTeam(
                abbreviation = '',
                score = 56,
                team_id = ''
            )
    ...
    def testNFLLiveGameAwayTeam(self):
        """Test NFLLiveGameAwayTeam"""
