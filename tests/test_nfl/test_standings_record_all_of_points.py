...
class TestStandingsRecordAllOfPoints(unittest.TestCase):
    """StandingsRecordAllOfPoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandingsRecordAllOfPoints:
        """Test StandingsRecordAllOfPoints
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StandingsRecordAllOfPoints`
        """
        model = StandingsRecordAllOfPoints()
        if include_optional:
            return StandingsRecordAllOfPoints(
                against = 56,
                var_for = 56
            )
        else:
    ...
    def testStandingsRecordAllOfPoints(self):
        """Test StandingsRecordAllOfPoints"""
