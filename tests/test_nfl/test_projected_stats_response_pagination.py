...
class TestProjectedStatsResponsePagination(unittest.TestCase):
    """ProjectedStatsResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectedStatsResponsePagination:
        """Test ProjectedStatsResponsePagination
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectedStatsResponsePagination`
        """
        model = ProjectedStatsResponsePagination()
        if include_optional:
            return ProjectedStatsResponsePagination(
                token = ''
            )
        else:
            return ProjectedStatsResponsePagination(
    ...
    def testProjectedStatsResponsePagination(self):
        """Test ProjectedStatsResponsePagination"""
