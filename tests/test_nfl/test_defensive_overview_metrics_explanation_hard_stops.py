...
class TestDefensiveOverviewMetricsExplanationHardStops(unittest.TestCase):
    """DefensiveOverviewMetricsExplanationHardStops unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DefensiveOverviewMetricsExplanationHardStops
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DefensiveOverviewMetricsExplanationHardStops`
        """
        model = DefensiveOverviewMetricsExplanationHardStops()
        if include_optional:
            return DefensiveOverviewMetricsExplanationHardStops(
    ...
    def testDefensiveOverviewMetricsExplanationHardStops(self):
        """Test DefensiveOverviewMetricsExplanationHardStops"""
