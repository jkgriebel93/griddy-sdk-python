...
class TestTeamRosterResponse(unittest.TestCase):
    """TeamRosterResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeamRosterResponse:
        """Test TeamRosterResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TeamRosterResponse`
        """
        model = TeamRosterResponse()
        if include_optional:
            return TeamRosterResponse(
                season = 2025,
                team = src.griddy.nfl.models.team_info.TeamInfo(
                    abbr = 'MIN', 
    ...
    def testTeamRosterResponse(self):
        """Test TeamRosterResponse"""
